...
<div class="f-brand m-100">
    <div class="title-brand">
        <h1 class="main-title">Nhãn hàng<p>&nbsp;tiêu biểu</p>
        </h1>
        ...
        <div class="row">
            <div class="brand-item">
                <a href="./san-pham.html" class="hover-img yoshi">
                    <figure>
                        <img src="./upload/hinhanh/yoshitake.png" alt="">
                    </figure>
                </a>
            </div>
            <div class="brand-item">
                <a href="./ingersoll-rand.html" class="hover-img">
                    <figure>
                        <img src="./upload/hinhanh/ir.png" alt="">
                    </figure>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="brand-item">
                <a href="./san-pham-khac/kawakijapan/" class="hover-img">
                    <figure>
                        <img src="./upload/hinhanh/kawaki.png" alt="">
                    </figure>
                </a>
            </div>
            <div class="brand-item">
...
<div class="news">
    <div class="title-brand">
        <h1 class="main-title">Tin tức<p>&nbsp;mới</p>
        </h1>
    ...
    <div class="gr-news m-100">
        <article class="news-item">
            ...
            <a href="tin-tuc/<?php echo $tintuc[0]['tenkhongdau']?>-<?php echo $tintuc[0]['id']?>.html" type="button"
                class="btn-news">
                Xem thêm
                <i><img src="./images/arrow-right.svg" alt=""></i>
            </a>
            <img class="news-img" src="<?php echo _upload_tintuc_l.$tintuc[0]['thumb']?>"
                alt="<?php echo $tintuc[0]['ten']?>" />
        </article>
        <div class="gr-r-news">
            <article class="r-news-item">
                ...
                <img class="news-img" src="<?php echo _upload_tintuc_l.$tintuc[1]['thumb']?>"
                    alt="<?php echo $tintuc[1]['ten']?>" />
            </article>
            <article class="r-news-item">
                <div class="layer"></div>
                <h3 class="news-title">
                ...
                <img class="news-img" src="<?php echo _upload_tintuc_l.$tintuc[2]['thumb']?>"
                    alt="<?php echo $tintuc[2]['ten']?>" />
            </article>
        </div>
    </div>
</div>
...
<div id="right1">
    ...
    <?php if (!empty($spnb)) {
        ...
        <div class="right_item" <?php echo $str ?>>
          ...
          <div class="img">
            <div class="img_wrap">
              <a href="san-pham/<?php echo $product_item["tenkhongdau"] ?>-<?php echo $product_item[
                "id"
                ] ?>.html">
          ...
          <h3><a href="san-pham/<?php echo $product_item["tenkhongdau"] ?>-<?php echo $product_item[
            "id"
            ] ?>.html"><?php echo $product_item["ten"] ?></a>
          </h3>
          <div class="desc">
    ...
    <?php if (!empty($spnb2)) {
        ...
        <div class="right_item" <?php echo $str ?>>
          ...
          <h3><a
              href="san-pham-kitz/<?php echo $product_item["tenkhongdau"] ?>-<?php echo $product_item[
                "id"
                ] ?>.html"><?php echo $product_item["ten"] ?></a>
          </h3>
          <div class="desc">
