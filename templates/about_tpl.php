  ...
  <div id="right">
      <div class="box_main">
          ...
          <div class="box_news" <?= $str ?>>
              <div class="image_boder"><a href="gioi-thieu/<?= $tintuc[$i][
                "tenkhongdau"
              ] ?>-<?= $tintuc[$i]["id"] ?>.html"><img src="<?= _upload_tintuc_l,
  $tintuc[$i]["thumb"] ?>" alt="<?= $tintuc[$i]["ten"] ?>" /></a></div>

              <div class="mota_tt">
                  <div class="ten_tt">
                      <h2> <a href="gioi-thieu/<?= $tintuc[$i][
                  "tenkhongdau"
                ] ?>-<?= $tintuc[$i]["id"] ?>.html"><?= $tintuc[$i][
  "ten"
] ?></a></h2>
                  </div>
                  <?php
