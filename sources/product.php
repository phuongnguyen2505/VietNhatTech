...
if($id!='') {
    ...
    $d->query($sql_lanxem);
    $ar = array("ingersoll-rand"=>"Ingersoll Rand","san-pham"=>"Yoshitake","san-pham-khac"=>"Sản phẩm");
    if($lang=='en') {
    ...
    if(!empty($_POST)) {
        ...
        if ($tieude == null) { 
            $coloi=true; $error_tieude = "<br>Bạn chưa nhập tiêu đề";
        }
        if ($noidung == null) { 
            $coloi=true; $error_noidung = "<br>Bạn chưa nhập nội dung";
        }                    
