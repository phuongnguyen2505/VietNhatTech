  ...
  var be = oe(function (Ce, ae) {
    var H = Object.getOwnPropertyNames,
      ...
      "<define:process>": function defineProcess() {}
        ...
        ce = L({
      "src/common/parser-create-error.js": function srcCommonParserCreateErrorJs(a, d) {
        "use strict";

        K();

        function i(c, r) {
          var _ = new SyntaxError(c + " (" + r.start.line + ":" + r.start.column + ")");
        ...
        ue = L({
      "src/utils/try-combinations.js": function srcUtilsTryCombinationsJs(a, d) {
        "use strict";
        ...
        function i() {
          ...
          try {
            for (var _iterator = _.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        le = L({
      "src/language-graphql/pragma.js": function srcLanguageGraphqlPragmaJs(a, d) {
        "use strict";
        ...
        pe = L({
      "src/language-graphql/loc.js": function srcLanguageGraphqlLocJs(a, d) {
        "use strict";
        ...
        fe = L({
      "node_modules/graphql/jsutils/isObjectLike.js": function node_modulesGraphqlJsutilsIsObjectLikeJs(a) {
        "use strict";
        ...
        function d(c) {
          return typeof Symbol == "function" && _typeof(Symbol.iterator) == "symbol" ? d = function d(_) {
            return _typeof(_);
          } : d = function d(_) {
            return _ && typeof Symbol == "function" && _.constructor === Symbol && _ !== Symbol.prototype ? "symbol" : _typeof(_);
          }, d(c);
        }
        ...
        z = L({
      "node_modules/graphql/polyfills/symbols.js": function node_modulesGraphqlPolyfillsSymbolsJs(a) {
        "use strict";
        ...
        $ = L({
      "node_modules/graphql/language/location.js": function node_modulesGraphqlLanguageLocationJs(a) {
        "use strict";
        ...
        de = L({
      "node_modules/graphql/language/printLocation.js": function node_modulesGraphqlLanguagePrintLocationJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.printLocation = i, a.printSourceLocation = c;
        var d = $();
        ...
        function c(k, O) {
          var A = k.locationOffset.column - 1,
              ...
              I = O.line === 1 ? A : 0,
              s = O.column + I,
              p = "".concat(k.name, ":").concat(v, ":").concat(s, "\n"),
              e = N.split(/\r\n|[\n\r]/g),
              n = e[g];
        ...
        W = L({
      "node_modules/graphql/error/GraphQLError.js": function node_modulesGraphqlErrorGraphQLErrorJs(a) {
        "use strict";

        K();

        function d(f) {
          return typeof Symbol == "function" && _typeof(Symbol.iterator) == "symbol" ? d = function d(o) {
            return _typeof(o);
          } : d = function d(o) {
            return o && typeof Symbol == "function" && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : _typeof(o);
          }, d(f);
        }

        Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.printError = y, a.GraphQLError = void 0;
        ...
        function s(f, m, o) {
          return p() ? s = Reflect.construct : s = function s(l, T, S) {
            var x = [null];
            x.push.apply(x, T);
        ...
        var u = function (f) {
          ...
          function o(h, l, T, S, x, b, M) {
            ...
            return Object.defineProperties(v(C), {
              name: {
                value: "GraphQLError"
              },
              message: {
              ...
              locations: {
                value: (U = B) !== null && U !== void 0 ? U : void 0,
                enumerable: B != null
              },
              path: {
                value: x != null ? x : void 0,
                enumerable: x != null
              },
              nodes: {
                value: R != null ? R : void 0
              },
              source: {
                value: (V = Y) !== null && V !== void 0 ? V : void 0
              },
              positions: {
                value: (q = F) !== null && q !== void 0 ? q : void 0
              },
              originalError: {
                value: b
              },
              extensions: {
                value: (G = j) !== null && G !== void 0 ? G : void 0,
                enumerable: j != null
              }
            }), b != null && b.stack ? (Object.defineProperty(v(C), "stack", {
              value: b.stack,
              writable: !0,
              configurable: !0
            }), D(C)) : (Error.captureStackTrace ? Error.captureStackTrace(v(C), o) : Object.defineProperty(v(C), "stack", {
              value: Error().stack,
              writable: !0,
              configurable: !0
            }), C);
        ...
        function y(f) {
          var m = f.message;
          if (f.nodes) for (var o = 0, h = f.nodes; o < h.length; o++) {
            var l = h[o];
            l.loc && (m += "\n\n" + (0, _.printLocation)(l.loc));
          } else if (f.source && f.locations) for (var T = 0, S = f.locations; T < S.length; T++) {
            var x = S[T];
        ...
        Z = L({
      "node_modules/graphql/error/syntaxError.js": function node_modulesGraphqlErrorSyntaxErrorJs(a) {
        "use strict";
        ...
        he = L({
      "node_modules/graphql/language/kinds.js": function node_modulesGraphqlLanguageKindsJs(a) {
        "use strict";
        ...
        ve = L({
      "node_modules/graphql/jsutils/invariant.js": function node_modulesGraphqlJsutilsInvariantJs(a) {
        "use strict";
        ...
        ee = L({
      "node_modules/graphql/jsutils/nodejsCustomInspectSymbol.js": function node_modulesGraphqlJsutilsNodejsCustomInspectSymbolJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a["default"] = void 0;
        var d = typeof Symbol == "function" && typeof Symbol["for"] == "function" ? Symbol["for"]("nodejs.util.inspect.custom") : void 0,
            i = d;
        a["default"] = i;
      }
    }),
        Te = L({
      "node_modules/graphql/jsutils/defineInspect.js": function node_modulesGraphqlJsutilsDefineInspectJs(a) {
        "use strict";
        ...
        te = L({
      "node_modules/graphql/language/ast.js": function node_modulesGraphqlLanguageAstJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.isNode = _, a.Token = a.Location = void 0;
        var d = i(Te());
        ...
        ne = L({
      "node_modules/graphql/language/tokenKind.js": function node_modulesGraphqlLanguageTokenKindJs(a) {
        "use strict";
        ...
        re = L({
      "node_modules/graphql/jsutils/inspect.js": function node_modulesGraphqlJsutilsInspectJs(a) {
        "use strict";
        ...
        function c(v) {
          return typeof Symbol == "function" && _typeof(Symbol.iterator) == "symbol" ? c = function c(s) {
            return _typeof(s);
          } : c = function c(s) {
            return s && typeof Symbol == "function" && s.constructor === Symbol && s !== Symbol.prototype ? "symbol" : _typeof(s);
          }, c(v);
        }
        ...
        _e = L({
      "node_modules/graphql/jsutils/devAssert.js": function node_modulesGraphqlJsutilsDevAssertJs(a) {
        "use strict";
        ...
        Ee = L({
      "node_modules/graphql/jsutils/instanceOf.js": function node_modulesGraphqlJsutilsInstanceOfJs(a) {
        "use strict";
        ...
        me = L({
      "node_modules/graphql/language/source.js": function node_modulesGraphqlLanguageSourceJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.isSource = A, a.Source = void 0;
        ...
        ye = L({
      "node_modules/graphql/language/directiveLocation.js": function node_modulesGraphqlLanguageDirectiveLocationJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.DirectiveLocation = void 0;
        var d = Object.freeze({
          QUERY: "QUERY",
          MUTATION: "MUTATION",
        ...
        ke = L({
      "node_modules/graphql/language/blockString.js": function node_modulesGraphqlLanguageBlockStringJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.dedentBlockStringValue = d, a.getBlockStringIndentation = c, a.printBlockString = r;

        function d(_) {
          var E = _.split(/\r\n|[\n\r]/g),
              k = c(_);

          if (k !== 0) for (var O = 1; O < E.length; O++) {
            E[O] = E[O].slice(k);
          }
        ...
        Ne = L({
      "node_modules/graphql/language/lexer.js": function node_modulesGraphqlLanguageLexerJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.isPunctuatorTokenKind = E, a.Lexer = void 0;
        ...
        function O(t, u) {
          for (var y = t.source, f = y.body, m = f.length, o = u.end; o < m;) {
            ...
            switch (h) {
              ...
              case 46:
                if (f.charCodeAt(o + 1) === 46 && f.charCodeAt(o + 2) === 46) return new i.Token(c.TokenKind.SPREAD, o, o + 3, l, T, u);
                break;
        ...
        function g(t, u, y, f, m, o) {
          ...
          if (l === 45 && (l = h.charCodeAt(++T)), l === 48) {
            if (l = h.charCodeAt(++T), l >= 48 && l <= 57) throw (0, d.syntaxError)(t, T, "Invalid number, unexpected digit after 0: ".concat(k(l), "."));
          } else T = D(t, T, l), l = h.charCodeAt(T);

          if (l === 46 && (S = !0, l = h.charCodeAt(++T), T = D(t, T, l), l = h.charCodeAt(T)), (l === 69 || l === 101) && (S = !0, l = h.charCodeAt(++T), (l === 43 || l === 45) && (l = h.charCodeAt(++T)), T = D(t, T, l), l = h.charCodeAt(T)), l === 46 || n(l)) throw (0, d.syntaxError)(t, T, "Invalid number, expected digit but got: ".concat(k(l), "."));
        ...
        function v(t, u, y, f, m) {
          for (var o = t.body, h = u + 1, l = h, T = 0, S = ""; h < o.length && !isNaN(T = o.charCodeAt(h)) && T !== 10 && T !== 13;) {
            ...
            if (T < 32 && T !== 9) throw (0, d.syntaxError)(t, h, "Invalid character within String: ".concat(k(T), "."));
        ...
        function I(t, u, y, f, m, o) {
          for (var h = t.body, l = u + 3, T = l, S = 0, x = ""; l < h.length && !isNaN(S = h.charCodeAt(l));) {
            if (S === 34 && h.charCodeAt(l + 1) === 34 && h.charCodeAt(l + 2) === 34) return x += h.slice(T, l), new i.Token(c.TokenKind.BLOCK_STRING, u, l + 3, y, f, m, (0, r.dedentBlockStringValue)(x));
            if (S < 32 && S !== 9 && S !== 10 && S !== 13) throw (0, d.syntaxError)(t, l, "Invalid character within String: ".concat(k(S), "."));
        ...
        Oe = L({
      "node_modules/graphql/language/parser.js": function node_modulesGraphqlLanguageParserJs(a) {
        "use strict";

        K(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.parse = O, a.parseValue = A, a.parseType = N, a.Parser = void 0;
        ...
        var g = function () {
          ...
          return s.parseName = function () {
            ...
            if (this.peek(r.TokenKind.NAME)) switch (this._lexer.token.value) {
              case "query":
              case "mutation":
              case "subscription":
            ...
            var e = this._lexer.token;
            if (this.peek(r.TokenKind.BRACE_L)) return {
            ...
            var n = this.parseOperationType(),
                t;
            return this.peek(r.TokenKind.NAME) && (t = this.parseName()), {
              kind: i.Kind.OPERATION_DEFINITION,
              operation: n,
              name: t,
            ...
            var e = this._lexer.token;
            return this.expectToken(r.TokenKind.DOLLAR), {
            ...
            var e = this._lexer.token,
                ...
                t,
                u;
            return this.expectOptionalToken(r.TokenKind.COLON) ? (t = n, u = this.parseName()) : u = n, {
              kind: i.Kind.FIELD,
              alias: t,
              name: u,
            ...
            var e = this._lexer.token,
                n = this.parseName();
            return this.expectToken(r.TokenKind.COLON), {
            ...
            var e,
                n = this._lexer.token;
            return this.expectKeyword("fragment"), ((e = this._options) === null || e === void 0 ? void 0 : e.experimentalFragmentVariables) === !0 ? {
            ...
            var n = this._lexer.token;
            return this.expectToken(r.TokenKind.AT), {
            ...
            var e = this._lexer.token,
                n;
            return this.expectOptionalToken(r.TokenKind.BRACKET_L) ? (n = this.parseTypeReference(), this.expectToken(r.TokenKind.BRACKET_R), n = {
              kind: i.Kind.LIST_TYPE,
              type: n,
              loc: this.loc(e)
            }) : n = this.parseNamedType(), this.expectOptionalToken(r.TokenKind.BANG) ? {
            ...
            if (e.kind === r.TokenKind.NAME) switch (e.value) {
              case "schema":
            ...
            if (((e = this._options) === null || e === void 0 ? void 0 : e.allowLegacySDLImplementsInterfaces) === !0) {
              var n = [];
            ...
            var e;
            return ((e = this._options) === null || e === void 0 ? void 0 : e.allowLegacySDLEmptyFields) === !0 && this.peek(r.TokenKind.BRACE_L) && this._lexer.lookahead().kind === r.TokenKind.BRACE_R ? (this._lexer.advance(), this._lexer.advance(), []) : this.optionalMany(r.TokenKind.BRACE_L, this.parseFieldDefinition, r.TokenKind.BRACE_R);
            ...
            var n;
            if (((n = this._options) === null || n === void 0 ? void 0 : n.noLocation) !== !0) return new c.Location(e, this._lexer.lastToken, this._lexer.source);
          }, s.peek = function (e) {
            ...
            var n = this._lexer.token;
            if (n.kind === r.TokenKind.NAME && n.value === e) this._lexer.advance();else throw (0, d.syntaxError)(this._lexer.source, n.start, 'Expected "'.concat(e, '", found ').concat(D(n), "."));
    ...
    function Ke(a) {
      ...
      for (; c.kind !== "<EOF>";) {
        c.kind === "Comment" && (Object.assign(c, {
          column: c.column - 1
        }), d.push(c)), c = c.next;
      }
    ...
    function Le(a) {
      ...
      if (a instanceof d) {
        var i = a.message,
            _a$locations = _slicedToArray(a.locations, 1),
            c = _a$locations[0];
    ...
    function xe(a) {
      var _Oe = Oe(),
          d = _Oe.parse,
          _ge = ge(function () {
        return d(a, Object.assign({}, X));
      }, function () {
        return d(a, Object.assign(Object.assign({}, X), {}, {
