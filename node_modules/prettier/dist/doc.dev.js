...
(function (factory) {
  ...
  var require_doc_js_umd = __commonJS({
    "dist/_doc.js.umd.js": function dist_docJsUmdJs(exports, module) {
      ...
      var require_doc_builders = __commonJS2({
        "src/document/doc-builders.js": function srcDocumentDocBuildersJs(exports2, module2) {
          "use strict";
      ...
      var require_end_of_line = __commonJS2({
        "src/common/end-of-line.js": function srcCommonEndOfLineJs(exports2, module2) {
          "use strict";
          ...
          function countEndOfLineChars(text, eol) {
            ...
            var endOfLines = text.match(regex);
      ...
      var require_get_last = __commonJS2({
        "src/utils/get-last.js": function srcUtilsGetLastJs(exports2, module2) {
          "use strict";
      ...
      var require_emoji_regex = __commonJS2({
        "node_modules/emoji-regex/index.js": function node_modulesEmojiRegexIndexJs(exports2, module2) {
          "use strict";
      ...
      var require_get_string_width = __commonJS2({
        "src/utils/get-string-width.js": function srcUtilsGetStringWidthJs(exports2, module2) {
          "use strict";
      ...
      var require_doc_utils = __commonJS2({
        "src/document/doc-utils.js": function srcDocumentDocUtilsJs(exports2, module2) {
          "use strict";

          init_define_process();
          var getLast = require_get_last();

          var _require_doc_builders = require_doc_builders(),
              literalline = _require_doc_builders.literalline,
              join = _require_doc_builders.join;

          var isConcat = function isConcat(doc) {
            return Array.isArray(doc) || doc && doc.type === "concat";
          };

          var getDocParts = function getDocParts(doc) {
            ...
            while (docsStack.length > 0) {
              ...
              if (!onEnter || onEnter(doc2) !== false) {
                if (isConcat(doc2) || doc2.type === "fill") {
                  var parts = getDocParts(doc2);

                  for (var ic = parts.length, i = ic - 1; i >= 0; --i) {
                  ...
                  if (shouldTraverseConditionalGroups) {
                    for (var _ic = doc2.expandedStates.length, _i = _ic - 1; _i >= 0; --_i) {
                      docsStack.push(doc2.expandedStates[_i]);
                    }
                  } else {
          ...
          function mapDoc(doc, cb) {
            ...
            function process2(doc2) {
              ...
              if (doc2.type === "if-break") {
                var breakContents = doc2.breakContents && rec(doc2.breakContents);
                var flatContents = doc2.flatContents && rec(doc2.flatContents);
                return cb(Object.assign(Object.assign({}, doc2), {}, {
                  breakContents: breakContents,
                  flatContents: flatContents
                }));
              ...
              if (doc2.type === "group" && doc2.expandedStates) {
                var expandedStates = doc2.expandedStates.map(rec);
                var contents = expandedStates[0];
                return cb(Object.assign(Object.assign({}, doc2), {}, {
                  contents: contents,
              ...
              if (doc2.contents) {
                var _contents = rec(doc2.contents);
          ...
          function breakParentGroup(groupStack) {
            if (groupStack.length > 0) {
              var parentGroup = getLast(groupStack);
          ...
          var isHardline = function isHardline(doc, nextDoc) {
            return doc && doc.type === "line" && doc.hard && nextDoc && nextDoc.type === "break-parent";
          };
          ...
          function stripDocTrailingHardlineFromDoc(doc) {
            ...
            if (isConcat(doc) || doc.type === "fill") {
              var parts = getDocParts(doc);

              while (parts.length > 1 && isHardline.apply(void 0, _toConsumableArray(parts.slice(-2)))) {
                parts.length -= 2;
              }

              if (parts.length > 0) {
                var lastPart = stripDocTrailingHardlineFromDoc(getLast(parts));
            ...
            switch (doc.type) {
              ...
              case "label":
                {
                  var contents = stripDocTrailingHardlineFromDoc(doc.contents);
              ...
              case "if-break":
                {
                  var breakContents = stripDocTrailingHardlineFromDoc(doc.breakContents);
                  var flatContents = stripDocTrailingHardlineFromDoc(doc.flatContents);
                  return Object.assign(Object.assign({}, doc), {}, {
                    breakContents: breakContents,
                    flatContents: flatContents
                  });
          ...
          function cleanDocFn(doc) {
            switch (doc.type) {
              case "fill":
                if (doc.parts.every(function (part) {
                  return part === "";
                })) {
                  return "";
                }
            ...
            try {
              for (var _iterator4 = getDocParts(doc)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                ...
                var _ref2 = isConcat(part) ? getDocParts(part) : [part],
                    _ref3 = _toArray(_ref2),
                    currentPart = _ref3[0],
                    restParts = _ref3.slice(1);
                ...
                parts.push.apply(parts, _toConsumableArray(restParts));
              }
            } catch (err) {
          ...
          function cleanDoc(doc) {
            return mapDoc(doc, function (currentDoc) {
              return cleanDocFn(currentDoc);
            });
          }

          function normalizeParts(parts) {
            var newParts = [];
            var restParts = parts.filter(Boolean);
            ...
            while (restParts.length > 0) {
              ...
              if (isConcat(part)) {
                restParts.unshift.apply(restParts, _toConsumableArray(getDocParts(part)));
                continue;
              }
          ...
          function replaceTextEndOfLine(text) {
            var replacement = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : literalline;
      ...
      var require_doc_printer = __commonJS2({
        "src/document/doc-printer.js": function srcDocumentDocPrinterJs(exports2, module2) {
          "use strict";

          init_define_process();

          var _require_end_of_line = require_end_of_line(),
              convertEndOfLineToChars = _require_end_of_line.convertEndOfLineToChars;

          var getLast = require_get_last();
          var getStringWidth = require_get_string_width();

          var _require_doc_builders2 = require_doc_builders(),
              fill = _require_doc_builders2.fill,
              cursor = _require_doc_builders2.cursor,
              indent = _require_doc_builders2.indent;

          var _require_doc_utils = require_doc_utils(),
              isConcat = _require_doc_utils.isConcat,
              getDocParts = _require_doc_utils.getDocParts;
          ...
          function makeAlign(indent2, widthOrDoc, options) {
            ...
            var alignType = typeof widthOrDoc === "string" ? "stringAlign" : "numberAlign";
            return generateInd(indent2, {
              type: alignType,
              n: widthOrDoc
            }, options);
          ...
          function generateInd(ind, newPart, options) {
            var queue = newPart.type === "dedent" ? ind.queue.slice(0, -1) : [].concat(_toConsumableArray(ind.queue), [newPart]);
            var value = "";
            var length = 0;
            var lastTabs = 0;
            var lastSpaces = 0;
            ...
            try {
              for (var _iterator5 = queue[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          function trim(out) {
            ...
            if (out.length > 0 && typeof getLast(out) === "string") {
              var trimmed = getLast(out).replace(/[\t ]*$/, "");
            ...
            while (width >= 0) {
              ...
              if (typeof doc === "string") {
                ...
                switch (doc.type) {
                  ...
                  case "group":
                    {
                      ...
                      var groupMode = doc["break"] ? MODE_BREAK : mode;
                      var contents = doc.expandedStates && groupMode === MODE_BREAK ? getLast(doc.expandedStates) : doc.contents;
                      cmds.push({
                        mode: groupMode,
                        doc: contents
                      });
                  ...
                  case "if-break":
                    {
                      var _groupMode = doc.groupId ? groupModeMap[doc.groupId] || MODE_FLAT : mode;

                      var _contents2 = _groupMode === MODE_BREAK ? doc.breakContents : doc.flatContents;
          ...
          function printDocToString(doc, options) {
            ...
            while (cmds.length > 0) {
              var _cmds$pop2 = cmds.pop(),
                  ind = _cmds$pop2.ind,
                  mode = _cmds$pop2.mode,
                  doc2 = _cmds$pop2.doc;
              ...
              if (typeof doc2 === "string") {
                ...
                switch (doc2.type) {
                      ...
                      case MODE_BREAK:
                        {
                          ...
                          var rem = width - pos;
                          var hasLineSuffix = lineSuffix.length > 0;

                          if (!doc2["break"] && fits(next, cmds, rem, hasLineSuffix)) {
                            cmds.push(next);
                          } else {
                            if (doc2.expandedStates) {
                              var mostExpanded = getLast(doc2.expandedStates);
                              ...
                              if (doc2["break"]) {
                                ...
                                for (var _i2 = 1; _i2 < doc2.expandedStates.length + 1; _i2++) {
                                  if (_i2 >= doc2.expandedStates.length) {
                                    cmds.push({
                                      ind: ind,
                                      mode: MODE_BREAK,
                                      doc: mostExpanded
                                    ...
                                    var state = doc2.expandedStates[_i2];
                                    var cmd = {
                                      ind: ind,
                                      mode: MODE_FLAT,
                                      doc: state
                  ...
                  case "fill":
                    {
                      ...
                      var contentFits = fits(contentFlatCmd, [], _rem, lineSuffix.length > 0, true);
                      ...
                      var whitespaceFlatCmd = {
                        ind: ind,
                        mode: MODE_FLAT,
                        doc: whitespace
                      };
                      var whitespaceBreakCmd = {
                        ind: ind,
                        mode: MODE_BREAK,
                        doc: whitespace
                      };
                      ...
                      var secondContent = _parts[0];
                      var firstAndSecondContentFlatCmd = {
                        ind: ind,
                        mode: MODE_FLAT,
                        doc: [content, whitespace, secondContent]
                      };
                      var firstAndSecondContentFits = fits(firstAndSecondContentFlatCmd, [], _rem, lineSuffix.length > 0, true);
                  ...
                  case "indent-if-break":
                    {
                      var groupMode = doc2.groupId ? groupModeMap[doc2.groupId] : mode;

                      if (groupMode === MODE_BREAK) {
                        var breakContents = doc2.type === "if-break" ? doc2.breakContents : doc2.negate ? doc2.contents : indent(doc2.contents);
                      ...
                      if (groupMode === MODE_FLAT) {
                        var flatContents = doc2.type === "if-break" ? doc2.flatContents : doc2.negate ? indent(doc2.contents) : doc2.contents;
                  ...
                  case "line":
                    switch (mode) {
                      ...
                      case MODE_BREAK:
                        if (lineSuffix.length > 0) {
                          cmds.push.apply(cmds, [{
                            ind: ind,
                            mode: mode,
                            doc: doc2
                          }].concat(_toConsumableArray(lineSuffix.reverse())));
                          lineSuffix.length = 0;
                          break;
                        }
              ...
              if (cmds.length === 0 && lineSuffix.length > 0) {
                cmds.push.apply(cmds, _toConsumableArray(lineSuffix.reverse()));
                lineSuffix.length = 0;
              }
            }
      ...
      var require_doc_debug = __commonJS2({
        "src/document/doc-debug.js": function srcDocumentDocDebugJs(exports2, module2) {
          "use strict";

          init_define_process();

          var _require_doc_utils2 = require_doc_utils(),
              isConcat = _require_doc_utils2.isConcat,
              getDocParts = _require_doc_utils2.getDocParts;
          ...
          function flattenDoc(doc) {
            ...
            if (isConcat(doc)) {
              ...
              try {
                for (var _iterator6 = getDocParts(doc)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                  var part = _step6.value;

                  if (isConcat(part)) {
                    res.push.apply(res, _toConsumableArray(flattenDoc(part).parts));
                  } else {
                    var flattened = flattenDoc(part);
          ...
          function printDocToDebug(doc) {
            ...
            function printDoc(doc2, index, parentParts) {
              ...
              if (isConcat(doc2)) {
                var printed = getDocParts(doc2).map(printDoc).filter(Boolean);
                return printed.length === 1 ? printed[0] : "[".concat(printed.join(", "), "]");
              }

              if (doc2.type === "line") {
                var withBreakParent = Array.isArray(parentParts) && parentParts[index + 1] && parentParts[index + 1].type === "break-parent";
              ...
              if (doc2.type === "break-parent") {
                var afterHardline = Array.isArray(parentParts) && parentParts[index - 1] && parentParts[index - 1].type === "line" && parentParts[index - 1].hard;
              ...
              if (doc2.type === "indent-if-break") {
                ...
                var options = optionsParts.length > 0 ? ", { ".concat(optionsParts.join(", "), " }") : "";
              ...
              if (doc2.type === "group") {
                ...
                if (doc2["break"] && doc2["break"] !== "propagated") {
                  _optionsParts.push("shouldBreak: true");
                }

                if (doc2.id) {
                  _optionsParts.push("id: ".concat(printGroupId(doc2.id)));
                }

                var _options = _optionsParts.length > 0 ? ", { ".concat(_optionsParts.join(", "), " }") : "";

                if (doc2.expandedStates) {
                  return "conditionalGroup([".concat(doc2.expandedStates.map(function (part) {
                    return printDoc(part);
                  }).join(","), "]").concat(_options, ")");
                }

                return "group(".concat(printDoc(doc2.contents)).concat(_options, ")");
              }

              if (doc2.type === "fill") {
                return "fill([".concat(doc2.parts.map(function (part) {
                  return printDoc(part);
                }).join(", "), "])");
              }
            ...
            function printGroupId(id) {
              ...
              var prefix = String(id).slice(7, -1) || "symbol";

              for (var counter = 0;; counter++) {
                var key = prefix + (counter > 0 ? " #".concat(counter) : "");
