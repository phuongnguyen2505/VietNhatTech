...
(function (e) {
  ...
  var oe = C(function (tl, zr) {
    var Ye = function Ye(a) {
      return a && a.Math == Math && a;
    };

    zr.exports = Ye((typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) == "object" && globalThis) || Ye((typeof window === "undefined" ? "undefined" : _typeof(window)) == "object" && window) || Ye((typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" && self) || Ye((typeof global === "undefined" ? "undefined" : _typeof(global)) == "object" && global) || function () {
      return this;
    }() || Function("return this")();
  });
  var me = C(function (rl, Gr) {
  ...
  var ye = C(function (ol, ri) {
    var ei = bt(),
        ti = Function.prototype,
        St = ti.call,
        An = ei && ti.bind.bind(St, St);
  ...
  var kt = C(function (cl, oi) {
    oi.exports = function (a) {
      return a == null;
    };
  });
  var Ft = C(function (pl, hi) {
    var kn = kt(),
        Fn = TypeError;

    hi.exports = function (a) {
      if (kn(a)) throw Fn("Can't call method on " + a);
      return a;
    };
  });
  var tt = C(function (fl, li) {
    var Bn = ui(),
        In = Ft();
  ...
  var It = C(function (dl, ci) {
    var Bt = (typeof document === "undefined" ? "undefined" : _typeof(document)) == "object" && document.all,
        Tn = _typeof(Bt) > "u" && Bt !== void 0;
    ci.exports = {
      all: Bt,
      IS_HTMLDDA: Tn
    };
  });
  var le = C(function (ml, fi) {
    var pi = It(),
        Pn = pi.all;
  ...
  var Pe = C(function (vl, vi) {
    var di = le(),
        mi = It(),
        Dn = mi.all;
    vi.exports = mi.IS_HTMLDDA ? function (a) {
      return _typeof(a) == "object" ? a !== null : di(a) || a === Dn;
    } : function (a) {
      return _typeof(a) == "object" ? a !== null : di(a);
    };
  });
  var rt = C(function (gl, gi) {
    var Tt = oe(),
        Nn = le(),
        On = function On(a) {
  ...
  var yi = C(function (xl, xi) {
    var Ln = ye();
    xi.exports = Ln({}.isPrototypeOf);
  });
  var Ci = C(function (yl, Ai) {
    var Vn = rt();
    Ai.exports = Vn("navigator", "userAgent") || "";
  });
  var Fi = C(function (Al, ki) {
    var wi = oe(),
        Pt = Ci(),
        Ei = wi.process,
        bi = wi.Deno,
        _i = Ei && Ei.versions || bi && bi.version,
        Si = _i && _i.v8,
        ce,
        it;
  ...
  var Nt = C(function (El, Ti) {
    var jn = Dt();
    Ti.exports = jn && !Symbol.sham && _typeof(Symbol.iterator) == "symbol";
  });
  var Ot = C(function (bl, Pi) {
    var qn = rt(),
        Mn = le(),
        Un = yi(),
        Wn = Nt(),
  ...
  var qi = C(function (kl, ji) {
    ...
    ji.exports = function (a, u) {
      var o, l;
      if (u === "string" && Vt(o = a.toString) && !Rt(l = Lt(o, a)) || Vt(o = a.valueOf) && !Rt(l = Lt(o, a)) || u !== "string" && Vt(o = a.toString) && !Rt(l = Lt(o, a))) return l;
      throw $n("Can't convert object to primitive value");
    };
  });
  var Ui = C(function (Fl, Mi) {
    Mi.exports = !1;
  });
  var st = C(function (Bl, zi) {
    var Wi = oe(),
  ...
  var ss = C(function (Ol, is) {
    var pu = oe(),
        ...
        we = pu.Symbol,
        ts = we && we["for"],
        mu = rs ? we : we && we.withoutSetter || du;
  ...
  var os = C(function (Ll, us) {
    ...
    us.exports = function (a, u) {
      ...
      if (o) {
        if (u === void 0 && (u = "default"), l = vu(o, a, u), !as(l) || ns(l)) return l;
  ...
  var ps = C(function (Rl, cs) {
    var _u = oe(),
        ls = Pe(),
        Ut = _u.document,
        Su = ls(Ut) && ls(Ut.createElement);

    cs.exports = function (a) {
      return Su ? Ut.createElement(a) : {};
    };
  });
  var Wt = C(function (jl, fs) {
    var wu = xe(),
        ku = me(),
        Fu = ps();
    fs.exports = !wu && !ku(function () {
  ...
  var zt = C(function (ms) {
    ...
    ms.f = Bu ? ds : function (u, o) {
      if (u = Du(u), o = Nu(o), Lu) try {
        return ds(u, o);
      } catch (_unused4) {}
      if (Ou(u, o)) return Pu(!Iu(Tu.f, u, o), u[o]);
    };
  });
  var gs = C(function (Ml, vs) {
    var Vu = xe(),
        Ru = me();
  ...
  var Me = C(function (As) {
    ...
    As.f = Uu ? zu ? function (u, o, l) {
      if (ut(u), o = ys(o), ut(l), typeof u == "function" && o === "prototype" && "value" in l && Xt in l && !l[Xt]) {
        var v = Hu(u, o);
        v && v[Xt] && (u[o] = l.value, l = {
          configurable: Kt in l ? l[Kt] : v[Kt],
          enumerable: Ht in l ? l[Ht] : v[Ht],
          writable: !1
        });
      }
      ...
      if (ut(u), o = ys(o), ut(l), Wu) try {
        return Gt(u, o, l);
      } catch (_unused5) {}
      if ("get" in l || "set" in l) throw Gu("Accessors not supported");
      return "value" in l && (u[o] = l.value), u;
    };
  });
  var Jt = C(function (zl, Cs) {
    var Ku = xe(),
        Xu = Me(),
        Ju = _t();
  ...
  var _s = C(function (Gl, bs) {
    var Qt = xe(),
        Qu = be(),
        Es = Function.prototype,
        $u = Qt && Object.getOwnPropertyDescriptor,
        $t = Qu(Es, "name"),
        Yu = $t && function () {}.name === "something",
        Zu = $t && (!Qt || Qt && $u(Es, "name").configurable);
  ...
  var Zt = C(function (Jl, Ds) {
    Ds.exports = {};
  });
  var Vs = C(function (Ql, Ls) {
    var uo = Bs(),
        Os = oe(),
        oo = Pe(),
        ho = Jt(),
      ...
      return function (u) {
        var o;
        if (!oo(u) || (o = Ue(u)).type !== a) throw rr("Incompatible receiver, " + a + " required");
        return o;
      };
    };

    uo || tr.state ? (pe = tr.state || (tr.state = new po()), pe.get = pe.get, pe.has = pe.has, pe.set = pe.set, ot = function ot(a, u) {
      if (pe.has(a)) throw rr(Ns);
      return u.facade = a, pe.set(a, u), u;
    }, Ue = function Ue(a) {
      return pe.get(a) || {};
    }, ht = function ht(a) {
      return pe.has(a);
    }) : (ke = lo("state"), co[ke] = !0, ot = function ot(a, u) {
      if (er(a, ke)) throw rr(Ns);
  ...
  var sr = C(function ($l, js) {
    var vo = me(),
        ...
        Eo = ir && !vo(function () {
      return ct(function () {}, "length", {
        value: 8
      }).length !== 8;
    }),
        bo = String(String).split("String"),
        _o = js.exports = function (a, u, o) {
      String(u).slice(0, 7) === "Symbol(" && (u = "[" + String(u).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), o && o.getter && (u = "get " + u), o && o.setter && (u = "set " + u), (!lt(a, "name") || xo && a.name !== u) && (ir ? ct(a, "name", {
        value: u,
        configurable: !0
      }) : a.name = u), Eo && o && lt(o, "arity") && a.length !== o.arity && ct(a, "length", {
        value: o.arity
      });

      try {
        o && lt(o, "constructor") && o.constructor ? ir && ct(a, "prototype", {
          writable: !1
  ...
  var Ms = C(function (Yl, qs) {
    ...
    qs.exports = function (a, u, o, l) {
      l || (l = {});
      var v = l.enumerable,
          b = l.name !== void 0 ? l.name : u;
      if (So(o) && ko(o, b, l), l.global) v ? a[u] = o : Fo(u, o);else {
        try {
          l.unsafe ? a[u] && (v = !0) : delete a[u];
        } catch (_unused7) {}
  ...
  var ma = C(function (cc, da) {
    var ih = me(),
        sh = le(),
        ah = /#|\.prototype\./,
        We = function We(a, u) {
      var o = uh[nh(a)];
      return o == hh ? !0 : o == oh ? !1 : sh(u) ? ih(u) : !!u;
    },
  ...
  var ga = C(function (pc, va) {
    ...
    va.exports = function (a, u) {
      var o = a.target,
          ...
          x,
          R;
      if (l ? y = ur : v ? y = ur[o] || fh(o, {}) : y = (ur[o] || {}).prototype, y) for (I in u) {
        if (x = u[I], a.dontCallGetSet ? (R = lh(y, I), T = R && R.value) : T = y[I], b = mh(l ? I : o + (v ? "." : "#") + I, a.forced), !b && T !== void 0) {
          if (_typeof(x) == _typeof(T)) continue;
          dh(x, T);
        }

        (a.sham || T && T.sham) && ch(x, "sham", !0), ph(y, I, x, a);
      }
    };
  });
  var xa = C(function () {
  ...
  var Ea = C(function (gc, Ca) {
    var Aa = sr(),
        gh = Me();

    Ca.exports = function (a, u, o) {
      return o.get && Aa(o.get, u, {
        getter: !0
      }), o.set && Aa(o.set, u, {
        setter: !0
      }), gh.f(a, u, o);
  ...
  var Zh = C(function (Ec, Ka) {
    ...
    var pr = Object.defineProperty,
      ...
      for (var o in u) {
        ...
        Fh = function Fh(a, u, o, l) {
      if (u && _typeof(u) == "object" || typeof u == "function") {
        ...
        try {
          var _loop = function _loop() {
            var v = _step.value;
            !wh.call(a, v) && v !== o && pr(a, v, {
              get: function get() {
                return u[v];
              },
              enumerable: !(l = Sh(u, v)) || l.enumerable
            });
          };

          for (var _iterator = fr(u)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            _loop();
          }
        } catch (err) {
      ...
      "<define:process>": function defineProcess() {}
        ...
        dr = $({
      "src/common/parser-create-error.js": function srcCommonParserCreateErrorJs(a, u) {
        "use strict";

        J();

        function o(l, v) {
          var b = new SyntaxError(l + " (" + v.start.line + ":" + v.start.column + ")");
          return b.loc = v, b;
        }
        ...
        Ba = $({
      "src/utils/try-combinations.js": function srcUtilsTryCombinationsJs(a, u) {
        "use strict";
    ...
    function Ta() {
      if (_typeof(pt) > "u") {
        var a = new ArrayBuffer(2),
            u = new Uint8Array(a),
            o = new Uint16Array(a);
        if (u[0] = 1, u[1] = 2, o[0] === 258) pt = "BE";else if (o[0] === 513) pt = "LE";else throw new Error("unable to figure out endianess");
      }
    ...
    var pt,
      ...
      "node-modules-polyfills:os": function nodeModulesPolyfillsOs() {
        J(), lr = hr, cr = "\n", Ua = {
          ...
          tmpdir: lr,
          tmpDir: hr,
          networkInterfaces: qa,
          getNetworkInterfaces: Ma,
          release: ja,
          type: Ra,
          cpus: Va,
          totalmem: La,
        ...
        Dh = $({
      "node-modules-polyfills-commonjs:os": function nodeModulesPolyfillsCommonjsOs(a, u) {
        J();
        var o = (Ph(), Bh(Ia));
        ...
        Nh = $({
      "node_modules/detect-newline/index.js": function node_modulesDetectNewlineIndexJs(a, u) {
        "use strict";
        ...
        u.exports = o, u.exports.graceful = function (l) {
          return typeof l == "string" && o(l) || "\n";
        };
      }
    }),
        Oh = $({
      "node_modules/jest-docblock/build/index.js": function node_modulesJestDocblockBuildIndexJs(a) {
        ...
        J(), Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.extract = g, a.parse = G, a.parseWithComments = f, a.print = B, a.strip = w;
        ...
        function f(k) {
          var X = (0, o()["default"])(k) || u().EOL;
          k = k.replace(b, "").replace(v, "").replace(U, "$1");
          var O = "";

          for (; O !== k;) {
            O = k, k = k.replace(x, "".concat(X, "$1 $2").concat(X));
          }

          k = k.replace(T, "").trimRight();
          var i = Object.create(null),
              S = k.replace(R, "").replace(T, "").trimRight(),
              F;
        ...
        function B(k) {
          var _k$comments = k.comments,
              X = _k$comments === void 0 ? "" : _k$comments,
              _k$pragmas = k.pragmas,
              O = _k$pragmas === void 0 ? {} : _k$pragmas,
              i = (0, o()["default"])(X) || u().EOL,
              S = "/**",
              F = " *",
              j = " */",
              Z = Object.keys(O),
              ne = Z.map(function (ie) {
            return V(ie, O[ie]);
          }).reduce(function (ie, Ne) {
            return ie.concat(Ne);
          }, []).map(function (ie) {
            return "".concat(F, " ").concat(ie).concat(i);
          }).join("");
          ...
          if (!X) {
            ...
            if (Z.length === 1 && !Array.isArray(O[Z[0]])) {
              var ie = O[Z[0]];
              return "".concat(S, " ").concat(V(Z[0], ie)[0]).concat(j);
            }
          }

          var ee = X.split(i).map(function (ie) {
            return "".concat(F, " ").concat(ie);
          }).join(i) + i;
          return S + i + (X ? ee : "") + (X && Z.length ? F + i : "") + ne + j;
        }

        function V(k, X) {
          return D.concat(X).map(function (O) {
            return "@".concat(k, " ").concat(O).trim();
          });
        }
      }
    }),
        Lh = $({
      "src/common/end-of-line.js": function srcCommonEndOfLineJs(a, u) {
        "use strict";
        ...
        u.exports = {
          ...
          countEndOfLineChars: v,
          normalizeEndOfLine: b
        };
      }
    }),
        Vh = $({
      "src/language-js/utils/get-shebang.js": function srcLanguageJsUtilsGetShebangJs(a, u) {
        "use strict";
        ...
        Rh = $({
      "src/language-js/pragma.js": function srcLanguageJsPragmaJs(a, u) {
        "use strict";

        J();

        var _Oh = Oh(),
            o = _Oh.parseWithComments,
            l = _Oh.strip,
            v = _Oh.extract,
            b = _Oh.print,
            _Lh = Lh(),
            y = _Lh.normalizeEndOfLine,
            I = Vh();
        ...
        jh = $({
      "src/utils/is-non-empty-array.js": function srcUtilsIsNonEmptyArrayJs(a, u) {
        "use strict";
        ...
        Wa = $({
      "src/language-js/loc.js": function srcLanguageJsLocJs(a, u) {
        "use strict";
        ...
        function l(T) {
          var x, R;
          var U = T.range ? T.range[0] : T.start,
              D = (x = (R = T.declaration) === null || R === void 0 ? void 0 : R.decorators) !== null && x !== void 0 ? x : T.decorators;
        ...
        za = $({
      "src/language-js/parse/utils/create-parser.js": function srcLanguageJsParseUtilsCreateParserJs(a, u) {
        "use strict";
        ...
        qh = $({
      "src/language-js/utils/is-ts-keyword-type.js": function srcLanguageJsUtilsIsTsKeywordTypeJs(a, u) {
        "use strict";
        ...
        Mh = $({
      "src/language-js/utils/is-block-comment.js": function srcLanguageJsUtilsIsBlockCommentJs(a, u) {
        "use strict";

        J();

        var o = new Set(["Block", "CommentBlock", "MultiLine"]),
            l = function l(v) {
          return o.has(v == null ? void 0 : v.type);
        };
        ...
        Uh = $({
      "src/language-js/utils/is-type-cast-comment.js": function srcLanguageJsUtilsIsTypeCastCommentJs(a, u) {
        "use strict";
        ...
        Wh = $({
      "src/utils/get-last.js": function srcUtilsGetLastJs(a, u) {
        "use strict";
        ...
        zh = $({
      "src/language-js/parse/postprocess/visit-node.js": function srcLanguageJsParsePostprocessVisitNodeJs(a, u) {
        "use strict";
        ...
        function o(l, v) {
          ...
          if (l && _typeof(l) == "object" && typeof l.type == "string") {
            var _b = Object.keys(l);

            for (var y = 0; y < _b.length; y++) {
              l[_b[y]] = o(l[_b[y]], v);
            }
        ...
        Gh = $({
      "src/language-js/parse/postprocess/throw-syntax-error.js": function srcLanguageJsParsePostprocessThrowSyntaxErrorJs(a, u) {
        "use strict";
        ...
        Ga = $({
      "src/language-js/parse/postprocess/index.js": function srcLanguageJsParsePostprocessIndexJs(a, u) {
        "use strict";
          ...
          if (w.parser !== "typescript" && w.parser !== "flow" && w.parser !== "acorn" && w.parser !== "espree" && w.parser !== "meriyah") {
            ...
            g = I(g, function (B) {
              ...
              if (B.type === "ParenthesizedExpression") {
                ...
                var k = o(B);
                if (!f.has(k)) return V.extra = Object.assign(Object.assign({}, V.extra), {}, {
                  parenthesized: !0
                }), V;
              }
            });
            ...
            switch (f.type) {
              ...
              case "ObjectExpression":
                if (w.parser === "typescript") {
                  var _B2 = f.properties.find(function (V) {
                    return V.type === "Property" && V.value.type === "TSEmptyBodyFunctionExpression";
                  });

                  _B2 && T(_B2.value, "Unexpected token.");
                }
              ...
              case "SequenceExpression":
                {
                  var _B3 = y(f.expressions);

                  f.range = [o(f), Math.min(l(_B3), l(f))];
                  break;
                }

              case "TopicReference":
                w.__isUsingHackPipeline = !0;
                break;
              ...
              case "ExportAllDeclaration":
                {
                  ...
                  if (w.parser === "meriyah" && _B4 && _B4.type === "Identifier") {
                    var V = w.originalText.slice(o(_B4), l(_B4));
                    (V.startsWith('"') || V.startsWith("'")) && (f.exported = Object.assign(Object.assign({}, f.exported), {}, {
                      type: "Literal",
                      value: f.exported.name,
                      raw: V
                    }));
                  }
        ...
        ft = $({
      "node_modules/acorn/dist/acorn.js": function node_modulesAcornDistAcornJs(a, u) {
        J(), function (o, l) {
          _typeof(a) == "object" && _typeof(u) < "u" ? l(a) : typeof define == "function" && define.amd ? define(["exports"], l) : (o = (typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) < "u" ? globalThis : o || self, l(o.acorn = {}));
        }(a, function (o) {
          "use strict";
          ...
          var l = [509, 0, 227, 0, 150, 4, 294, 9, 1368, 2, 2, 1, 6, 3, 41, 2, 5, 0, 166, 1, 574, 3, 9, 9, 370, 1, 154, 10, 50, 3, 123, 2, 54, 14, 32, 10, 3, 1, 11, 3, 46, 10, 8, 0, 46, 9, 7, 2, 37, 13, 2, 9, 6, 1, 45, 0, 13, 2, 49, 13, 9, 3, 2, 11, 83, 11, 7, 0, 161, 11, 6, 9, 7, 3, 56, 1, 2, 6, 3, 1, 3, 2, 10, 0, 11, 1, 3, 6, 4, 4, 193, 17, 10, 9, 5, 0, 82, 19, 13, 9, 214, 6, 3, 8, 28, 1, 83, 16, 16, 9, 82, 12, 9, 9, 84, 14, 5, 9, 243, 14, 166, 9, 71, 5, 2, 1, 3, 3, 2, 0, 2, 1, 13, 9, 120, 6, 3, 6, 4, 0, 29, 9, 41, 6, 2, 3, 9, 0, 10, 10, 47, 15, 406, 7, 2, 7, 17, 9, 57, 21, 2, 13, 123, 5, 4, 0, 2, 1, 2, 6, 2, 0, 9, 9, 49, 4, 2, 1, 2, 4, 9, 9, 330, 3, 19306, 9, 87, 9, 39, 4, 60, 6, 26, 9, 1014, 0, 2, 54, 8, 3, 82, 0, 12, 1, 19628, 1, 4706, 45, 3, 22, 543, 4, 4, 5, 9, 7, 3, 6, 31, 3, 149, 2, 1418, 49, 513, 54, 5, 49, 9, 0, 15, 0, 23, 4, 2, 14, 1361, 6, 2, 16, 3, 6, 2, 1, 2, 4, 262, 6, 10, 9, 357, 0, 62, 13, 1495, 6, 110, 6, 6, 9, 4759, 9, 787719, 239],
            ...
            strictBind: "eval arguments"
              ...
              T = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this",
              x = {
            5: T,
          ...
          function w(e, t) {
            return e < 65 ? e === 36 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && U.test(String.fromCharCode(e)) : t === !1 ? !1 : g(e, v);
          }

          function G(e, t) {
            return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && D.test(String.fromCharCode(e)) : t === !1 ? !1 : g(e, v) || g(e, l);
          }
          ...
          var i = {
            num: new f("num", k),
            regexp: new f("regexp", k),
            string: new f("string", k),
            name: new f("name", k),
            privateId: new f("privateId", k),
            eof: new f("eof"),
            bracketL: new f("[", {
              beforeExpr: !0,
              startsExpr: !0
          ...
          function mt(e, t) {
            return function (r, s, n, h, c, m) {
              ...
              e.locations && (A.loc = new te(this, c, m)), e.ranges && (A.range = [n, h]), t.push(A);
            };
          }
          ...
          Y.prototype.parse = function () {
            ...
            for (var e = this.scopeStack.length - 1; e >= 0; e--) {
              ...
              if (t.inClassFieldInit || t.flags & Le) return !1;
          ...
          L.isLet = function (e) {
            ...
            if (w(s, !0)) {
              for (var n = r + 1; G(s = this.input.charCodeAt(n), !0);) {
                ++n;
              }

              if (s === 92 || s > 55295 && s < 56320) return !0;
              var h = this.input.slice(r, n);
              if (!R.test(h)) return !0;
            }
              ...
              case i._import:
                if (this.options.ecmaVersion > 10 && s === i._import) {
                  ...
                  var c = ee.exec(this.input),
                      m = this.pos + c[0].length,
                      A = this.input.charCodeAt(m);
            ...
            if (this.labels.push(At), this.enterScope(0), this.expect(i.parenL), this.type === i.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
            var r = this.isLet();

            if (this.type === i._var || this.type === i._const || r) {
              var s = this.startNode(),
                  n = r ? "let" : this.value;
              return this.next(), this.parseVar(s, !0, n), this.finishNode(s, "VariableDeclaration"), (this.type === i._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && s.declarations.length === 1 ? (this.options.ecmaVersion >= 9 && (this.type === i._in ? t > -1 && this.unexpected(t) : e["await"] = t > -1), this.parseForIn(e, s)) : (t > -1 && this.unexpected(t), this.parseFor(e, s));
            }

            var h = this.isContextual("let"),
                c = !1,
                m = new He(),
                A = this.parseExpression(t > -1 ? "await" : !0, m);
            return this.type === i._in || (c = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (this.options.ecmaVersion >= 9 && (this.type === i._in ? t > -1 && this.unexpected(t) : e["await"] = t > -1), h && c && this.raise(A.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(A, !1, m), this.checkLValPattern(A), this.parseForIn(e, A)) : (this.checkExpressionErrors(m, !0), t > -1 && this.unexpected(t), this.parseFor(e, A));
          }, L.parseFunctionStatement = function (e, t, r) {
            return this.next(), this.parseFunction(e, Ve | (r ? 0 : Ct), !1, t);
            ...
            for (var t, r = !1; this.type !== i.braceR;) {
              if (this.type === i._case || this.type === i._default) {
                ...
                t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), s ? t.test = this.parseExpression() : (r && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), r = !0, t.test = null), this.expect(i.colon);
          ...
          L.parseTryStatement = function (e) {
            ...
            for (var m = this.type.isLoop ? "loop" : this.type === i._switch ? "switch" : null, A = this.labels.length - 1; A >= 0; A--) {
              var q = this.labels[A];
              if (q.statementStart === e.start) q.statementStart = this.start, q.kind = m;else break;
            }
            ...
            }), e.body = this.parseStatement(s ? s.indexOf("label") === -1 ? s + "label" : s : "label"), this.labels.pop(), e.label = r, this.finishNode(e, "LabeledStatement");
          }, L.parseExpressionStatement = function (e, t) {
            return e.expression = t, this.semicolon(), this.finishNode(e, "ExpressionStatement");
          }, L.parseBlock = function (e, t, r) {
            for (e === void 0 && (e = !0), t === void 0 && (t = this.startNode()), t.body = [], this.expect(i.braceL), e && this.enterScope(0); this.type !== i.braceR;) {
            ...
            e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? yt : ve, !1);
          };
          var Ve = 1,
              Ct = 2,
              Cr = 4;
          L.parseFunction = function (e, t, r, s, n) {
            ...
            return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(xt(e.async, e.generator)), t & Ve || (e.id = this.type === i.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, r, !1, n), this.yieldPos = h, this.awaitPos = c, this.awaitIdentPos = m, this.finishNode(e, t & Ve ? "FunctionDeclaration" : "FunctionExpression");
          }, L.parseFunctionParams = function (e) {
            this.expect(i.parenL), e.params = this.parseBindingList(i.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams();
            ...
            for (n.body = [], this.expect(i.braceL); this.type !== i.braceR;) {
              ...
              c && (n.body.push(c), c.type === "MethodDefinition" && c.kind === "constructor" ? (h && this.raise(c.start, "Duplicate constructor in the same class"), h = !0) : c.key && c.key.type === "PrivateIdentifier" && $a(s, c) && this.raiseRecoverable(c.key.start, "Identifier '#" + c.key.name + "' has already been declared"));
            }
            ...
            if (this.eatContextual("static")) {
              ...
              this.isClassElementNameStart() || this.type === i.star ? m = !0 : s = "static";
            }

            if (r["static"] = m, !s && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === i.star) && !this.canInsertSemicolon() ? h = !0 : s = "async"), !s && (t >= 9 || !h) && this.eat(i.star) && (n = !0), !s && !h && !n) {
              var A = this.value;
              (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? c = A : s = A);
            }

            if (s ? (r.computed = !1, r.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), r.key.name = s, this.finishNode(r.key, "Identifier")) : this.parseClassElementName(r), t < 13 || this.type === i.parenL || c !== "method" || n || h) {
              var q = !r["static"] && Ke(r, "constructor"),
                  W = q && e;
            ...
            this.type === i.privateId ? (this.value === "constructor" && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = !1, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e);
          }, L.parseClassMethod = function (e, t, r, s) {
            var n = e.key;
            e.kind === "constructor" ? (t && this.raise(n.start, "Constructor can't be a generator"), r && this.raise(n.start, "Constructor can't be an async method")) : e["static"] && Ke(e, "prototype") && this.raise(n.start, "Classes may not have a static property named prototype");
            ...
            this.type === i.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, ve, !1)) : (t === !0 && this.unexpected(), e.id = null);
          ...
          function $a(e, t) {
            var r = t.key.name,
                s = e[r],
                n = "true";
            return t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set") && (n = (t["static"] ? "s" : "i") + t.kind), s === "iget" && n === "iset" || s === "iset" && n === "iget" || s === "sget" && n === "sset" || s === "sset" && n === "sget" ? (e[r] = "true", !1) : s ? !0 : (e[r] = n, !1);
          }
          ...
          L.parseExport = function (e, t) {
            ...
            if (this.eat(i._default)) {
              ...
              if (this.type === i._function || (r = this.isAsyncFunction())) {
                var s = this.startNode();
                this.next(), r && this.next(), e.declaration = this.parseFunction(s, Ve | Cr, !1, r);
            ...
            if (this.shouldParseExportStatement()) e.declaration = this.parseStatement(null), e.declaration.type === "VariableDeclaration" ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null;else {
              if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== i.string && this.unexpected(), e.source = this.parseExprAtom();else {
            ...
            e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), P(e, t) && this.raiseRecoverable(r, "Duplicate export '" + t + "'"), e[t] = !0);
          }, L.checkPatternExport = function (e, t) {
            var r = t.type;
            if (r === "Identifier") this.checkExport(e, t, t.start);else if (r === "ObjectPattern") for (var s = 0, n = t.properties; s < n.length; s += 1) {
              var h = n[s];
            ...
            for (this.expect(i.braceL); !this.eat(i.braceR);) {
              if (r) r = !1;else if (this.expect(i.comma), this.afterTrailingComma(i.braceR)) break;
              var s = this.startNode();
            ...
            for (this.expect(i.braceL); !this.eat(i.braceR);) {
              if (t) t = !1;else if (this.expect(i.comma), this.afterTrailingComma(i.braceR)) break;
              var n = this.startNode();
          ...
          he.toAssignable = function (e, t, r) {
            ...
            if (this.options.ecmaVersion >= 6) switch (this.type) {
              case i.bracketL:
                var e = this.startNode();
                return this.next(), e.elements = this.parseBindingList(i.bracketR, !0, !0), this.finishNode(e, "ArrayPattern");
            ...
            for (var s = [], n = !0; !this.eat(e);) {
              if (n ? n = !1 : this.expect(i.comma), t && this.type === i.comma) s.push(null);else {
          ...
          Fe.initialContext = function () {
            ...
            return t === Q.f_expr || t === Q.f_stat ? !0 : e === i.colon && (t === Q.b_stat || t === Q.b_expr) ? !t.isExpr : e === i._return || e === i.name && this.exprAllowed ? S.test(this.input.slice(this.lastTokEnd, this.start)) : e === i._else || e === i.semi || e === i.eof || e === i.parenR || e === i.arrow ? !0 : e === i.braceL ? t === Q.b_stat : e === i._var || e === i._const || e === i.name ? !1 : !this.exprAllowed;
            ...
            var t,
                r = this.type;
            r.keyword && e === i.dot ? this.exprAllowed = !1 : (t = r.updateContext) ? t.call(this, e) : this.exprAllowed = r.beforeExpr;
          ...
          }, i.incDec.updateContext = function () {}, i._function.updateContext = i._class.updateContext = function (e) {
            e.beforeExpr && e !== i._else && !(e === i.semi && this.curContext() !== Q.p_stat) && !(e === i._return && S.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === i.colon || e === i.braceL) && this.curContext() === Q.b_stat) ? this.context.push(Q.f_expr) : this.context.push(Q.f_stat), this.exprAllowed = !1;
            ...
            var t = !1;
            this.options.ecmaVersion >= 6 && e !== i.dot && (this.value === "of" && !this.exprAllowed || this.value === "yield" && this.inGeneratorContext()) && (t = !0), this.exprAllowed = t;
          };
          var M = Y.prototype;
          M.checkPropClash = function (e, t, r) {
            if (!(this.options.ecmaVersion >= 9 && e.type === "SpreadElement") && !(this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
              ...
              if (this.options.ecmaVersion >= 6) {
                n === "__proto__" && h === "init" && (t.proto && (r ? r.doubleProto < 0 && (r.doubleProto = s.start) : this.raiseRecoverable(s.start, "Redefinition of __proto__ property")), t.proto = !0);
                return;
              }
            ...
            var s = !1,
                ...
                h = -1,
                c = -1;
            t ? (n = t.parenthesizedAssign, h = t.trailingComma, c = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new He(), s = !0);
            var m = this.start,
                A = this.startLoc;
            ...
            if (r && (q = r.call(this, q, m, A)), this.type.isAssign) {
              ...
              return W.operator = this.value, this.type === i.eq && (q = this.toAssignable(q, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= q.start && (t.shorthandAssign = -1), this.type === i.eq ? this.checkLValPattern(q) : this.checkLValSimple(q), W.left = q, this.next(), W.right = this.parseMaybeAssign(e), c > -1 && (t.doubleProto = c), this.finishNode(W, "AssignmentExpression");
            ...
            if (h != null && (!n || this.type !== i._in) && h > s) {
              var c = this.type === i.logicalOR || this.type === i.logicalAND,
                  m = this.type === i.coalesce;
              m && (h = i.logicalAND.binop);
              var A = this.value;
              this.next();
              var q = this.start,
                  W = this.startLoc,
                  re = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, n), q, W, h, n),
                  Se = this.buildBinary(t, r, e, re, A, c || m);
            ...
            var n = this.start,
                h = this.startLoc,
                c;
            if (this.isContextual("await") && this.canAwait) c = this.parseAwait(s), t = !0;else if (this.type.prefix) {
              var m = this.startNode(),
                  A = this.type === i.incDec;
              m.operator = this.value, m.prefix = !0, this.next(), m.argument = this.parseMaybeUnary(null, !0, A, s), this.checkExpressionErrors(e, !0), A ? this.checkLValSimple(m.argument) : this.strict && m.operator === "delete" && m.argument.type === "Identifier" ? this.raiseRecoverable(m.start, "Deleting local variable in strict mode") : m.operator === "delete" && Er(m.argument) ? this.raiseRecoverable(m.start, "Private fields can not be deleted") : t = !0, c = this.finishNode(m, A ? "UpdateExpression" : "UnaryExpression");
            } else if (!t && this.type === i.privateId) (s || this.privateNameStack.length === 0) && this.unexpected(), c = this.parsePrivateIdent(), this.type !== i._in && this.unexpected();else {
              if (c = this.parseExprSubscripts(e, s), this.checkExpressionErrors(e)) return c;

              for (; this.type.postfix && !this.canInsertSemicolon();) {
                var q = this.startNodeAt(n, h);
                q.operator = this.value, q.prefix = !1, q.argument = c, this.checkLValSimple(c), this.next(), c = this.finishNode(q, "UpdateExpression");
              }
            }
            if (!r && this.eat(i.starstar)) {
              if (t) this.unexpected(this.lastTokStart);else return this.buildBinary(n, h, c, this.parseMaybeUnary(null, !1, !1, s), "**", !1);
            } else return c;
          };
          ...
          M.parseExprSubscripts = function (e, t) {
            ...
            var h = this.parseSubscripts(n, r, s, !1, t);
            ...
            for (var h = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start, c = !1;;) {
              var m = this.parseSubscript(e, t, r, s, h, c, n);

              if (m.optional && (c = !0), m === e || m.type === "ArrowFunctionExpression") {
                if (c) {
            ...
            if (q || A && this.type !== i.parenL && this.type !== i.backQuote || this.eat(i.dot)) {
              ...
              var re = new He(),
                  Se = this.yieldPos,
                  qe = this.awaitPos,
                  Be = this.awaitIdentPos;
              this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
              var $e = this.parseExprList(i.parenR, this.options.ecmaVersion >= 8, !1, re);
              ...
              this.checkExpressionErrors(re, !0), this.yieldPos = Se || this.yieldPos, this.awaitPos = qe || this.awaitPos, this.awaitIdentPos = Be || this.awaitIdentPos;
              ...
              Te.tag = e, Te.quasi = this.parseTemplate({
                isTagged: !0
            ...
            switch (this.type) {
              ...
              case i.name:
                var n = this.start,
                    ...
                    c = this.containsEsc,
                    m = this.parseIdent(!1);
                if (this.options.ecmaVersion >= 8 && !c && m.name === "async" && !this.canInsertSemicolon() && this.eat(i._function)) return this.overrideContext(Q.f_expr), this.parseFunction(this.startNodeAt(n, h), 0, !1, !0, t);

                if (s && !this.canInsertSemicolon()) {
                  if (this.eat(i.arrow)) return this.parseArrowExpression(this.startNodeAt(n, h), [m], !1, t);
                  if (this.options.ecmaVersion >= 8 && m.name === "async" && this.type === i.name && !c && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return m = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(i.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, h), [m], !0, t);
                }
              ...
              case i.regexp:
                var A = this.value;
                return r = this.parseLiteral(A.value), r.regex = {
                  pattern: A.pattern,
                  flags: A.flags
                }, r;
              ...
              case i.parenL:
                var q = this.start,
                    W = this.parseParenAndDistinguishExpression(s, t);
              ...
              case i.bracketL:
                return r = this.startNode(), this.next(), r.elements = this.parseExprList(i.bracketR, !0, !0, e), this.finishNode(r, "ArrayExpression");
            ...
            if (this.options.ecmaVersion >= 6) {
              ...
              for (this.yieldPos = 0, this.awaitPos = 0; this.type !== i.parenR;) {
                if (q ? q = !1 : this.expect(i.comma), h && this.afterTrailingComma(i.parenR, !0)) {
                  W = !0;
                  break;
                  ...
                  break;
                } else A.push(this.parseMaybeAssign(!1, re, this.parseParenItem));
              }

              var $e = this.lastTokEnd,
                  Ie = this.lastTokEndLoc;
              if (this.expect(i.parenR), e && !this.canInsertSemicolon() && this.eat(i.arrow)) return this.checkPatternErrors(re, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = Se, this.awaitPos = qe, this.parseParenArrowList(r, s, A, t);
              (!A.length || W) && this.unexpected(this.lastTokStart), Be && this.unexpected(Be), this.checkExpressionErrors(re, !0), this.yieldPos = Se || this.yieldPos, this.awaitPos = qe || this.awaitPos, A.length > 1 ? (n = this.startNodeAt(c, m), n.expressions = A, this.finishNodeAt(n, "SequenceExpression", $e, Ie)) : n = A[0];
          ...
          M.parseNew = function () {
            ...
            return e.callee = this.parseSubscripts(this.parseExprAtom(), s, n, !0, !1), h && e.callee.type === "ImportExpression" && this.raise(s, "Cannot use new with import()"), this.eat(i.parenL) ? e.arguments = this.parseExprList(i.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Ya, this.finishNode(e, "NewExpression");
          }, M.parseTemplateElement = function (e) {
            var t = e.isTagged,
                r = this.startNode();
            return this.type === i.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), r.value = {
              raw: this.value,
              cooked: null
            }) : r.value = {
              raw: this.input.slice(this.start, this.end).replace(/\r\n?/g, "\n"),
              cooked: this.value
            }, this.next(), r.tail = this.type === i.backQuote, this.finishNode(r, "TemplateElement");
            ...
            for (r.quasis = [s]; !s.tail;) {
              this.type === i.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(i.dollarBraceL), r.expressions.push(this.parseExpression()), this.expect(i.braceR), r.quasis.push(s = this.parseTemplateElement({
                isTagged: t
              }));
            }
            ...
            for (r.properties = [], this.next(); !this.eat(i.braceR);) {
              if (s) s = !1;else if (this.expect(i.comma), this.options.ecmaVersion >= 5 && this.afterTrailingComma(i.braceR)) break;
            ...
            var r = this.startNode(),
                ...
                h,
                c;
            if (this.options.ecmaVersion >= 9 && this.eat(i.ellipsis)) return e ? (r.argument = this.parseIdent(!1), this.type === i.comma && this.raise(this.start, "Comma is not permitted after the rest element"), this.finishNode(r, "RestElement")) : (r.argument = this.parseMaybeAssign(!1, t), this.type === i.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(r, "SpreadElement"));
            this.options.ecmaVersion >= 6 && (r.method = !1, r.shorthand = !1, (e || t) && (h = this.start, c = this.startLoc), e || (s = this.eat(i.star)));
            var m = this.containsEsc;
            return this.parsePropertyName(r), !e && !m && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(r) ? (n = !0, s = this.options.ecmaVersion >= 9 && this.eat(i.star), this.parsePropertyName(r, t)) : n = !1, this.parsePropertyValue(r, e, s, n, h, c, t, m), this.finishNode(r, "Property");
          }, M.parsePropertyValue = function (e, t, r, s, n, h, c, m) {
            if ((r || s) && this.type === i.colon && this.unexpected(), this.eat(i.colon)) e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(!1, c), e.kind = "init";else if (this.options.ecmaVersion >= 6 && this.type === i.parenL) t && this.unexpected(), e.kind = "init", e.method = !0, e.value = this.parseMethod(r, s);else if (!t && !m && this.options.ecmaVersion >= 5 && !e.computed && e.key.type === "Identifier" && (e.key.name === "get" || e.key.name === "set") && this.type !== i.comma && this.type !== i.braceR && this.type !== i.eq) {
            ...
            if (this.options.ecmaVersion >= 6) {
              if (this.eat(i.bracketL)) return e.computed = !0, e.key = this.parseMaybeAssign(), this.expect(i.bracketR), e.key;
              e.computed = !1;
            }
            ...
            return this.initFunction(s), this.options.ecmaVersion >= 6 && (s.generator = e), this.options.ecmaVersion >= 8 && (s.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(xt(t, s.generator) | vt | (r ? gr : 0)), this.expect(i.parenL), s.params = this.parseBindingList(i.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(s, !1, !0, !1), this.yieldPos = n, this.awaitPos = h, this.awaitIdentPos = c, this.finishNode(s, "FunctionExpression");
          }, M.parseArrowExpression = function (e, t, r, s) {
            var n = this.yieldPos,
                h = this.awaitPos,
                c = this.awaitIdentPos;
            return this.enterScope(xt(r, !1) | mr), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!r), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, !0), this.parseFunctionBody(e, !0, !1, s), this.yieldPos = n, this.awaitPos = h, this.awaitIdentPos = c, this.finishNode(e, "ArrowFunctionExpression");
          }, M.parseFunctionBody = function (e, t, r, s) {
            var n = t && this.type !== i.braceL,
                h = this.strict,
                c = !1;
            if (n) e.body = this.parseMaybeAssign(s), e.expression = !0, this.checkParams(e, !1);else {
              ...
              var A = this.labels;
              this.labels = [], c && (this.strict = !0), this.checkParams(e, !h && !c && !t && !r && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, Ar), e.body = this.parseBlock(!1, void 0, c && !h), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = A;
            }
            this.exitScope();
            ...
            for (var r = Object.create(null), s = 0, n = e.params; s < n.length; s += 1) {
              var h = n[s];
              this.checkLValInnerPattern(h, yt, t ? null : r);
            }
          }, M.parseExprList = function (e, t, r, s) {
            for (var n = [], h = !0; !this.eat(e);) {
              if (h) h = !1;else if (this.expect(i.comma), t && this.afterTrailingComma(e)) break;
              var c = void 0;
              r && this.type === i.comma ? c = null : this.type === i.ellipsis ? (c = this.parseSpread(s), s && this.type === i.comma && s.trailingComma < 0 && (s.trailingComma = this.start)) : c = this.parseMaybeAssign(!1, s), n.push(c);
            }
            ...
            var t = this.startNode();
            return this.next(), this.type === i.semi || this.canInsertSemicolon() || this.type !== i.star && !this.type.startsExpr ? (t.delegate = !1, t.argument = null) : (t.delegate = this.eat(i.star), t.argument = this.parseMaybeAssign(e)), this.finishNode(t, "YieldExpression");
          ...
          Ee.enterScope = function (e) {
            ...
            for (var e = this.scopeStack.length - 1;; e--) {
              var t = this.scopeStack[e];
              if (t.flags & gt && !(t.flags & mr)) return t;
            }
          };

          var Re = function Re(t, r, s) {
          ...
          var _r = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS",
              Sr = _r + " Extended_Pictographic",
              wr = Sr,
              kr = wr + " EBase EComp EMod EPres ExtPict",
              en = kr,
              tn = {
            9: _r,
            10: Sr,
          ...
          ge.prototype.reset = function (t, r, s) {
            ...
            if (e.eat(123)) {
              var s = 0,
                  n = -1;
              if (this.regexp_eatDecimalDigits(e) && (s = e.lastIntValue, e.eat(44) && this.regexp_eatDecimalDigits(e) && (n = e.lastIntValue), e.eat(125))) return n !== -1 && n < s && !t && e.raise("numbers out of order in {} quantifier"), !0;
          ...
          N.regexp_eatPatternCharacters = function (e) {
            ...
            var t = e.pos,
                ...
                s = e.current(r);
            return e.advance(r), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, r) && (s = e.lastIntValue), un(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
          };
          ...
          N.regexp_eatRegExpIdentifierPart = function (e) {
            var t = e.pos,
                r = this.options.ecmaVersion >= 11,
                s = e.current(r);
            return e.advance(r), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, r) && (s = e.lastIntValue), on(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
          };
          ...
          N.regexp_eatAtomEscape = function (e) {
            ...
            return e.current() === 48 && !Je(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), !0) : !1;
          }, N.regexp_eatControlEscape = function (e) {
            var t = e.current();
            return t === 116 ? (e.lastIntValue = 9, e.advance(), !0) : t === 110 ? (e.lastIntValue = 10, e.advance(), !0) : t === 118 ? (e.lastIntValue = 11, e.advance(), !0) : t === 102 ? (e.lastIntValue = 12, e.advance(), !0) : t === 114 ? (e.lastIntValue = 13, e.advance(), !0) : !1;
          }, N.regexp_eatControlLetter = function (e) {
            var t = e.current();
            return Lr(t) ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
          };
              ...
              if (this.regexp_eatFixedHexDigits(e, 4)) {
                ...
                if (s && n >= 55296 && n <= 56319) {
                  ...
                  if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
                    ...
                    if (c >= 56320 && c <= 57343) return e.lastIntValue = (n - 55296) * 1024 + (c - 56320) + 65536, !0;
                  }
          ...
          N.regexp_eatIdentityEscape = function (e) {
            ...
            var t = e.current();
            if (ln(t)) return e.lastIntValue = -1, e.advance(), !0;
          ...
          N.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
            ...
            var t = e.current();
            return Je(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
          ...
          N.regexp_eatLegacyOctalEscapeSequence = function (e) {
            ...
            var t = e.current();
            return qr(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
          };
          ...
          N.regexp_eatFixedHexDigits = function (e, t) {
            ...
            for (var s = 0; s < t; ++s) {
              var n = e.current();
              if (!Rr(n)) return e.pos = r, !1;
              e.lastIntValue = 16 * e.lastIntValue + jr(n), e.advance();
            }
          ...
          z.next = function (e) {
          ...
          }, (typeof Symbol === "undefined" ? "undefined" : _typeof(Symbol)) < "u" && (z[Symbol.iterator] = function () {
            var e = this;
            return {
              next: function next() {
                var t = e.getToken();
            ...
            if (r === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = r + 2, this.options.locations) for (var s = void 0, n = t; (s = Z(this.input, n, this.pos)) > -1;) {
            ...
            e: for (; this.pos < this.input.length;) {
              ...
              switch (e) {
                ...
                default:
                  if (e > 8 && e < 14 || e >= 5760 && ne.test(String.fromCharCode(e))) ++this.pos;else break e;
              }
            }
            ...
            var e = this.options.ecmaVersion,
                t = 35;
            if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), w(t, !0) || t === 92)) return this.finishToken(i.privateId, this.readWord1());
            ...
            for (var e, t, r = this.pos;;) {
              ...
              if (S.test(s) && this.raise(r, "Unterminated regular expression"), e) e = !1;else {
            ...
            return this.finishToken(i.regexp, {
              pattern: n,
              flags: c,
              value: A
            });
          ...
          z.readRadixNumber = function (e) {
            ...
            r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1), s === 46 && !r && (++this.pos, this.readInt(10), s = this.input.charCodeAt(this.pos)), (s === 69 || s === 101) && !r && (s = this.input.charCodeAt(++this.pos), (s === 43 || s === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), w(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
            ...
            for (var t = "", r = ++this.pos;;) {
              ...
              var s = this.input.charCodeAt(this.pos);
              if (s === e) break;
              s === 92 ? (t += this.input.slice(r, this.pos), t += this.readEscapedChar(!1), r = this.pos) : s === 8232 || s === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (j(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
            }
          ...
          z.tryReadTemplateToken = function () {
            ...
            try {
              ...
              if (e === Ur) this.readInvalidTemplateToken();else throw e;
            }
            ...
            for (var e = "", t = this.pos;;) {
              ...
              if (r === 92) e += this.input.slice(t, this.pos), e += this.readEscapedChar(!0), t = this.pos;else if (j(r)) {
            ...
            for (var e = "", t = !0, r = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
              ...
              if (G(n, s)) this.pos += n <= 65535 ? 1 : 2;else if (n === 92) {
        ...
        Hh = $({
      "node_modules/acorn-jsx/xhtml.js": function node_modulesAcornJsxXhtmlJs(a, u) {
        J(), u.exports = {
          quot: '"',
          amp: "&",
          apos: "'",
        ...
        Ha = $({
      "node_modules/acorn-jsx/index.js": function node_modulesAcornJsxIndexJs(a, u) {
        "use strict";
        ...
        function y(x) {
          ...
          if (!R) {
            var U = x.tokTypes,
              ...
              jsxText: new g("jsxText", {
                beforeExpr: !0
              }),
              jsxTagStart: new g("jsxTagStart", {
                startsExpr: !0
              }),
              jsxTagEnd: new g("jsxTagEnd")
            };
            V.jsxTagStart.updateContext = function () {
              this.context.push(f), this.context.push(w), this.exprAllowed = !1;
            }, V.jsxTagEnd.updateContext = function (k) {
              var X = this.context.pop();
              X === w && k === U.slash || X === G ? (this.context.pop(), this.exprAllowed = this.curContext() === f) : this.exprAllowed = !0;
            }, R = {
              tokContexts: B,
              tokTypes: V
            }, b.set(x, R);
        ...
        }, Object.defineProperty(u.exports, "tokTypes", {
          get: function get() {
        ...
        function T(x, R) {
          var U = R.acorn || ft(),
              ...
              w = D.tokTypes,
              G = U.tokContexts,
              f = D.tokContexts.tc_oTag,
              B = D.tokContexts.tc_cTag,
              V = D.tokContexts.tc_expr,
              k = U.isNewLine,
              X = U.isIdentifierStart,
              O = U.isIdentifierChar;
          return (
            /*#__PURE__*/
            function (_R) {
              _inherits(_class, _R);
              ...
              _createClass(_class, [{
                ...
                value: function jsx_readToken() {
                  ...
                  for (;;) {
                    ...
                    switch (F) {
                      ...
                      default:
                        k(F) ? (i += this.input.slice(S, this.pos), i += this.jsx_readNewLine(!0), S = this.pos) : ++this.pos;
                    }
                  }
                }
              }, {
                key: "jsx_readNewLine",
                value: function jsx_readNewLine(i) {
                  var S = this.input.charCodeAt(this.pos),
                      F;
                ...
                key: "jsx_readString",
                value: function jsx_readString(i) {
                  var S = "",
                      F = ++this.pos;
                  ...
                  for (;;) {
                    ...
                    if (j === i) break;
                    j === 38 ? (S += this.input.slice(F, this.pos), S += this.jsx_readEntity(), F = this.pos) : k(j) ? (S += this.input.slice(F, this.pos), S += this.jsx_readNewLine(!1), F = this.pos) : ++this.pos;
                  }
                ...
                value: function jsx_parseAttributeValue() {
                  switch (this.type) {
                    case g.braceL:
                      var i = this.jsx_parseExpressionContainer();
                ...
                value: function jsx_parseEmptyExpression() {
                  var i = this.startNodeAt(this.lastTokEnd, this.lastTokEndLoc);
                ...
                value: function jsx_parseOpeningElementAt(i, S) {
                  var F = this.startNodeAt(i, S);
                  F.attributes = [];
                  var j = this.jsx_parseElementName();
                ...
                value: function jsx_parseClosingElementAt(i, S) {
                  var F = this.startNodeAt(i, S),
                      j = this.jsx_parseElementName();
                  return j && (F.name = j), this.expect(w.jsxTagEnd), this.finishNode(F, j ? "JSXClosingElement" : "JSXClosingFragment");
                }
              }, {
                key: "jsx_parseElementAt",
                value: function jsx_parseElementAt(i, S) {
                  var F = this.startNodeAt(i, S),
                      j = [],
                      Z = this.jsx_parseOpeningElementAt(i, S),
                      ne = null;
                  ...
                  var ee = Z.name ? "Element" : "Fragment";
                ...
                value: function jsx_parseText() {
                  var i = this.parseLiteral(this.value);
                ...
                key: "parseExprAtom",
                value: function parseExprAtom(i) {
                  return this.type === w.jsxText ? this.jsx_parseText() : this.type === w.jsxTagStart ? this.jsx_parseElement() : _get(_getPrototypeOf(_class.prototype), "parseExprAtom", this).call(this, i);
                }
              }, {
                key: "readToken",
                value: function readToken(i) {
                  ...
                  return i === 60 && this.exprAllowed && this.input.charCodeAt(this.pos + 1) !== 33 ? (++this.pos, this.finishToken(w.jsxTagStart)) : _get(_getPrototypeOf(_class.prototype), "readToken", this).call(this, i);
                }
              }, {
                key: "updateContext",
                value: function updateContext(i) {
                  if (this.type == g.braceL) {
                    var S = this.curContext();
                    S == f ? this.context.push(G.b_expr) : S == V ? this.context.push(G.b_tmpl) : _get(_getPrototypeOf(_class.prototype), "updateContext", this).call(this, i), this.exprAllowed = !0;
                  } else if (this.type === g.slash && i === w.jsxTagStart) this.context.length -= 2, this.context.push(B), this.exprAllowed = !1;else return _get(_getPrototypeOf(_class.prototype), "updateContext", this).call(this, i);
                }
              }], [{
                key: "acornJsx",
                get: function get() {
        ...
        Kh = $({
      "src/language-js/parse/acorn.js": function srcLanguageJsParseAcornJs(a, u) {
        "use strict";
        ...
        function R(D, g) {
          var w = x(),
              G = [],
              f = [],
              B = w.parse(D, Object.assign(Object.assign({}, y), {}, {
            sourceType: g,
            onComment: G,
            onToken: f
          }));
        ...
        Xh = $({
      "src/language-js/parse/utils/replace-hashbang.js": function srcLanguageJsParseUtilsReplaceHashbangJs(a, u) {
        "use strict";
        ...
        Jh = $({
      "node_modules/espree/dist/espree.cjs": function node_modulesEspreeDistEspreeCjs(a) {
        "use strict";
        ...
        function v(p) {
          return p && _typeof(p) == "object" && "default" in p ? p : {
            "default": p
          };
        }
        ...
        function b(p) {
          ...
          return p && Object.keys(p).forEach(function (_) {
            if (_ !== "default") {
              ...
              Object.defineProperty(P, _, d.get ? d : {
                enumerable: !0,
                get: function get() {
                  return p[_];
                }
        ...
        function R(p, P) {
          var _ = p[0],
              ...
              E = {
            type: x.Template,
            value: P.slice(_.start, d.end)
          };
          return _.loc && (E.loc = {
            start: _.loc.start,
            end: d.loc.end
          }), _.range && (E.start = _.range[0], E.end = d.range[1], E.range = [E.start, E.end]), E;
        }
        ...
        U.prototype = {
          constructor: U,
          translate: function translate(p, P) {
            var _ = p.type,
                d = this._acornTokTypes;
            if (_ === d.name) p.type = x.Identifier, p.value === "static" && (p.type = x.Keyword), P.ecmaVersion > 5 && (p.value === "yield" || p.value === "let") && (p.type = x.Keyword);else if (_ === d.privateId) p.type = x.PrivateIdentifier;else if (_ === d.semi || _ === d.comma || _ === d.parenL || _ === d.parenR || _ === d.braceL || _ === d.braceR || _ === d.dot || _ === d.bracketL || _ === d.colon || _ === d.question || _ === d.bracketR || _ === d.ellipsis || _ === d.arrow || _ === d.jsxTagStart || _ === d.incDec || _ === d.starstar || _ === d.jsxTagEnd || _ === d.prefix || _ === d.questionDot || _.binop && !_.keyword || _.isAssign) p.type = x.Punctuator, p.value = this._code.slice(p.start, p.end);else if (_ === d.jsxName) p.type = x.JSXIdentifier;else if (_.label === "jsxText" || _ === d.jsxAttrValueToken) p.type = x.JSXText;else if (_.keyword) _.keyword === "true" || _.keyword === "false" ? p.type = x.Boolean : _.keyword === "null" ? p.type = x.Null : p.type = x.Keyword;else if (_ === d.num) p.type = x.Numeric, p.value = this._code.slice(p.start, p.end);else if (_ === d.string) P.jsxAttrValueToken ? (P.jsxAttrValueToken = !1, p.type = x.JSXText) : p.type = x.String, p.value = this._code.slice(p.start, p.end);else if (_ === d.regexp) {
              p.type = x.RegularExpression;
              var E = p.value;
              p.regex = {
                flags: E.flags,
                pattern: E.pattern
              }, p.value = "/".concat(E.pattern, "/").concat(E.flags);
            }
            return p;
          },
          onToken: function onToken(p, P) {
            var _ = this,
                d = this._acornTokTypes,
                E = P.tokens,
                K = this._tokens;
        ...
        function G() {
          var p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 5,
              P = p === "latest" ? g() : p;
          if (typeof P != "number") throw new Error("ecmaVersion must be a number or \"latest\". Received value of type ".concat(_typeof(p), " instead."));
          if (P >= 2015 && (P -= 2009), !D.includes(P)) throw new Error("Invalid ecmaVersion.");
          return P;
        }

        function f() {
          var p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "script";
        ...
        function B(p) {
          var P = G(p.ecmaVersion),
              _ = f(p.sourceType),
              d = p.range === !0,
              E = p.loc === !0;

          if (P !== 3 && p.allowReserved) throw new Error("`allowReserved` is only supported when ecmaVersion is 3");
          if (_typeof(p.allowReserved) < "u" && typeof p.allowReserved != "boolean") throw new Error("`allowReserved`, when present, must be `true` or `false`");
          var K = P === 3 ? p.allowReserved || "never" : !1,
              H = p.ecmaFeatures || {},
              te = p.sourceType === "commonjs" || Boolean(H.globalReturn);
          ...
          return Object.assign({}, p, {
            ...
            locations: E,
            allowReserved: K,
            allowReturnOutsideFunction: te
          });
        }

        var V = Symbol("espree's internal state"),
            k = Symbol("espree's esprimaFinishNode");
        ...
        function X(p, P, _, d, E, K, H) {
          ...
          return typeof _ == "number" && (ae.start = _, ae.end = d, ae.range = [_, d]), _typeof(E) == "object" && (ae.loc = {
            start: E,
            end: K
          }), ae;
        }
        ...
        var O = function O() {
          return function (p) {
            var P = Object.assign({}, p.acorn.tokTypes);
            return p.acornJsx && Object.assign(P, p.acornJsx.tokTypes),
            /*#__PURE__*/
            function (_p) {
              _inherits(_class2, _p);

              function _class2(d, E) {
                var _this;

                _classCallCheck(this, _class2);

                (_typeof(d) != "object" || d === null) && (d = {}), typeof E != "string" && !(E instanceof String) && (E = String(E));
                var K = d.sourceType,
                    H = B(d),
                    te = H.ecmaFeatures || {},
                    ae = H.tokens === !0 ? new U(P, E) : null,
                    fe = {
                  originalSourceType: K || H.sourceType,
                  tokens: ae ? [] : null,
                  comments: H.comment === !0 ? [] : null,
                  impliedStrict: te.impliedStrict === !0 && H.ecmaVersion >= 5,
                  ecmaVersion: H.ecmaVersion,
                  jsxAttrValueToken: !1,
                  lastToken: null,
                  templateElements: []
                };
                _this = _possibleConstructorReturn(this, _getPrototypeOf(_class2).call(this, {
                  ...
                  onToken: function onToken(Ae) {
                    ae && ae.onToken(Ae, fe), Ae.type !== P.eof && (fe.lastToken = Ae);
                  },
                  onComment: function onComment(Ae, dt, mt, _e, Ce, Oe) {
                    if (fe.comments) {
                      var ze = X(Ae, dt, mt, _e, Ce, Oe, E);
                      fe.comments.push(ze);
                    }
                  }
                }, E)), _this[V] = fe;
              ...
              _createClass(_class2, [{
                ...
                value: function finishNode() {
                  var d = _get(_getPrototypeOf(_class2.prototype), "finishNode", this).apply(this, arguments);
                ...
                value: function finishNodeAt() {
                  var d = _get(_getPrototypeOf(_class2.prototype), "finishNodeAt", this).apply(this, arguments);
                ...
                value: function parse() {
                  var d = this[V],
                      E = _get(_getPrototypeOf(_class2.prototype), "parse", this).call(this);

                  if (E.sourceType = d.originalSourceType, d.comments && (E.comments = d.comments), d.tokens && (E.tokens = d.tokens), E.body.length) {
                    var _E$body = _slicedToArray(E.body, 1),
                        K = _E$body[0];

                    E.range && (E.range[0] = K.range[0]), E.loc && (E.loc.start = K.loc.start), E.start = K.start;
                  }

                  return d.lastToken && (E.range && (E.range[1] = d.lastToken.range[1]), E.loc && (E.loc.end = d.lastToken.loc.end), E.end = d.lastToken.end), this[V].templateElements.forEach(function (K) {
                    var te = K.tail ? 1 : 2;
                ...
                key: "parseTopLevel",
                value: function parseTopLevel(d) {
                  return this[V].impliedStrict && (this.strict = !0), _get(_getPrototypeOf(_class2.prototype), "parseTopLevel", this).call(this, d);
                }
              }, {
                key: "raise",
                value: function raise(d, E) {
                  var K = p.acorn.getLineInfo(this.input, d),
                      H = new SyntaxError(E);
                  throw H.index = d, H.lineNumber = K.line, H.column = K.column + 1, H;
                }
              }, {
                key: "raiseRecoverable",
                value: function raiseRecoverable(d, E) {
                  this.raise(d, E);
                }
              }, {
                key: "unexpected",
                value: function unexpected(d) {
                  var E = "Unexpected token";

                  if (d != null) {
                    if (this.pos = d, this.options.locations) for (; this.pos < this.lineStart;) {
                      this.lineStart = this.input.lastIndexOf("\n", this.lineStart - 2) + 1, --this.curLine;
                    }
                    this.nextToken();
                  }

                  this.end > this.start && (E += " ".concat(this.input.slice(this.start, this.end))), this.raise(this.start, E);
                }
              }, {
                key: "jsx_readString",
                value: function jsx_readString(d) {
                  var E = _get(_getPrototypeOf(_class2.prototype), "jsx_readString", this).call(this, d);

                  return this.type === P.string && (this[V].jsxAttrValueToken = !0), E;
                }
              }, {
                key: k,
                value: function value(d) {
                  return d.type === "TemplateElement" && this[V].templateElements.push(d), d.type.includes("Function") && !d.generator && (d.generator = !1), d;
                }
              }]);
        ...
        function F(p, P) {
          ...
          return (!P || P.tokens !== !0) && (P = Object.assign({}, P, {
            tokens: !0
          })), new _(P, p).tokenize();
        }
        ...
        Qh = $({
      "src/language-js/parse/espree.js": function srcLanguageJsParseEspreeJs(a, u) {
        "use strict";
        ...
        function x(R, U) {
          var D = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
              ...
              w = b(R),
              _l3 = l(function () {
            return g(w, Object.assign(Object.assign({}, I), {}, {
              sourceType: "module"
            }));
          }, function () {
            return g(w, Object.assign(Object.assign({}, I), {}, {
