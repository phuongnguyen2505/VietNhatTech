...
<div class="ui-corner-all custom-corners">
  ...
  <div class="ui-body ui-body-a">
    ...
    <?php for($i=0;$i<count($tintuc_khac); $i++){?>
      <li><a href="tin-tuc/<?=$tintuc_khac[$i]['tenkhongdau']?>-<?=$tintuc_khac[$i]['id']?>.html" class="transitionAll"><?=stripcslashes($tintuc_khac[$i]['ten'])?>(<?=make_date($tintuc_khac[$i]['ngaytao'])?>)</a></li>
    <?php } ?>
    </ul>
