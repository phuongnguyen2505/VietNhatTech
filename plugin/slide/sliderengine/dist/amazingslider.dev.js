...
(function ($) {
  $.fn.html5lightbox = function (options) {
    ...
    if (inst.options.skinfolder.charAt(0) != "/" && inst.options.skinfolder.substring(0, 5) != "http:" && inst.options.skinfolder.substring(0, 6) != "https:") inst.options.skinfolder = inst.options.jsfolder + inst.options.skinfolder;
    ...
    inst.createMarkup = function () {
      ...
      inst.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + inst.options.overlaybgcolor + ";opacity:" + inst.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(inst.options.overlayopacity * 100) + ");'></div>" + "<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:hidden;'>" + "<div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'>" + "<div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;background-color:" + inst.options.bgcolor + ";'>" + "<div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:center;width:100%;height:100%;background:url(\"" + inst.options.skinfolder + inst.options.loadingimage + "\") no-repeat center center;'></div>" + "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + inst.options.bordersize + "px;text-align:center;width:" + inst.options.errorwidth + "px;height:" + inst.options.errorheight + "px;'>" + "The requested content cannot be loaded.<br />Please try again later." + "</div>" + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + inst.options.bordersize + "px;text-align:center;'></div>" + "</div>" + "<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:40%;'><img src='" + inst.options.skinfolder + inst.options.nextimage + "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:40%;'><img src='" + inst.options.skinfolder + inst.options.previmage + "'></div>" + "</div>" + "<div id='html5-elem-data-box' style='display:none;position:relative;width:100%;margin:0px auto;height:" + inst.options.barheight + "px;background-color:" + inst.options.bgcolor + ";'>" + "<div id='html5-text' style='display:block;float:left;overflow:hidden;margin-left:" + inst.options.bordersize + "px;'></div>" + "<div id='html5-close' style='display:block;cursor:pointer;float:right;margin-right:" + inst.options.bordersize + "px;'><img src='" + inst.options.skinfolder + inst.options.closeimage + "'></div>" + "</div>" + "<div id='html5-watermark' style='display:none;position:absolute;left:" + String(inst.options.bordersize + 2) + "px;top:" + String(inst.options.bordersize + 2) + "px;'></div>" + "</div>" + "</div>");
      inst.$lightbox.css({
    ...
    inst.calcNextPrevElem = function () {
      ...
      if (curGroup != undefined && curGroup != null) {
        ...
        if (inst.options.nextElem < 0) for (j = 0; j < inst.options.curElem; j++) {
          if (inst.elemArray[j][ELEM_GROUP] == curGroup) {
            inst.options.nextElem = j;
            break;
          }
        ...
        if (inst.options.nextElem >= 0) {
          ...
          if (inst.options.prevElem < 0) for (j = inst.elemArray.length - 1; j > inst.options.curElem; j--) {
            if (inst.elemArray[j][ELEM_GROUP] == curGroup) {
              inst.options.prevElem = j;
              break;
            }
    ...
    inst.calcElemSize = function (sizeObj) {
      ...
      var h0 = winH - 2 * inst.options.bordersize - inst.options.barheight - ($(window).width() > 1024 ? 18 : 0);
...
var ASPlatforms = {
  flashInstalled: function flashInstalled() {
  ...
  html5VideoSupported: function html5VideoSupported() {
  ...
  isIE678: function isIE678() {
    return this.isIE6() || this.isIE7() || this.isIE8();
  },
  isIE6789: function isIE6789() {
    return this.isIE6() || this.isIE7() || this.isIE8() || this.isIE9();
  },
  isTouch: function isTouch() {
    return "ontouchstart" in window;
  },
  css33dTransformSupported: function css33dTransformSupported() {
    return !this.isIE() && !this.isOpera();
  },
  applyBrowserStyles: function applyBrowserStyles(object, applyToValue) {
    var ret = {};
...
(function ($) {
  $.fn.amazingslider = function (options) {
    ...
    var AmazingSlider = function AmazingSlider(container, options, id) {
    ...
    AmazingSlider.prototype = {
      initData: function initData(onSuccess) {
        this.readTags();
        onSuccess(this);
      },
      readTags: function readTags() {
        var instance = this;
      ...
      initHtml5Lightbox: function initHtml5Lightbox() {
        var i;
        ...
        if (this.lightboxArray.length > 0) {
          ...
          for (i = 0; i < this.lightboxArray.length; i++) {
            this.html5Lightbox.addItem(this.lightboxArray[i][ELEM_LINK], this.lightboxArray[i][ELEM_TITLE], "amazingslider" + this.id, this.lightboxArray[i][ELEM_LIGHTBOXWIDTH], this.lightboxArray[i][ELEM_LIGHTBOXHEIGHT], this.lightboxArray[i][ELEM_WEBM], this.lightboxArray[i][ELEM_OGG]);
          }
        }
      },
      createGoogleFonts: function createGoogleFonts() {
      ...
      initVideoApi: function initVideoApi() {
        var i, j, videos;
        ...
        for (i = 0; i < this.elemArray.length; i++) {
          ...
          for (j = 0; j < videos.length; j++) {
            if (videos[j].type == TYPE_VIDEO_YOUTUBE) initYoutube = true;else if (videos[j].type == TYPE_VIDEO_VIMEO) initVimeo = true;
          }
        }
      ...
      createSliderTimeout: function createSliderTimeout() {
        var instance = this;
      ...
      updateTimer: function updateTimer(percent) {
      ...
      playVideo: function playVideo(autoplay) {
      ...
      playMp4Video: function playMp4Video(href, webmhref, autoplay) {
      ...
      embedHTML5Video: function embedHTML5Video($container, src, autoPlay) {
      ...
      embedFlash: function embedFlash($container, w, h, src, wmode, flashVars) {
      ...
      playVimeoVideo: function playVimeoVideo(href, autoplay) {
        var $videoWrapper = $(".amazingslider-video-wrapper-" + this.id, this.container);
        $videoWrapper.css({
          display: "block",
          width: "100%",
      ...
      playYoutubeVideo: function playYoutubeVideo(href, autoplay) {
        var $videoWrapper = $(".amazingslider-video-wrapper-" + this.id, this.container);
        $videoWrapper.css({
          display: "block",
          width: "100%",
      ...
      checkVideoType: function checkVideoType(href) {
        if (!href) return -1;
      ...
      createText: function createText() {
        ...
        if (this.options.textstyle == "static") {
          $textWrapper.html("<div class='amazingslider-text-" + this.id + "'>" + "<div class='amazingslider-text-bg-" + this.id + "'></div>" + "<div class='amazingslider-title-" + this.id + "'></div>" + "<div class='amazingslider-description-" + this.id + "'></div>" + "</div>");
          $textWrapper.css({
          ...
          if (this.options.textautohide) $(".amazingslider-slider-" + this.id, this.container).hover(function () {
            ...
            $(".amazingslider-text-wrapper-" + instance.id, instance.container).fadeOut();
          });
        ...
        $("head").append("<style type='text/css' data-creator='amazingslidercreator'>" + ".amazingslider-text-" + this.id + " {" + this.options.textcss + "} " + ".amazingslider-text-bg-" + this.id + " {" + this.options.textbgcss + "} " + ".amazingslider-title-" + this.id + " {" + this.options.titlecss + "} " + ".amazingslider-description-" + this.id + " {" + this.options.descriptioncss + "} " + "</style>");
        this.container.bind("amazingslider.switchtext", function (event, prev, cur) {
          ...
          if (instance.options.textstyle == "static") {
            ...
            if (!instance.elemArray[cur][ELEM_TITLE] && !instance.elemArray[cur][ELEM_DESCRIPTION]) $textBg.hide();else $textBg.show();
          } else if (instance.options.textstyle == "dynamic") if (!instance.elemArray[cur][ELEM_TITLE] && !instance.elemArray[cur][ELEM_DESCRIPTION]) $textWrapper.fadeOut();else $textWrapper.fadeOut(function () {
            var pos = "bottomleft";
      ...
      createBottomShadow: function createBottomShadow() {
      ...
      createBackgroundImage: function createBackgroundImage() {
      ...
      carMoveLeft: function carMoveLeft() {
      ...
      carMoveRight: function carMoveRight() {
        var $navContainer = $(".amazingslider-nav-container-" + this.id, this.container);
        var $bulletWrapper = $(".amazingslider-bullet-wrapper-" + this.id, this.container);
        if ($navContainer.width() >= $bulletWrapper.width()) return;
        if (this.options.navshowpreview) $(".amazingslider-nav-preview-" + this.id, this.container).hide();
      ...
      carMoveBottom: function carMoveBottom() {
        var $navContainer = $(".amazingslider-nav-container-" + this.id, this.container);
        var $bulletWrapper = $(".amazingslider-bullet-wrapper-" + this.id, this.container);
      ...
      carMoveTop: function carMoveTop() {
        var $navContainer = $(".amazingslider-nav-container-" + this.id, this.container);
        var $bulletWrapper = $(".amazingslider-bullet-wrapper-" + this.id, this.container);
        if ($navContainer.height() >= $bulletWrapper.height()) return;
        if (this.options.navshowpreview) $(".amazingslider-nav-preview-" + this.id, this.container).hide();
      ...
      updateCarouselLeftRightArrow: function updateCarouselLeftRightArrow(l) {
        var $navContainer = $(".amazingslider-nav-container-" + this.id, this.container);
        var $bulletWrapper = $(".amazingslider-bullet-wrapper-" + this.id, this.container);
      ...
      createNav: function createNav() {
        ...
        if (this.options.navstyle == "thumbnails") {
          ...
          if (this.options.navthumbstyle == "imageandtitle") this.options.navheight += this.options.navthumbtitleheight;else if (this.options.navthumbstyle == "imageandtitledescription") this.options.navwidth += this.options.navthumbtitlewidth;
        }
        ...
        if (this.options.navstyle != "none") {
          ...
          if (instance.options.navdirection == "vertical") $nav.touchSwipe({
            preventWebBrowser: true,
            swipeTop: function swipeTop(data) {
              instance.carMoveTop();
            },
            ...
            preventWebBrowser: false,
            swipeLeft: function swipeLeft(data) {
      ...
      createNavBullet: function createNavBullet(index) {
        var instance = this;
      ...
      slideRun: function slideRun(index, playVideo) {
      ...
      showImage: function showImage(slideDirection) {
        var instance = this;
        var imgLoader = new Image();
        $(imgLoader).load(function () {
          ...
          } else if (instance.options.scalemode == "fit") instance.curImageMarginTop = (sliderRatio - imgRatio) * 50;else {
          ...
          if (instance.elemArray[instance.curElem][ELEM_LINK]) {
            ...
            $swipeBox.unbind("click").bind("click", function () {
              if (instance.elemArray[instance.curElem][ELEM_LIGHTBOX]) instance.html5Lightbox.showItem(instance.elemArray[instance.curElem][ELEM_LINK]);else {
    ...
    this.each(function () {
      ...
      var i;
      var l;
      var mark = instance.options.wtextdefault;
...
(function ($) {
  $.fn.amazingsliderTransition = function (id, $prev, $next, transition, callback, transitionStartCallback) {
    ...
    if ((effect == "threed" || effect == "threedhorizontal") && !ASPlatforms.css33dTransformSupported()) effect = transition[effect].fallback;
