...
(function (e) {
  ...
  var c = {
    ...
    makeMap: function makeMap(f, j, h) {
      var g;
      f = f || [];
      j = j || ",";
    ...
    trim: function trim(f) {
      return (f ? "" + f : "").replace(a, "");
    },
    create: function create(o, f, j) {
      var n = this,
          g,
          i,
          k,
    ...
    createNS: function createNS(j, h) {
      var g, f;
      h = h || e;
      j = j.split(".");
    ...
    addUnload: function addUnload(j, i) {
      var h = this,
          _g;
      ...
      _g = function g() {
        ...
        if (f) {
          ...
          if (e.detachEvent) {
            ...
            e.detachEvent("onunload", _g);
          } else {
            if (e.removeEventListener) {
              e.removeEventListener("unload", _g, false);
            }
          }

          h.unloads = l = f = w = _g = 0;
      ...
      if (!h.unloads) {
        if (e.attachEvent) {
          e.attachEvent("onunload", _g);
          e.attachEvent("onbeforeunload", k);
        } else {
          if (e.addEventListener) {
            e.addEventListener("unload", _g, false);
          }
        }
    ...
    removeUnload: function removeUnload(i) {
      var g = this.unloads,
          h = null;
    ...
    _replace: function _replace(h, f, g) {
      if (d) {
...
tinymce.create("tinymce.util.Dispatcher", {
  ...
  listeners: null,
  inDispatch: false,
  Dispatcher: function Dispatcher(a) {
    this.scope = a || this;
    this.listeners = [];
  },
  ...
  addToTop: function addToTop(d, b) {
    var a = this,
        c = {
      cb: d,
      scope: b || a.scope
...
(function () {
  ...
  tinymce.create("tinymce.util.URI", {
    ...
    toRelative: function toRelative(b) {
      var d = this,
          f;
    ...
    toAbsolute: function toAbsolute(b, c) {
      b = new tinymce.util.URI(b, {
        base_uri: this
      });
      return b.getURI(this.host == b.host && this.protocol == b.protocol ? c : 0);
    },
    toRelPath: function toRelPath(g, h) {
      var c,
          f = 0,
          d = "",
          e,
    ...
    toAbsPath: function toAbsPath(e, f) {
      var c,
          b = 0,
          h = [],
          d,
...
(function () {
  ...
  tinymce.create("static tinymce.util.Cookie", {
    ...
    setHash: function setHash(j, b, g, f, i, c) {
      var h = "";
      a(b, function (e, d) {
...
(function () {
  ...
  tinymce.create("tinymce.util.JSONRequest", {
    JSONRequest: function JSONRequest(d) {
      this.settings = c({}, d);
      this.count = 0;
    },
    send: function send(f) {
      var e = f.error,
          d = f.success;
      f = c(this.settings, f);
...
(function (a) {
  a.VK = {
    ...
    TAB: 9,
    UP: 38,
    modifierPressed: function modifierPressed(b) {
...
tinymce.util.Quirks = function (d) {
  ...
  function c(G, F) {
    try {
      d.getDoc().execCommand(G, false, F);
    } catch (E) {}
  }

  function x() {
    var E = d.getDoc().documentMode;
    return E ? E : 6;
  }
  ...
  function i() {
    function E(H) {
      var F, J, G, I;
      F = C.getRng();
      J = o.getParent(F.startContainer, o.isBlock);

      if (H) {
        J = o.getNext(J, o.isBlock);
      }

      if (J) {
        G = J.firstChild;

        while (G && G.nodeType == 3 && G.nodeValue.length === 0) {
          G = G.nextSibling;
        }

        if (G && G.nodeName === "SPAN") {
          I = G.cloneNode(false);
        }
      }

      d.getDoc().execCommand(H ? "ForwardDelete" : "Delete", false, null);
      J = o.getParent(F.startContainer, o.isBlock);
      tinymce.each(o.select("span.Apple-style-span,font.Apple-style-span", J), function (K) {
        var L = C.getBookmark();

        if (I) {
          o.replace(I.cloneNode(false), K, true);
        } else {
          o.remove(K, true);
        }
    ...
    d.onKeyDown.add(function (F, H) {
      var G;
      G = H.keyCode == t;

      if (!H.isDefaultPrevented() && (G || H.keyCode == s) && !l.modifierPressed(H)) {
        H.preventDefault();
        E(G);
      }
    });
  ...
  function D() {
    function F(H, K) {
      ...
      if (G.nodeType == 1 && G.hasChildNodes()) {
        G = G.childNodes[Math.min(K ? J : J > 0 ? J - 1 : 0, G.childNodes.length - 1)];
      }
    ...
    function E(J, N) {
      ...
      if (I.nodeType == 1) {
        G = M >= I.childNodes.length;
        I = F(J, N);

        if (I.nodeType == 3) {
          M = N && !G ? 0 : I.nodeValue.length;
        }
      }

      if (I.nodeType == 3 && (N && M > 0 || !N && M < I.nodeValue.length)) {
        return false;
      }

      while (I !== H) {
        K = I.parentNode[N ? "firstChild" : "lastChild"];

        if (K.nodeName == "BR") {
          K = K[N ? "nextSibling" : "previousSibling"] || K;
        }
    ...
    d.onKeyDown.addToTop(function (H, J) {
      var G,
          I = J.keyCode;

      if (!J.isDefaultPrevented() && (I == t || I == s)) {
        G = C.getRng(true);

        if (E(G, true) && E(G, false) && (G.collapsed || o.findCommonAncestor(F(G, true), F(G)) === o.getRoot())) {
          H.setContent("");
          H.selection.setCursorLocation(H.getBody(), 0);
          H.nodeChanged();
          J.preventDefault();
        }
      }
  ...
  function v() {
    if (!d.settings.content_editable) {
      o.bind(d.getDoc(), "focusin", function (E) {
        C.setRng(C.getRng());
      });
      o.bind(d.getDoc(), "mousedown", function (E) {
  ...
  function m() {
    d.onKeyDown.add(function (E, H) {
      if (!H.isDefaultPrevented() && H.keyCode === s) {
        if (C.isCollapsed() && C.getRng(true).startOffset === 0) {
          var G = C.getNode();
          var F = G.previousSibling;

          if (F && F.nodeName && F.nodeName.toLowerCase() === "hr") {
            o.remove(F);
            tinymce.dom.Event.cancel(H);
          }
        }
      }
    });
  ...
  function b() {
    if (!Range.prototype.getClientRects) {
      d.onMouseDown.add(function (F, G) {
  ...
  function z() {
    d.onClick.add(function (E, F) {
      F = F.target;

      if (/^(IMG|HR)$/.test(F.nodeName)) {
        C.getSel().setBaseAndExtent(F, 0, F, 1);
      }

      if (F.nodeName == "A" && o.hasClass(F, "mceItemAnchor")) {
        C.select(F);
      }
  ...
  function A() {
    function F() {
      var H = o.getAttribs(C.getStart().cloneNode(false));
      return function () {
        var I = C.getStart();

        if (I !== d.getBody()) {
          o.setAttrib(I, "style", null);
          tinymce.each(H, function (J) {
            I.setAttributeNode(J.cloneNode(true));
          });
        }
      };
    }
    ...
    function E() {
      return !C.isCollapsed() && C.getStart() != C.getEnd();
    }
    ...
    d.onKeyPress.add(function (H, J) {
      var I;

      if ((J.keyCode == 8 || J.keyCode == 46) && E()) {
        I = F();
    ...
    o.bind(d.getDoc(), "cut", function (I) {
      var H;

      if (E()) {
        H = F();
        d.onKeyUp.addToTop(G);
        setTimeout(function () {
          H();
          d.onKeyUp.remove(G);
        }, 0);
  ...
  function j() {
    ...
    o.bind(d.getDoc(), "selectionchange", function () {
      ...
      E = window.setTimeout(function () {
        ...
        if (!F || !tinymce.dom.RangeUtils.compareRanges(G, F)) {
          d.nodeChanged();
          F = G;
        }
      }, 50);
  ...
  function y() {
    d.onKeyDown.add(function (E, G) {
      if (!G.isDefaultPrevented() && G.keyCode === s) {
        if (C.isCollapsed() && C.getRng(true).startOffset === 0) {
          var F = C.getNode().previousSibling;

          if (F && F.nodeName && F.nodeName.toLowerCase() === "table") {
  ...
  function g() {
    ...
    d.contentStyles.push(".mceHideBrInPre pre br {display: none}");
    o.addClass(d.getBody(), "mceHideBrInPre");
    d.parser.addNodeFilter("pre", function (E, G) {
      var H = E.length,
          J,
          F,
          K,
      ...
      while (H--) {
        ...
        while (F--) {
          ...
          if (I && I.type === 3 && I.value.charAt(I.value - 1) != "\n") {
            I.value += "\n";
          } else {
            K.parent.insert(new tinymce.html.Node("#text", 3), K, true).value = "\n";
          }
        }
      }
    });
    d.serializer.addNodeFilter("pre", function (E, G) {
      var H = E.length,
          J,
          F,
          K,
  ...
  function f() {
    o.bind(d.getBody(), "mouseup", function (G) {
      var F,
          E = C.getNode();

      if (E.nodeName == "IMG") {
        if (F = o.getStyle(E, "width")) {
          o.setAttrib(E, "width", F.replace(/[^0-9%]+/g, ""));
          o.setStyle(E, "width", "");
        }

        if (F = o.getStyle(E, "height")) {
          o.setAttrib(E, "height", F.replace(/[^0-9%]+/g, ""));
          o.setStyle(E, "height", "");
        }
      }
    });
  ...
  function q() {
    d.onKeyDown.add(function (K, L) {
      var J, E, F, H, I, M, G;
      J = L.keyCode == t;

      if (!L.isDefaultPrevented() && (J || L.keyCode == s) && !l.modifierPressed(L)) {
        E = C.getRng();
        F = E.startContainer;
        H = E.startOffset;
        G = E.collapsed;

        if (F.nodeType == 3 && F.nodeValue.length > 0 && (H === 0 && !G || G && H === (J ? 0 : 1))) {
          nonEmptyElements = K.schema.getNonEmptyElements();
          L.preventDefault();
          I = o.create("br", {
            id: "__tmp"
          });
          F.parentNode.insertBefore(I, F);
          K.getDoc().execCommand(J ? "ForwardDelete" : "Delete", false, null);
          F = C.getRng().startContainer;
          M = F.previousSibling;

          if (M && M.nodeType == 1 && !o.isBlock(M) && o.isEmpty(M) && !nonEmptyElements[M.nodeName.toLowerCase()]) {
            o.remove(M);
          }
  ...
  function e() {
    d.onKeyDown.add(function (I, J) {
      ...
      if (J.isDefaultPrevented() || J.keyCode != l.BACKSPACE) {
        return;
      }
      ...
      while (H && H.parentNode && H.parentNode.firstChild == H && H.parentNode != E) {
        H = H.parentNode;
      }

      if (H.tagName === "BLOCKQUOTE") {
        I.formatter.toggle("blockquote", null, H);
        G.setStart(F, 0);
        G.setEnd(F, 0);
        C.setRng(G);
        C.collapse(false);
  ...
  function k() {
    function E() {
      ...
      if (!r.object_resizing) {
        c("enableObjectResizing", false);
      }
    }

    if (!r.readonly) {
      d.onBeforeExecCommand.add(E);
      d.onMouseDown.add(E);
    }
  }
  ...
  function n() {
    function E(F, G) {
      tinymce.each(o.select("a"), function (J) {
        var H = J.parentNode,
            I = o.getRoot();

        if (H.lastChild === J) {
          while (H && !o.isBlock(H)) {
            if (H.parentNode.lastChild !== H || H === I) {
              return;
            }
    ...
    d.onExecCommand.add(function (F, G) {
      if (G === "CreateLink") {
        E(F);
      }
    });
    d.onSetContent.add(C.onSetContent.add(E));
  }

  function u() {
    if (r.forced_root_block) {
      d.onInit.add(function () {
        c("DefaultParagraphSeparator", r.forced_root_block);
      });
    }
  }
  ...
  function a() {
    ...
    d.onUndo.add(E);
    d.onRedo.add(E);
    d.onSetContent.add(E);
  }

  function p() {
    d.onKeyDown.add(function (F, G) {
      var E;

      if (!G.isDefaultPrevented() && G.keyCode == s) {
        E = F.getDoc().selection.createRange();
  ...
  function h() {
    ...
    if (x() >= 10) {
      E = "";
      tinymce.each("p div h1 h2 h3 h4 h5 h6".split(" "), function (F, G) {
        E += (G > 0 ? "," : "") + F + ":empty";
      });
      d.contentStyles.push(E + "{padding-right: 1px !important}");
    }
  }
...
(function (j) {
  ...
  j.html = j.html || {};
  j.html.Entities = {
    encodeRaw: function encodeRaw(m, l) {
      return m.replace(l ? k : b, function (n) {
        return g[n] || n;
      });
    },
    encodeAllRaw: function encodeAllRaw(l) {
      return ("" + l).replace(f, function (m) {
        return g[m] || m;
      });
    },
    encodeNumeric: function encodeNumeric(m, l) {
      return m.replace(l ? k : b, function (n) {
        if (n.length > 1) {
    ...
    encodeNamed: function encodeNamed(n, l, m) {
      m = m || a;
      return n.replace(l ? k : b, function (o) {
        return g[o] || m[o] || o;
      });
    },
    getEncodeFunc: function getEncodeFunc(l, o) {
...
tinymce.html.Styles = function (d, f) {
  ...
  return {
    ...
    serialize: function serialize(p, r) {
      var o = "",
          n,
          q;
...
(function (f) {
  ...
  f.html.Schema = function (A) {
    ...
    v = m("block_elements", "h1 h2 h3 h4 h5 h6 hr p div address pre form table tbody thead tfoot th tr td li ol ul caption blockquote center dl dt dd dir fieldset noscript menu isindex samp header footer article section hgroup aside nav figure option datalist select optgroup");
...
(function (d) {
  ...
  d.extend(b.prototype, {
    ...
    walk: function walk(f) {
      return a(this, null, f);
    }
  });
  d.extend(b, {
    create: function create(g, f) {
      var i, h;
      i = new b(g, e[g] || 1);
  ...
  b.html.DomParser = function (g, h) {
    ...
    f.parse = function (v, m) {
      ...
      n = new b.html.SaxParser({
        ...
        cdata: function cdata(l) {
          B.append(K("#cdata", 4)).value = l;
        },
        text: function text(P, l) {
          var O;
        ...
        doctype: function doctype(O) {
          var l;
          l = B.append(K("#doctype", 10));
          l.value = O;
          I(B);
        },
        start: function start(l, W, P) {
          var U, R, Q, O, S, X, V, T;
          ...
          if (P) {
            ...
            if (P.removeEmpty || P.paddEmpty) {
              if (B.isEmpty(u)) {
                if (P.paddEmpty) {
                  B.empty().append(new a("#text", "3")).value = "\xA0";
                } else {
                ...
                if (elementRule) {
                  if (elementRule.removeEmpty) {
                    ...
                    if (elementRule.paddEmpty) {
                      t.empty().append(new b.html.Node("#text", 3)).value = "\xA0";
                    }
                  }
                }
              }
...
tinymce.html.Writer = function (e) {
  ...
  return {
    ...
    text: function text(i, h) {
      if (i.length > 0) {
        c[c.length] = h ? i : f(i);
      }
    },
    cdata: function cdata(h) {
      c.push("<![CDATA[", h, "]]>");
    },
    comment: function comment(h) {
      c.push("<!--", h, "-->");
    },
    pi: function pi(h, i) {
      if (i) {
...
(function (e) {
  ...
  e.create("tinymce.dom.DOMUtils", {
    ...
    DOMUtils: function DOMUtils(o, l) {
      var k = this,
          i,
          j,
          n;
    ...
    getViewPort: function getViewPort(j) {
      var k, i;
      j = !j ? this.win : j;
      k = j.document;
    ...
    getParent: function getParent(k, j, i) {
      return this.getParents(k, j, i, false);
    },
    getParents: function getParents(s, m, k, q) {
      var j = this,
          i,
          l = j.settings,
          p = [];
    ...
    getNext: function getNext(j, i) {
      return this._findSib(j, i, "nextSibling");
    },
    getPrev: function getPrev(j, i) {
      return this._findSib(j, i, "previousSibling");
    },
    select: function select(k, j) {
      var i = this;
    ...
    create: function create(k, i, j) {
      return this.add(this.doc.createElement(k), k, i, j, 1);
    },
    createHTML: function createHTML(q, i, m) {
      var p = "",
          l = this,
          j;
      p += "<" + q;
    ...
    setStyle: function setStyle(l, i, j) {
      var k = this;
    ...
    getStyle: function getStyle(l, i, k) {
      l = this.get(l);
    ...
    setStyles: function setStyles(l, m) {
      var j = this,
          k = j.settings,
          i;
      i = k.update_styles;
    ...
    removeAllAttribs: function removeAllAttribs(i) {
      return this.run(i, function (l) {
        var k,
            j = l.attributes;
    ...
    setAttrib: function setAttrib(k, l, i) {
      var j = this;
    ...
    setAttribs: function setAttribs(j, k) {
      var i = this;
    ...
    getAttrib: function getAttrib(m, o, k) {
      var i,
          j = this,
          l;
      m = j.get(m);
    ...
    parseStyle: function parseStyle(i) {
      return this.styles.parse(i);
    },
    serializeStyle: function serializeStyle(j, i) {
      return this.styles.serialize(j, i);
    },
    addStyle: function addStyle(j) {
      var k = this.doc,
          i;
    ...
    addClass: function addClass(i, j) {
    ...
    removeClass: function removeClass(k, l) {
      var i = this,
          j;
    ...
    hasClass: function hasClass(j, i) {
      j = this.get(j);
    ...
    getOuterHTML: function getOuterHTML(k) {
      var j,
          i = this;
      k = i.get(k);
    ...
    setOuterHTML: function setOuterHTML(l, j, m) {
      var i = this;
    ...
    insertAfter: function insertAfter(i, j) {
      j = this.get(j);
      return this.run(i, function (l) {
        var k, m;
        k = j.parentNode;
    ...
    replace: function replace(m, l, i) {
      var j = this;
    ...
    findCommonAncestor: function findCommonAncestor(k, i) {
      var l = k,
          j;
    ...
    getAttribs: function getAttribs(j) {
      var i;
      j = this.get(j);
    ...
    nodeIndex: function nodeIndex(m, n) {
      var i = 0,
          k,
          l,
          j;
    ...
    bind: function bind(l, i, k, j) {
      return this.events.add(l, i, k, j || this);
    },
    unbind: function unbind(k, i, j) {
      return this.events.remove(k, i, j);
    },
    fire: function fire(k, j, i) {
      return this.events.fire(k, j, i);
    },
    getContentEditable: function getContentEditable(j) {
      var i;
    ...
    _findSib: function _findSib(l, i, j) {
      var k = this,
          m = i;
...
(function () {
  ...
  var _d2 = function d(C, e, F, G) {
    ...
    if (D.length > 1 && j.exec(C)) {
      if (D.length === 2 && k.relative[D[0]]) {
        ...
        K = k.relative[D[0]] ? [e] : _d2(D.shift(), e);
      ...
      if (!G && D.length > 1 && e.nodeType === 9 && !A && k.match.ID.test(D[0]) && !k.match.ID.test(D[D.length - 1])) {
        J = _d2.find(D.shift(), e, A);
        e = J.expr ? _d2.filter(J.expr, J.set)[0] : J.set[0];
      }
      ...
      if (e) {
        J = G ? {
          expr: D.pop(),
          set: l(G)
        } : _d2.find(D.pop(), D.length === 1 && (D[0] === "~" || D[0] === "+") && e.parentNode ? e.parentNode : e, A);
        K = J.expr ? _d2.filter(J.expr, J.set) : J.set;
    ...
    if (r.call(N) === "[object Array]") {
      if (!B) {
        ...
        if (e && e.nodeType === 1) {
          for (E = 0; N[E] != null; E++) {
            if (N[E] && (N[E] === true || N[E].nodeType === 1 && _d2.contains(e, N[E]))) {
              F.push(K[E]);
            }
          }
        } else {
  ...
  _d2.matches = function (e, y) {
    return _d2(e, null, null, y);
  };

  _d2.matchesSelector = function (e, y) {
    return _d2(y, null, null, [e]).length > 0;
  };

  _d2.find = function (E, e, F) {
    var D, z, B, A, C, y;
  ...
  _d2.error = function (e) {
    throw new Error("Syntax error, unrecognized expression: " + e);
  };

  var b = _d2.getText = function (B) {
    var z,
        A,
        e = B.nodeType,
        y = "";
  ...
  var k = _d2.selectors = {
    ...
    preFilter: {
      CLASS: function CLASS(A, y, z, e, D, E) {
        A = " " + A[1].replace(q, "") + " ";
      ...
      ATTR: function ATTR(B, y, z, e, C, D) {
      ...
      PSEUDO: function PSEUDO(B, y, z, e, C) {
        if (B[1] === "not") {
          if ((n.exec(B[3]) || "").length > 1 || /^\w/.test(B[3])) {
            B[3] = _d2(B[3], null, null, y);
          } else {
            var A = _d2.filter(B[3], y, z, true ^ C);
    ...
    filters: {
      ...
      has: function has(z, y, e) {
        return !!_d2(e[3], z).length;
      },
      header: function header(e) {
        return /h\d/i.test(e.nodeName);
      },
      text: function text(z) {
      ...
      reset: function reset(y) {
        var e = y.nodeName.toLowerCase();
        return (e === "input" || e === "button") && "reset" === y.type;
      },
      button: function button(y) {
        var e = y.nodeName.toLowerCase();
    ...
    setFilters: {
      first: function first(y, e) {
        return e === 0;
      },
      last: function last(z, y, e, A) {
        return y === A.length - 1;
      },
      even: function even(y, e) {
        return e % 2 === 0;
      },
      odd: function odd(y, e) {
        return e % 2 === 1;
      },
      lt: function lt(z, y, e) {
        return y < e[3] - 0;
      },
      gt: function gt(z, y, e) {
        return y > e[3] - 0;
      },
      nth: function nth(z, y, e) {
        return e[3] - 0 === y;
      },
      eq: function eq(z, y, e) {
        return e[3] - 0 === y;
      }
    },
    filter: {
      PSEUDO: function PSEUDO(z, E, D, F) {
        var e = E[1],
            y = k.filters[e];
      ...
      CLASS: function CLASS(y, e) {
        return (" " + (y.className || y.getAttribute("class")) + " ").indexOf(e) > -1;
      },
      ATTR: function ATTR(C, A) {
        var z = A[1],
            e = _d2.attr ? _d2.attr(C, z) : k.attrHandle[z] ? k.attrHandle[z](C) : C[z] != null ? C[z] : C.getAttribute(z),
            D = e + "",
            B = A[2],
            y = A[4];
        return e == null ? B === "!=" : !B && _d2.attr ? e != null : B === "=" ? D === y : B === "*=" ? D.indexOf(y) >= 0 : B === "~=" ? (" " + D + " ").indexOf(y) >= 0 : !y ? D && e !== false : B === "!=" ? D !== y : B === "^=" ? D.indexOf(y) === 0 : B === "$=" ? D.substr(D.length - y.length) === y : B === "|=" ? D === y || D.substr(0, y.length + 1) === y + "-" : false;
      },
      POS: function POS(B, y, z, C) {
        var e = y[2],
            A = k.setFilters[e];
  ...
  (function () {
    ...
    if (z) {
      ...
      _d2.matchesSelector = function (D, F) {
        F = F.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']");
        ...
        return _d2(F, null, null, [D]).length > 0;
      };
    }
  })();
  ...
  var s = function s(z, e, D) {
    ...
    return _d2.filter(B, E);
  };

  window.tinymce.dom.Sizzle = _d2;
})();
...
(function (a) {
  a.dom.Element = function (f, d) {
    ...
    a.extend(b, {
      ...
      moveTo: function moveTo(g, h) {
        b.setStyles({
          left: g,
          top: h
        });
      },
      moveBy: function moveBy(g, i) {
        var h = b.getXY();
        b.moveTo(h.x + g, h.y + i);
      },
      resizeTo: function resizeTo(g, i) {
        b.setStyles({
          width: g,
          height: i
        });
      },
      resizeBy: function resizeBy(g, j) {
        var i = b.getSize();
...
(function (d) {
  ...
  d.create("tinymce.dom.Selection", {
    Selection: function Selection(k, j, i, h) {
      var g = this;
      g.dom = k;
      g.win = j;
      g.serializer = i;
    ...
    setCursorLocation: function setCursorLocation(i, j) {
      var g = this;
    ...
    setContent: function setContent(h, j) {
      var o = this,
          g = o.getRng(),
          k,
          l = o.win.document,
    ...
    getBookmark: function getBookmark(s, v) {
      var y = this,
          n = y.dom,
          h,
          k,
    ...
    moveToBookmark: function moveToBookmark(o) {
      var s = this,
          m = s.dom,
          j,
          i,
    ...
    getSelectedBlocks: function getSelectedBlocks(p, h) {
      var o = this,
          k = o.dom,
          m,
          l,
    ...
    selectorChanged: function selectorChanged(g, j) {
      var h = this,
          i;
    ...
    _fixIESelection: function _fixIESelection() {
      var h = this.dom,
          n = h.doc,
          i = n.body,
          k,
...
(function (a) {
  a.dom.Serializer = function (e, i, f) {
    ...
    return {
      ...
      onPreProcess: h,
      onPostProcess: b,
      serialize: function serialize(o, m) {
        var l, p, k, j, n;
      ...
      addRules: function addRules(j) {
        f.addValidElements(j);
      },
      setRules: function setRules(j) {
...
(function (b) {
  ...
  b.create("tinymce.ui.KeyboardNavigation", {
    KeyboardNavigation: function KeyboardNavigation(e, f) {
      var q = this,
          n = e.root,
          m = e.items,
          o = e.enableUpDown,
...
(function (c) {
  ...
  c.create("tinymce.ui.Control", {
    Control: function Control(f, e, d) {
      this.id = f;
      this.settings = e = e || {};
      this.rendered = false;
    ...
    setAriaProperty: function setAriaProperty(f, e) {
    ...
    setDisabled: function setDisabled(d) {
      if (d != this.disabled) {
    ...
    setActive: function setActive(d) {
      if (d != this.active) {
    ...
    setState: function setState(f, d) {
      var e = b.get(this.id);
...
tinymce.create("tinymce.ui.Container:tinymce.ui.Control", {
  Container: function Container(c, b, a) {
    this.parent(c, b, a);
    this.controls = [];
    this.lookup = {};
  },
...
tinymce.create("tinymce.ui.Separator:tinymce.ui.Control", {
  Separator: function Separator(b, a) {
    this.parent(b, a);
...
(function (d) {
  ...
  d.create("tinymce.ui.MenuItem:tinymce.ui.Control", {
    MenuItem: function MenuItem(g, f) {
      this.parent(g, f);
...
(function (d) {
  ...
  d.create("tinymce.ui.Menu:tinymce.ui.MenuItem", {
    ...
    createMenu: function createMenu(g) {
...
(function (e) {
  ...
  e.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {
    DropMenu: function DropMenu(h, g) {
      g = g || {};
    ...
    createMenu: function createMenu(j) {
      var h = this,
          i = h.settings,
          g;
    ...
    showMenu: function showMenu(p, n, r) {
      var z = this,
          A = z.settings,
          o,
          g = c.getViewPort(),
    ...
    _setupKeyboardNav: function _setupKeyboardNav() {
      var i,
          h,
          g = this;
      i = c.get("menu_" + g.id);
    ...
    _keyHandler: function _keyHandler(g) {
      var h = this,
          i;
...
(function (e) {
  ...
  e.create("tinymce.ui.ListBox:tinymce.ui.Control", {
    ListBox: function ListBox(j, i, g) {
      var h = this;
      h.parent(j, i, g);
      h.items = [];
      h.onChange = new a(h);
    ...
    selectByIndex: function selectByIndex(g) {
      var i = this,
          j,
          k,
          h;
    ...
    mark: function mark(g) {
      this.marked[g] = true;
    },
    add: function add(j, g, i) {
      var h = this;
      i = i || {};
      i = e.extend(i, {
        title: j,
...
(function (e) {
  ...
  e.create("tinymce.ui.NativeListBox:tinymce.ui.ListBox", {
    NativeListBox: function NativeListBox(h, g) {
      this.parent(h, g);
      this.classPrefix = "mceNativeListBox";
    },
    setDisabled: function setDisabled(g) {
...
(function (c) {
  ...
  c.create("tinymce.ui.MenuButton:tinymce.ui.Button", {
    MenuButton: function MenuButton(g, f, e) {
      this.parent(g, f, e);
...
(function (c) {
  ...
  c.create("tinymce.ui.SplitButton:tinymce.ui.MenuButton", {
    SplitButton: function SplitButton(g, f, e) {
      this.parent(g, f, e);
...
(function (d) {
  ...
  d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
    ColorSplitButton: function ColorSplitButton(i, h, f) {
      var g = this;
      g.parent(i, h, f);
    ...
    displayColor: function displayColor(g) {
      var f = this;
...
(function (b) {
  ...
  b.create("tinymce.AddOnManager", {
    AddOnManager: function AddOnManager() {
      var d = this;
      d.items = [];
      d.urls = {};
      d.lookup = {};
    ...
    requireLangPack: function requireLangPack(e) {
      var d = b.settings;
    ...
    createUrl: function createUrl(d, e) {
      if (_typeof(e) === "object") {
        return e;
      } else {
        return {
    ...
    addComponents: function addComponents(f, d) {
      var e = this.urls[f];
      b.each(d, function (g) {
        b.ScriptLoader.add(e + "/" + g);
      });
    },
    load: function load(j, f, d, h) {
      var g = this,
          e = f;
...
(function (j) {
  ...
  j.EditorManager = d(j, {
    ...
    getInstanceById: function getInstanceById(l) {
      return this.get(l);
    },
    add: function add(m) {
      var l = this,
    ...
    execCommand: function execCommand(r, p, o) {
      var q = this,
          n = q.get(o),
          l;
    ...
    execInstanceCommand: function execInstanceCommand(p, o, n, m) {
      var l = this.get(p);
    ...
    _setActive: function _setActive(l) {
...
(function (k) {
  ...
  k.create("tinymce.Editor", {
    ...
    initContentBody: function initContentBody() {
      var n = this,
          p = n.settings,
          q = l.get(n.id),
          r = n.getDoc(),
      ...
      n.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (u, v) {
        var x = u.length,
            y,
            t = n.schema.getNonEmptyElements();
    ...
    execCallback: function execCallback(q) {
      var m = this,
          p = m.settings[q],
          o;
    ...
    translate: function translate(m) {
    ...
    getLang: function getLang(o, m) {
      return k.i18n[(this.settings.language || "en") + "." + o] || (d(m) ? m : "{#" + o + "}");
    },
    getParam: function getParam(t, q, m) {
      var r = k.trim,
    ...
    nodeChanged: function nodeChanged(q) {
      var m = this,
          n = m.selection,
          p;
    ...
    addButton: function addButton(n, o) {
      var m = this;
      m.buttons = m.buttons || {};
      m.buttons[n] = o;
    },
    addCommand: function addCommand(m, o, n) {
      this.execCommands[m] = {
        func: o,
        scope: n || this
      };
    },
    addQueryStateHandler: function addQueryStateHandler(m, o, n) {
      this.queryStateCommands[m] = {
        func: o,
        scope: n || this
      };
    },
    addQueryValueHandler: function addQueryValueHandler(m, o, n) {
      this.queryValueCommands[m] = {
        func: o,
        scope: n || this
      };
    },
    addShortcut: function addShortcut(o, q, m, p) {
      var n = this,
          r;
    ...
    execCommand: function execCommand(u, r, x, m) {
      var p = this,
          q = 0,
          v,
          n;
    ...
    queryCommandState: function queryCommandState(q) {
      var n = this,
          r,
          p;
    ...
    queryCommandValue: function queryCommandValue(r) {
      var n = this,
          q,
          p;
    ...
    setProgressState: function setProgressState(m, n, p) {
    ...
    setContent: function setContent(r, p) {
      var o = this,
          n,
          m = o.getBody(),
          q;
    ...
    convertURL: function convertURL(o, n, q) {
      var m = this,
          p = m.settings;
    ...
    addVisual: function addVisual(q) {
      var n = this,
          o = n.settings,
          p = n.dom,
          m;
...
(function (d) {
  ...
  d.EditorCommands = function (n) {
    ...
    u((_u = {
      ...
      "Cut,Copy,Paste": function CutCopyPaste(z) {
        var y = n.getDoc(),
            v;
      ...
      "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function JustifyLeftJustifyCenterJustifyRightJustifyFull(v) {
        var x = v.substring(7);
      ...
      "InsertUnorderedList,InsertOrderedList": function InsertUnorderedListInsertOrderedList(y) {
        var v, x;
        f(y);
      ...
      "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function BoldItalicUnderlineStrikethroughSuperscriptSubscript(v) {
        s(v);
      },
      "ForeColor,HiliteColor,FontName": function ForeColorHiliteColorFontName(y, x, v) {
        s(y, v);
      },
      FontSize: function FontSize(z, y, x) {
        var v, A;
      ...
      RemoveFormat: function RemoveFormat(v) {
        q.remove(v);
      },
      mceBlockQuote: function mceBlockQuote(v) {
        s("blockquote");
      },
      FormatBlock: function FormatBlock(y, x, v) {
        return s(v || "p");
      },
      ...
      mceRemoveNode: function mceRemoveNode(z, y, x) {
        var v = x || p.getNode();
      ...
      mceSelectNodeDepth: function mceSelectNodeDepth(z, y, x) {
        var v = 0;
      ...
      mceSelectNode: function mceSelectNode(y, x, v) {
        p.select(v);
      },
      mceInsertContent: function mceInsertContent(B, I, K) {
      ...
      mceInsertRawHTML: function mceInsertRawHTML(y, x, v) {
        p.setContent("tiny_mce_marker");
        n.setContent(n.getContent().replace(/tiny_mce_marker/g, function () {
          return v;
        }));
      },
      mceToggleFormat: function mceToggleFormat(y, x, v) {
        s(v);
      },
      mceSetContent: function mceSetContent(y, x, v) {
        n.setContent(v);
      },
      "Indent,Outdent": function IndentOutdent(z) {
        var x, v, y;
        x = k.indentation;
        v = /[a-z%]+$/i.exec(x);
        x = parseInt(x);
    ...
    }, _defineProperty(_u, "mceToggleFormat", function mceToggleFormat(y, x, v) {
      q.toggle(v);
    }), _defineProperty(_u, "InsertHorizontalRule", function InsertHorizontalRule() {
      n.execCommand("mceInsertContent", false, "<hr />");
    }), _defineProperty(_u, "mceToggleVisualAid", function mceToggleVisualAid() {
      n.hasVisual = !n.hasVisual;
      n.addVisual();
    }), _defineProperty(_u, "mceReplaceContent", function mceReplaceContent(y, x, v) {
      n.execCommand("mceInsertContent", false, v.replace(/\{\$selection\}/g, p.getContent({
        format: "text"
      })));
    }), _defineProperty(_u, "mceInsertLink", function mceInsertLink(z, y, x) {
      var v;
    ...
    }), _defineProperty(_u, "selectAll", function selectAll() {
      var x = m.getRoot(),
          v = m.createRng();
      v.setStart(x, 0);
    ...
    u({
      "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function JustifyLeftJustifyCenterJustifyRightJustifyFull(z) {
      ...
      "InsertUnorderedList,InsertOrderedList": function InsertUnorderedListInsertOrderedList(v) {
        return m.getParent(p.getNode(), v == "insertunorderedlist" ? "UL" : "OL");
      }
    }, "state");
    u({
      "FontSize,FontName": function FontSizeFontName(y) {
        var x = 0,
            v;
...
(function (c) {
  ...
  c.create("tinymce.ControlManager", {
    ControlManager: function ControlManager(f, j) {
      var h = this,
          g;
      j = j || {};
      h.editor = f;
    ...
    setActive: function setActive(h, f) {
      var g = null;
    ...
    setDisabled: function setDisabled(h, f) {
      var g = null;
    ...
    createControl: function createControl(j) {
      var o,
          k,
          g,
          h = this,
    ...
    createDropMenu: function createDropMenu(f, n, h) {
      var m = this,
          i = m.editor,
          j,
          g,
    ...
    createListBox: function createListBox(f, n, h) {
      var l = this,
          j = l.editor,
          i,
          k,
    ...
    createButton: function createButton(m, i, l) {
      var h = this,
          g = h.editor,
          j,
          k,
    ...
    createMenuButton: function createMenuButton(h, f, g) {
      f = f || {};
      f.menu_button = 1;
      return this.createButton(h, f, g);
    },
    createSplitButton: function createSplitButton(m, i, l) {
      var h = this,
          g = h.editor,
          j,
          k,
    ...
    createColorSplitButton: function createColorSplitButton(f, n, h) {
      var l = this,
          j = l.editor,
          i,
          k,
    ...
    createToolbar: function createToolbar(k, h, j) {
      var i,
          g = this,
          f;
      k = g.prefix + k;
    ...
    createToolbarGroup: function createToolbarGroup(k, h, j) {
      var i,
          g = this,
          f;
      k = g.prefix + k;
    ...
    createSeparator: function createSeparator(g) {
      var f = g || this._cls.separator || c.ui.Separator;
      return new f();
    },
    setControlType: function setControlType(g, f) {
...
(function (d) {
  ...
  d.create("tinymce.WindowManager", {
    WindowManager: function WindowManager(f) {
      var g = this;
      g.editor = f;
      g.onOpen = new a(g);
      g.onClose = new a(g);
    ...
    createInstance: function createInstance(i, h, g, m, l, k) {
      var j = d.resolve(i);
      return new j(h, g, m, l, k);
    },
    confirm: function confirm(h, f, i, g) {
      g = g || window;
      f.call(i || this, g.confirm(this._decode(this.editor.getLang(h, h))));
    },
    alert: function alert(h, f, j, g) {
      var i = this;
      g = g || window;
    ...
    resizeBy: function resizeBy(f, g, h) {
      h.resizeBy(f, g);
    },
    _decode: function _decode(f) {
    ...
    function j() {
      l({
        ...
        link: {
          ...
          split: true,
          deep: true,
          onmatch: function onmatch(ab) {
            return true;
          },
          onformat: function onformat(ad, ab, ac) {
            T(ac, function (af, ae) {
...
(function (b) {
  ...
  b.EnterKey = function (f) {
    ...
    function g(A) {
      ...
      function D(M) {
        return M && i.isBlock(M) && !/^(TD|TH|CAPTION|FORM)$/.test(M.nodeName) && !/^(fixed|absolute)/i.test(M.style.position) && i.getContentEditable(M) !== "true";
      }

      function F(N) {
        var M;

        if (b.isIE && i.isBlock(N)) {
          M = e.getRng();
          N.appendChild(i.create("span", null, "\xA0"));
          e.select(N);
          N.lastChild.outerHTML = "";
          e.setRng(M);
        }
      }
      ...
      function y(O) {
        ...
        while (N = N.firstChild) {
          ...
          if (N.nodeType == 1 && !c[N.nodeName.toLowerCase()]) {
            P.push(N);
          }
        }
        ...
        while (M--) {
          ...
          if (!N.hasChildNodes() || N.firstChild == N.lastChild && N.firstChild.nodeValue === "") {
            i.remove(N);
          }
        }
      }
      ...
      function m(N) {
        ...
        if (N.hasChildNodes()) {
          ...
          if (N.nodeName == "BR") {
            if (N.nextSibling && i.isBlock(N.nextSibling)) {
              if (!L || L < 9) {
                O = i.create("br");
        ...
        e.setRng(M);
        i.remove(O);
        R = i.getViewPort(f.getWin());
        T = i.getPos(N).y;

        if (T < R.y || T + 25 > R.y + R.h) {
          f.getWin().scrollTo(0, T < R.y ? T : T - R.h + 25);
        }
      }
      ...
      function r(N) {
        var O = z,
            ...
            P,
            M;
        Q = N || t == "TABLE" ? i.create(N || x) : p.cloneNode(false);
        M = Q;
      ...
      function q(P) {
        ...
        if (z.nodeType == 3 && (P ? u > 0 : u < z.nodeValue.length)) {
          return false;
        }

        if (z.parentNode == p && B && !P) {
          return true;
        }

        if (P && z.nodeType == 1 && z == p.firstChild) {
          return true;
        }
      ...
      function G() {
        function M(O) {
          var N = n[O ? "firstChild" : "lastChild"];
          ...
          while (N) {
            ...
            N = N[O ? "nextSibling" : "previousSibling"];
          }
      ...
      function K() {
        ...
        if (b.isIE && t == "PRE" && (!L || L < 8)) {
          N.parentNode.insertBefore(i.doc.createTextNode("\r"), N);
        }
      ...
      function J(O) {
        ...
        while (N !== M && i.getContentEditable(N) !== "false") {
          if (i.getContentEditable(N) === "true") {
            P = N;
          }
      ...
      function H(N) {
        ...
        if (!b.isIE) {
          ...
          if (!M || /^(left|right)$/gi.test(i.getStyle(M, "float", true))) {
            i.add(N, "br");
          }
        }
      }
      ...
      z = v.startContainer;
      u = v.startOffset;
      x = d.forced_root_block;
      x = x ? x.toUpperCase() : "";
      L = i.doc.documentMode;

      if (z.nodeType == 1 && z.hasChildNodes()) {
        B = u > z.childNodes.length - 1;
      ...
      if (t == "PRE" && d.br_in_pre !== false) {
        ...
        if (!x && !A.shiftKey && t != "LI" || x && A.shiftKey) {
          K();
          return;
        }
      }
      ...
      if (q()) {
        if (/^(H[1-6]|PRE)$/.test(t) && I != "HGROUP") {
          o = r(x);
        } else {
          o = r();
        }

        if (d.end_container_on_empty_block && D(n) && i.isEmpty(p)) {
          o = i.split(n, p);
        } else {
          i.insertAfter(o, p);
        }
