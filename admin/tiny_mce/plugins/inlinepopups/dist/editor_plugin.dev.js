...
(function () {
  ...
  tinymce.create("tinymce.InlineWindowManager:tinymce.WindowManager", {
    InlineWindowManager: function InlineWindowManager(f) {
      var g = this;
      g.parent(f);
      g.zIndex = 300000;
      g.count = 0;
    ...
    _startDrag: function _startDrag(v, G, E) {
      var o = this,
          u,
          z,
          C = d.doc,
    ...
    resizeBy: function resizeBy(g, h, i) {
    ...
    setTitle: function setTitle(f, g) {
      var h;
      f = this._findId(f);
    ...
    alert: function alert(g, f, j) {
      var i = this,
          h;
      h = i.open({
        title: i,
        type: "alert",
        button_func: function button_func(k) {
          if (f) {
            f.call(k || i, k);
          }
    ...
    confirm: function confirm(g, f, j) {
      var i = this,
          h;
      h = i.open({
        title: i,
    ...
    _fixIELayout: function _fixIELayout(i, h) {
      var f, g;
