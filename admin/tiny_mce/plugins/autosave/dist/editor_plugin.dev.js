...
(function (e) {
  ...
  e.create("tinymce.plugins.AutoSave", {
    ...
    setupStorage: function setupStorage(i) {
      var h = this,
          k = c + "_test",
          j = "OK";
      h.key = c + i.id;
      e.each([function () {
        ...
        if (e.isIE) {
          ...
          return {
            ...
            removeItem: function removeItem(l) {
    ...
    "static": {
      _beforeUnloadHandler: function _beforeUnloadHandler(h) {
        var i;
