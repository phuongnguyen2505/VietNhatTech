    ...
    init: function init(a, b) {
      ...
      a.addCommand("mcePreview", function () {
        a.windowManager.open({
          ...
          width: parseInt(a.getParam("plugin_preview_width", "550")),
          height: parseInt(a.getParam("plugin_preview_height", "600")),
          resizable: "yes",
          scrollbars: "yes",
          popup_css: c ? c.join(",") : a.baseURI.toAbsolute("themes/" + a.settings.theme + "/skins/" + a.settings.skin + "/content.css"),
          inline: a.getParam("plugin_preview_inline", 1)
        }, {
          base: a.documentBaseURI.getURI()
        });
      });
      a.addButton("preview", {
        title: "preview.preview_desc",
        cmd: "mcePreview"
      });
    },
