...
(function () {
  tinymce.create('tinymce.plugins.VisualChars', {
    init: function init(ed, url) {
      ...
      ed.addCommand('mceVisualChars', t._toggleVisualChars, t); // Register buttons
    ...
    // Private methods
    _toggleVisualChars: function _toggleVisualChars(bookmark) {
      var t = this,
          ed = t.editor,
          nl,
          i,
      ...
      if (t.state) {
        ...
        tinymce.walk(b, function (n) {
          if (n.nodeType == 3 && n.nodeValue && n.nodeValue.indexOf("\xA0") != -1) nl.push(n);
        }, 'childNodes');
