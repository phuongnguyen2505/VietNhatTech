...
(function () {
  ...
  tinymce.create("tinymce.plugins.TemplatePlugin", {
    init: function init(b, c) {
      ...
      b.addCommand("mceTemplate", function (e) {
        b.windowManager.open({
          file: c + "/template.htm",
          width: b.getParam("template_popup_width", 750),
          height: b.getParam("template_popup_height", 600),
          inline: 1
        }, {
          plugin_url: c
        });
    ...
    _insertTemplate: function _insertTemplate(i, j) {
      var k = this,
          g = k.editor,
          f,
          c,
          d = g.dom,
          b = g.selection.getContent();
      f = j.content;
    ...
    _replaceVals: function _replaceVals(c) {
      var d = this.editor.dom,
          b = this.editor.getParam("template_replace_values");
    ...
    _getDateTime: function _getDateTime(e, b) {
      if (!b) {
        return "";
      }
