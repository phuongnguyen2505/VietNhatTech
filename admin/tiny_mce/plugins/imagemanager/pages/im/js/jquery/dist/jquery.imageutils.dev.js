...
/**
 * $Id: jquery.imageutils.js 466 2008-10-15 14:54:52Z spocke $
 *
 * @author Moxiecode
  ...
  $.extend($.ImageUtils.prototype, {
    render: function render() {
      ...
      $(t.img).load(function () {
        ...
        } else t.target.after('<v:image id="editImageVML" src="' + t.img.src + '" style="width:' + t.img.width + 'px;height:' + t.img.height + 'px"></v:image>');
    ...
    destroy: function destroy() {
      var t = this;
      if (t.canvas) $(t.canvas).remove();else $('#editImageVML').remove();
      t.target.show();
    }
  });
})(jQuery);