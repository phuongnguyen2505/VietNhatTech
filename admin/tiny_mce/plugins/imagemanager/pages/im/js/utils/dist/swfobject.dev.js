...
deconcept.SWFObject.prototype = {
  useExpressInstall: function useExpressInstall(_d) {
...
deconcept.util = {
  getRequestParameter: function getRequestParameter(_2b) {
...
if (deconcept.SWFObject.doPrepUnload) {
  if (!deconcept.unloadSet) {
    deconcept.SWFObjectUtil.prepUnload = function () {
      __flash_unloadHandler = function __flash_unloadHandler() {};

      __flash_savedUnloadHandler = function __flash_savedUnloadHandler() {};
