  ...
  tinymce.create('tinymce.plugins.ContextMenu', {
    ...
    init: function init(ed) {
      ...
      showMenu = ed.onContextMenu.add(function (ed, e) {
        ...
        Event.cancel(e); // Select the image if it's clicked. WebKit would other wise expand the selection
      ...
      ed.onRemove.add(function () {
        if (t._menu) t._menu.removeAll();
      });

      function hide(ed, e) {
        realCtrlKey = 0; // Since the contextmenu event moves
