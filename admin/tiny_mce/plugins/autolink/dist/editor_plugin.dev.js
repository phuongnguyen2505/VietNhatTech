...
(function () {
  tinymce.create("tinymce.plugins.AutolinkPlugin", {
    ...
    handleEclipse: function handleEclipse(a) {
      this.parseCurrentLine(a, -1, "(", true);
    },
    handleSpacebar: function handleSpacebar(a) {
      this.parseCurrentLine(a, 0, "", true);
    },
    handleEnter: function handleEnter(a) {
      this.parseCurrentLine(a, -1, "", false);
    },
    parseCurrentLine: function parseCurrentLine(i, d, b, g) {
