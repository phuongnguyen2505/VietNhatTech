  ...
  tinymce.create("tinymce.plugins.StylePlugin", {
    init: function init(a, b) {
      a.addCommand("mceStyleProps", function () {
        var c = false;
        var f = a.selection.getSelectedBlocks();
        var d = [];

        if (f.length === 1) {
          d.push(a.selection.getNode().style.cssText);
        } else {
          tinymce.each(f, function (g) {
            d.push(a.dom.getAttrib(g, "style"));
          });
          c = true;
        }
        ...
        a.windowManager.open({
          ...
          height: 340 + parseInt(a.getLang("style.delta_height", 0)),
          inline: 1
        }, {
          applyStyleToBlocks: c,
          plugin_url: b,
          styles: d
        });
      });
