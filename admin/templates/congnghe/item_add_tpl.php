...
?>
<form name="frm" method="post" action="index.php?com=congnghe&act=save&curPage=<?php echo isset($_REQUEST['curPage'])?>"
    enctype="multipart/form-data" class="nhaplieu">
    <!-- <b>Danh mục:</b><?php echo get_main_cat();?><br /><br /> -->

    <?php if ($_REQUEST['act']=='edit') {?>
    <b>Hình hiện tại:</b><img src="<?php echo _upload_tintuc.$item['thumb']?>" alt="NO PHOTO" /><br />
    <?php }?>
    <b>Hình ảnh:</b> <input type="file" name="file" /> <?php echo _product_type?> - <strong>Kích thước chuẩn: width
        210px -
        height 230px</strong><br />
    <br />
    <?php if ($_REQUEST['act']=='edit') {?>
    ...
    <div id="info_deals" class="usual">
        ...
        <div id="tab1" class="content_tab">
            ...
            <br><br />
            <b>Mô tả</b> <input name="mota_vi" id="mota_vi" value="<?php echo @$item['mota_vi']?>" class="input">
            <br><br />
            <b>Nội dung(VI)</b><br />
            <div>
  ...
  <br><br />
   <b>Nội dung(JP)</b><br/>
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=congnghe&act=man'"
        class="btn" />
</form>
