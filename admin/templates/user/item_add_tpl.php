...
function js_submit(){
	...
	if(document.frm.oldpassword.value.length<3){
...
<form name="frm" method="post" action="index.php?com=user&act=save" enctype="multipart/form-data" class="nhaplieu" onSubmit="return js_submit();">
	...
	<b>Tên đăng nhập</b> <input type="text" name="username" id="username" value="<?=$item['username']?>" class="input" disabled="disabled" /><br />
	<b>Mật khẩu mới</b> <input type="password" name="oldpassword" id="oldpassword" value="" class="input" /><span class="require">*</span><br />
