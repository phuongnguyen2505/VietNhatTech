...
?>
<form name="frm" method="post" action="index.php?com=tuyendung&act=save&curPage=<?=$_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">	 
    <?php /*?> <b>Danh mục 2:</b><?=get_main_cat();?><br /><br />   <?php */?>
	<?php if ($_REQUEST['act']==edit)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_tintuc.$item['thumb']?>"  alt="NO PHOTO" /><br />
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> width:230px , height:160px; <?=_product_type?><br />
    <br />
    ...
    <div id="info_deals" class="usual"> 
		<ul id="tab_content"> 
			...
			<?php /*?><li><a href="#tab4">Tiếng Nhật Bản</a></li>   <?php */?>          	   
		</ul> 
  ...
  <b>Nội dung(CA)</b><br/>
    ...
    <?php /*?><div id="tab4" class="content_tab">
...
height:"500px",
	...
	{				
		...
		window.location ="index.php?com=tuyendung&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_list="+a.value;	
		return true;
	}
</script>
