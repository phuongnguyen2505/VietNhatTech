...
<script language="javascript">
	function select_onchange()
	{
		...
		window.location ="index.php?com=news&act=man&id_cat="+a.value;	
		return true;
	}
...
function get_main_cat()
	{
		$sql="select ten_vi,id from table_news_cat where com='tin-tuc' order by stt asc";
...
<table class="blue_table">
    ...
    <th style="width:5%" align="center"><input type="checkbox" name="chonhet" id="chonhet" /></th>
        ...
        <!-- <th style="width:5%;">Tin Nổi bật</th> -->
    ...
    <td style="width:5%;" align="center"><input type="checkbox" name="chon" id="chon" value="<?=$items[$i]['id']?>" class="chon" /></td>
       ...
       <!--  <td style="width:35%;">
		...
		<td style="width:30%;" align="center"><a href="index.php?com=news&act=edit&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>
        <!--  <td align="center" style="width:5%;">
        <?php
        if($items[$i]['tinmoi']>0)
        {
        ?>
        <a href="index.php?com=news&act=man&tinmoi=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/yes-km.gif" border="0" /></a>
        <?php
        }
        else
        {
        ?>
        <a href="index.php?com=news&act=man&tinmoi=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/no-km.gif" border="0" /></a>
        <?php }
        ?>      </td> -->
        <!-- <td align="center" style="width:5%;">
        <?php
        ...
        {
        ?>
        <a href="index.php?com=news&act=man&tinnoibat=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/yes-km.gif" border="0" /></a>
        <?php
        }
        else
        {
        ?>
        <a href="index.php?com=news&act=man&tinnoibat=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/no-km.gif" border="0" /></a>
        <?php }
        ?>      </td> -->
		...
		<td style="width:5%;" align="center"><a href="index.php?com=news&act=edit&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png"  border="0"/></a></td>
