...
<table class="blue_table">
    ...
    <tr>
        ...
        <td style="width:20%;"><a
                href="index.php?com=product_kitz&act=edit&id_list=<?php echo $items[$i]['id_list']?>&id_cat=<?php echo $items[$i]['id_cat']?>&id_item=<?php echo $items[$i]['id_item']?>&id=<?php echo $items[$i]['id']?>"
        ...
        <a href="index.php?com=product_kitz&act=man&spbc=<?php echo $items[$i]['id']?><?php if($_REQUEST['curPage']!='') { echo'&curPage='. $_REQUEST['curPage'];
        ...
        <a href="index.php?com=product_kitz&act=man&sptb=<?php echo $items[$i]['id']?><?php if($_REQUEST['curPage']!='') { echo'&curPage='. $_REQUEST['curPage'];
                                                         }?>"><img src="media/images/yes-km.gif" border="0" /></a>
        <? 
        }
        else
        ...
        <td style="width:5%;"><a
                href="index.php?com=product_kitz&act=edit&id_list=<?php echo $items[$i]['id_list']?>&id_cat=<?php echo $items[$i]['id_cat']?>&id_item=<?php echo $items[$i]['id_item']?>&id=<?php echo $items[$i]['id']?>"><img
                    src="media/images/edit.png" /></a></td>
        <td style="width:5%;"><a href="index.php?com=product_kitz&act=delete&id=<?php echo $items[$i]['id']?>"
                onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" /></a></td>
    </tr>
    <?php	}?>
</table>
<a href="index.php?com=product_kitz&act=add"><img src="media/images/add.jpg"
