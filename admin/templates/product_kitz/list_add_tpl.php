<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=product_kitz&act=save_list" enctype="multipart/form-data" class="nhaplieu">	  
<!-- 
<?php if ($_REQUEST['act']==edit_list)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_product_kitz.$item['thumb']?>"  alt="NO PHOTO" width="250"/><br />
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> width: 230px - height:230px <?=_product_kitz_type?><br />
    <br /> 
...
<div id="info_deals" class="usual"> 
  ...
  <br><br />	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product_kitz&act=man_list'" class="btn" />
</form>