...
<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=product_kitz&act=save_cat" enctype="multipart/form-data" class="nhaplieu">	    
 <b>Danh mục:</b><?=get_main_category();?><br /><br />
 
 <?php /*?><?php if ($_REQUEST['act']==edit_cat)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_product_kitz.$item['thumb']?>"  alt="NO PHOTO" /><br />
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> <?=_product_kitz_type?><br />
    <br />  
<?php */?>
<div id="info_deals" class="usual"> 
  ...
  <br><br />	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product_kitz&act=man_cat'" class="btn" />
</form>
