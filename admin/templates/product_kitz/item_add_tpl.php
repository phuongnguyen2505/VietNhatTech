...
function select_onchange() {
    ...
    window.location =
        "index.php?com=product_kitz&act=<?php if($_REQUEST['act']=='edit') { echo 'edit'; 
                                        } else { echo 'add';
...
<form name="frm" method="post"
    action="index.php?com=product_kitz&act=save&curPage=<?php echo isset($_REQUEST['curPage'])?>"
  ...
  <br><br />
   <b>Nội dung(JP)</b><br/>
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product_kitz&act=man'"
        class="btn" />
</form>
...
function select_onchange() {
    var a = document.getElementById("id_list");
    window.location = "index.php?com=product_kitz&act=add&id_list=" + a.value;
    return true;
}
</script>
