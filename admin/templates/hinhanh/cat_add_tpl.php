...
<form name="frm" method="post" action="index.php?com=hinhanh&act=save_cat" enctype="multipart/form-data" class="nhaplieu">
	<?php if ($_REQUEST['act']==edit_cat)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_thuvienanh.$item['thumb']?>"  alt="NO PHOTO" /><br />
	<?php }?>
	<b>Hình đại diện:</b> <input type="file" name="file" /> <?=_product_type?> - <span style="color:#F00">Width:200px - Height:150px (hoặc tỉ lệ tương ứng)</span><br />
    <br />
    ...
    <div id="info_deals" class="usual"> 
                 ...
                 <li><a href="#tab3">Tiếng Đài Loan</a></li>  
  ...
  <br><br />	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=hinhanh&act=man_cat'" class="btn" />
</form>