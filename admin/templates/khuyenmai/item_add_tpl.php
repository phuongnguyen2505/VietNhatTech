...
?>
<form name="frm" method="post" action="index.php?com=khuyenmai&act=save&curPage=<?=$_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">	 
    <!-- <b>Danh mục 2:</b><?=get_main_cat();?><br /><br />  --> 
	<?php if ($_REQUEST['act']==edit)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_tintuc.$item['thumb']?>"  alt="NO PHOTO" /><br />
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> <?=_product_type?> - <strong>Kích thước chuẩn: width 160px - height 110px</strong><br />
    <br />
...
height:"500px",
	...
	{				
		...
		window.location ="index.php?com=khuyenmai&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_list="+a.value;	
		return true;
	}
</script>
