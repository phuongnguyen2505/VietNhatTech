...
{
    $sql="select ten_vi,id from table_product_other_item where hienthi=1 and id_list=".$_REQUEST['id_list']." and id_cat=".$_REQUEST['id_cat']." order by stt asc";
    $stmt=mysql_query($sql);
    $str='
...
<form name="frm" method="post"
  ...
  <br><br />
   <b>Nội dung(JP)</b><br/>
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product_other&act=man'"
        class="btn" />
</form>
