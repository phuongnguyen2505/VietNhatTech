...
<table class="blue_table">
    ...
    <tr>
        ...
        <td align="center" style="width:5%;">
            ...
            <a
                href="index.php?com=product_other&act=man&noibat=<?php echo $items[$i]['id']?><?php if($_REQUEST['curPage']!='') { echo'&curPage='. $_REQUEST['curPage'];
                                                                 }?>"><img
        ...
        <td style="width:5%;">
            ...
            <a
                href="index.php?com=product_other&act=man&hienthi=<?php echo $items[$i]['id']?><?php if($_REQUEST['curPage']!='') { echo'&curPage='. $_REQUEST['curPage'];
                                                                  }?>"><img
