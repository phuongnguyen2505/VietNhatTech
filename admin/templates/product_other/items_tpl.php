...
<table class="blue_table">
    ...
    <tr>
        <td style="width:5%;" align="center"><input type="checkbox" name="chon" id="chon" value="<?=$items[$i]['id']?>"
                class="chon" /></td>
        ...
        <td style="width:20%;"><a
                href="index.php?com=product_other&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>"
		...
		?>
            ...
            <a
                href="index.php?com=product_other&act=man&noibat=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img
        ...
        <a href="index.php?com=product_other&act=man&spbc=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/yes-km.gif" border="0" /></a>
		<? 
		}
		else
		{
		?>
         <a href="index.php?com=product_other&act=man&spbc=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/no-km.gif"  border="0"/></a>
         <?php
		 }?>      
         </td>  -->
        <!-- <td align="center" style="width:5%;">
        ...
        <a href="index.php?com=product_other&act=man&sptb=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/yes-km.gif" border="0" /></a>
		<? 
		}
		else
		{
		?>
         <a href="index.php?com=product_other&act=man&sptb=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img src="media/images/no-km.gif"  border="0"/></a>
         <?php
		 }?>      
         </td>      -->
        <td style="width:5%;">
		...
		?>
            ...
            <a
                href="index.php?com=product_other&act=man&hienthi=<?=$items[$i]['id']?><?php if($_REQUEST['curPage']!='') echo'&curPage='. $_REQUEST['curPage'];?>"><img
        ...
        <td style="width:5%;"><a
                href="index.php?com=product_other&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>"><img
                    src="media/images/edit.png" /></a></td>
        <td style="width:5%;"><a href="index.php?com=product_other&act=delete&id=<?=$items[$i]['id']?>"
