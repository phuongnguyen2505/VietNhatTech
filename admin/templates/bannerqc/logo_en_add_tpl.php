...
<form name="frm" method="post" action="index.php?com=bannerqc&act=save_en" enctype="multipart/form-data" class="nhaplieu">
	<b>Hình hiện tại:</b> 
	<?php
	 if($item['photo']!=NULL)
	 {
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=bannerqc&act=capnhat_en'" class="btn" />
</form>