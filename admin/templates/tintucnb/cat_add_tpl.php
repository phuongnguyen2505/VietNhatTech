...
<form name="frm" method="post" action="index.php?com=newsnb&act=save_cat" enctype="multipart/form-data" class="nhaplieu">
  ...
  <br><br />	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=newsnb&act=man_cat'" class="btn" />
</form>