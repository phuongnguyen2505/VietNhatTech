...
?>
<form name="frm" method="post" action="index.php?com=newsnb&act=save&curPage=<?=$_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">	 
    <!-- <b>Danh mục 2:</b><?php /*?><?=get_main_cat();?><?php */?><br /><br />-->   
  ...
  <br><br />
   <b>Nội dung(JP)</b><br/>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=newsnb&act=man'" class="btn" />
</form>
...
height:"500px",
	...
	{				
		...
		window.location ="index.php?com=newsnb&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_list="+a.value;	
		return true;
	}
</script>
