...
<?php if ($_REQUEST['act']==edit_list)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_product.$item['thumb']?>"  alt="NO PHOTO" width="250"/><br />
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> width: 230px - height:230px <?=_product_type?><br />
    <br /> 
