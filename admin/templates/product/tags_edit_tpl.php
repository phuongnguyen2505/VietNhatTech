<h3>Hinh ảnh</h3>
<form name="frm" method="post" action="index.php?com=product&act=save_tags" enctype="multipart/form-data" class="nhaplieu">
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product&act=man_tags&idp=<?=$_REQUEST['idp']?>'" class="btn" />
</form>