...
jQuery.fn.wowSlider = function (aj) {
  ...
  function I() {
    H.find(".ws_bullets a,.ws_thumbs a").click(function (a6) {
      aN(a6, aF(this).index());
    });
    ...
    function a4(bc) {
      ...
      for (var bb = 0; bb < 2; bb++) {
        var bf = al[bb ? "width" : "height"](),
            ba = aZ[bb ? "width" : "height"](),
            a6 = bf - ba;

        if (a6 < 0) {
          var a7,
              a9,
              bd = (bc[bb ? "pageX" : "pageY"] - al.offset()[bb ? "left" : "top"]) / bf;
          ...
          aV = bd;
          var a8 = aZ.position()[bb ? "left" : "top"];
          aZ.css({
            transition: "0ms linear",
            transform: "translate3d(" + a8.left + "px," + a8.top + "px,0)"
          });
          aZ.stop(true);
          ...
          if (E > 0) {
            ...
            a7 = bd < 0.5 ? 0 : a6 - 1;
            a9 = E * Math.abs(a8 - a7) / (Math.abs(bd - 0.5) - be);
          } else {
            a7 = a6 * Math.min(Math.max((bd - be) / (1 - 2 * be), 0), 1);
            a9 = -E * ba / 2;
          }
          ...
          aZ.animate(bb ? {
            ...
            top: a7
          }, a9, E > 0 ? "linear" : "easeOutCubic");
        } else {
          aZ.css(bb ? "left" : "top", a6 / 2);
        }
      }
    }
    ...
    if (al.length) {
      ...
      k.bind("mousemove mouseover", a4);
      aF(window).bind("resize load", a4);
      k.mouseout(function (a6) {
      ...
      if (aj.gestures) {
        ay(al, aj.gestures == 2, function (ba, a7, a6) {
          if (k.width() > aZ.width() || k.height() > aZ.height()) {
            return false;
          }

          var a9 = Math.min(Math.max(aW + a7, al.width() - aZ.width()), 0),
              a8 = Math.min(Math.max(aX + a6, al.height() - aZ.height()), 0);
          aZ.css("left", a9);
          aZ.css("top", a8);
        }, function (a6) {
          a2 = 1;
      ...
      H.find(".ws_thumbs a").each(function (a6, a7) {
        ay(a7, 0, 0, function (a8) {
          return !!aF(a8.target).parents(".ws_thumbs").get(0);
        }, function (a8) {
          a2 = 1;
        }, function (a8) {
          aN(a8, aF(a7).index());
    ...
    if (av.length) {
      ...
      if (aT.length) {
        var aY = function aY(a8) {
          ...
          aF(a1.get(a8)).addClass("ws_overbull");
          aU.show();
          var a9 = {
            left: a1.get(a8).offsetLeft - aU.width() / 2,
            "margin-top": a1.get(a8).offsetTop - a1.get(0).offsetTop + "px",
            "margin-bottom": -a1.get(a8).offsetTop + a1.get(a1.length - 1).offsetTop + "px"
          };
          var a7 = aT.get(a8);
          var a6 = {
            left: -a7.offsetLeft + (aF(a7).outerWidth(true) - aF(a7).outerWidth()) / 2
          };
          ...
          if (c < 0) {
            ...
            aU.stop().animate(a9, "fast");
            f.stop().animate(a6, "fast");
          }

          c = a8;
        };

        var aU = aF('<div class="ws_bulframe"/>').appendTo(a5);
        var f = aF("<div/>").css({
        ...
        a5.click(function (a6) {
          aN(a6, aF(a6.target).index());
        });
      }
    }
  }
            ...
            if (f < 0) {
              if (aU) {
                aX.stop(true).animate({
                  left: -Math.max(Math.min(aV.left, -aY.left), aV.left + k.width() - al.width())
                });
              } else {
                aX.stop(true).animate({
