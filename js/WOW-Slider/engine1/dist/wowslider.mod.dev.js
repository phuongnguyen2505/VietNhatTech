...
(function (b) {
  ...
  b.fn.wowSlider = function (p) {
    ...
    var k = p.onStep;
    b.extend(p, {
      onBeforeStep: function onBeforeStep(O, P) {
        if (!N && m) {
          m[0].wsStop();
          return O;
        } else {
