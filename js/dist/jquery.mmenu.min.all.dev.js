  ...
  if (!e[t]) {
    ...
    e[t] = function (n, s, i) {
      ...
      for (var o in e[t].addons) {
        e[t].addons[o]._add.call(this), e[t].addons[o]._add = function () {}, e[t].addons[o]._setup.call(this);
      }
      ...
      _update: function _update(e) {
        if (this.updates || (this.updates = []), "function" == typeof e) this.updates.push(e);else for (var n = 0, t = this.updates.length; t > n; n++) {
  ...
  t[e].addons[n] = {
    ...
    _setup: function _setup() {
      ...
      "boolean" == typeof a && (a = {
        add: a,
        update: a
      }), "object" != _typeof(a) && (a = {}), a = t.extend(!0, {}, t[e].defaults[n], a), this.opts[n] = a;
    },
    _add: function _add() {
    ...
    _setup: function _setup() {
      if (this.opts.offCanvas) {
        ...
        if ("boolean" == typeof p && (p = {
          open: p
        }), "object" != _typeof(p) && (p = {}), p = e.extend(!0, {}, e[n].defaults[o], p), p.open) {
  ...
  t[o].addons[e] = {
    ...
    _setup: function _setup() {
      ...
      if ("boolean" == typeof a && (a = {
        add: a,
        update: a
      }), "object" != _typeof(a) && (a = {}), a = t.extend(!0, {}, t[o].defaults[e], a), this.opts[e] = a, a.add) {
  ...
  e[t].addons[a] = {
    ...
    _setup: function _setup() {
      ...
      if (this.conf[a], "boolean" == typeof s && (s = {
        add: s,
        update: s
      }), "object" != _typeof(s) && (s = {}), "undefined" == typeof s.content && (s.content = ["prev", "title", "next"]), s = e.extend(!0, {}, e[t].defaults[a], s), this.opts[a] = s, s.add) {
...
!function (l) {
  ...
  l[e].addons[s] = {
    ...
    _setup: function _setup() {
      ...
      "boolean" == typeof a && (a = {
        collapse: a
      }), "object" != _typeof(a) && (a = {}), a = l.extend(!0, {}, l[e].defaults[s], a), this.opts[s] = a;
    },
    _add: function _add() {
      a = l[e]._c, n = l[e]._d, o = l[e]._e, a.add("collapsed uncollapsed"), t = l[e].glbl;
    },
    _clickAnchor: function _clickAnchor(l, e) {
      if (e) {
        var s = l.parent();
  ...
  e[n].addons[t] = {
      ...
      if (l.add) {
        ...
        c.length && c.each(function () {
          ...
          if (!s.children(n + "." + a.search).length) {
            ...
            if ("form" == n && "object" == _typeof(d.form)) for (var c in d.form) {
              o.attr(c, d.form[c]);
            }
    ...
    _setup: function _setup() {
      ...
      this.conf[t], "boolean" == typeof s && (s = {
        add: s,
        search: s
      }), "object" != _typeof(s) && (s = {}), s = e.extend(!0, {}, e[n].defaults[t], s), "boolean" != typeof s.showLinksOnly && (s.showLinksOnly = "menu" == s.addTo), this.opts[t] = s;
    },
    _add: function _add() {
