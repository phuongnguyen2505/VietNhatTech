...
(function (E, B) {
  ...
  function da(a, b, d, e) {
    if (c.isArray(b) && b.length) c.each(b, function (f, h) {
      d || Ra.test(a) ? e(a, h) : da(a + "[" + (_typeof(h) === "object" || c.isArray(h) ? f : "") + "]", h, d, e);
    });else if (!d && b != null && _typeof(b) === "object") c.isEmptyObject(b) ? e(a, "") : c.each(b, function (f, h) {
      da(a + "[" + f + "]", h, d, e);
    });else e(a, b);
  }
  ...
  var t = E.document,
    ...
    b.fn = b.prototype = {
      ...
      pushStack: function pushStack(j, s, v) {
        var z = b();
      ...
      each: function each(j, s) {
        return b.each(this, j, s);
      },
      ready: function ready(j) {
        b.bindReady();
    ...
    b.extend = b.fn.extend = function () {
      ...
      if (_typeof(G) !== "object" && !b.isFunction(G)) G = {};
      ...
      for (; K < Q; K++) {
        if ((j = arguments[K]) != null) for (s in j) {
          v = G[s];
          z = j[s];
    ...
    b.extend({
      noConflict: function noConflict(j) {
        E.$ = e;
        if (j) E.jQuery = d;
        return b;
      },
      ...
      bindReady: function bindReady() {
        if (!p) {
          ...
          if (t.addEventListener) {
            t.addEventListener("DOMContentLoaded", _u2, false);
            E.addEventListener("load", b.ready, false);
          } else if (t.attachEvent) {
            t.attachEvent("onreadystatechange", _u2);
      ...
      isWindow: function isWindow(j) {
        return j && _typeof(j) === "object" && "setInterval" in j;
      },
      ...
      type: function type(j) {
        return j == null ? String(j) : R[y.call(j)] || "object";
      },
      isPlainObject: function isPlainObject(j) {
      ...
      isEmptyObject: function isEmptyObject(j) {
        for (var s in j) {
          return false;
        }
      ...
      parseJSON: function parseJSON(j) {
      ...
      noop: function noop() {},
      globalEval: function globalEval(j) {
        if (j && l.test(j)) {
      ...
      nodeName: function nodeName(j, s) {
        return j.nodeName && j.nodeName.toUpperCase() === s.toUpperCase();
      },
      each: function each(j, s, v) {
        var z,
            H = 0,
            G = j.length,
      ...
      makeArray: function makeArray(j, s) {
        var v = s || [];
      ...
      merge: function merge(j, s) {
        var v = j.length,
            z = 0;
        if (typeof s.length === "number") for (var H = s.length; z < H; z++) {
          j[v++] = s[z];
        } else for (; s[z] !== B;) {
          j[v++] = s[z++];
        }
      ...
      access: function access(j, s, v, z, H, G) {
        var K = j.length;
    ...
    f = b(t);
    if (t.addEventListener) _u2 = function u() {
      t.removeEventListener("DOMContentLoaded", _u2, false);
      b.ready();
    };else if (t.attachEvent) _u2 = function _u() {
      if (t.readyState === "complete") {
        t.detachEvent("onreadystatechange", _u2);
        b.ready();
      }
    };
    return E.jQuery = E.$ = b;
  ...
  c.extend({
    ...
    data: function data(a, b, d) {
      if (c.acceptData(a)) {
        ...
        if (!(e && !f && typeof b === "string" && d === B)) {
          ...
          if (_typeof(b) === "object") {
            if (e) h[f] = c.extend(h[f], b);else c.extend(h, b);
          } else if (e && !h[f]) h[f] = {};
          a = e ? h[f] : h;
          if (d !== B) a[b] = d;
    ...
    removeData: function removeData(a, b) {
      if (c.acceptData(a)) {
        ...
        } else if (d && c.support.deleteExpando) delete a[c.expando];else if (a.removeAttribute) a.removeAttribute(c.expando);else if (d) delete f[e];else for (var l in a) {
          delete a[l];
        }
      }
    },
  ...
  c.fn.extend({
    data: function data(a, b) {
      ...
      if (typeof a === "undefined") {
        ...
        return d;
      } else if (_typeof(a) === "object") return this.each(function () {
        c.data(this, a);
      });
  ...
  c.event = {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        ...
        if (h = c.data(a)) {
          ...
          if (typeof k === "function") {
            ...
            a.nodeType || (h[l] = h = function h() {});
            h.events = k = {};
          }

          if (!_o) h.handle = _o = function o() {
            return typeof c !== "undefined" && !c.event.triggered ? c.event.handle.apply(_o.elem, arguments) : B;
          };
          _o.elem = a;
          b = b.split(" ");
          ...
          for (var x = 0, r; l = b[x++];) {
            ...
            if (!A) {
              A = k[l] = [];
              if (!C.setup || C.setup.call(a, e, r, _o) === false) if (a.addEventListener) a.addEventListener(l, _o, false);else a.attachEvent && a.attachEvent("on" + l, _o);
            }
    ...
    trigger: function trigger(a, b, d, e) {
      var f = a.type || a;

      if (!e) {
        a = _typeof(a) === "object" ? a[c.expando] ? a : c.extend(c.Event(f), a) : c.Event(f);
  ...
  c.each(["live", "die"], function (a, b) {
    c.fn[b] = function (d, e, f, h) {
      ...
      if (_typeof(d) === "object" && !d.preventDefault) {
        for (l in d) {
          h[b](l, e, d[l], r);
        }
  ...
  (function () {
        ...
        if (y) {
          ...
          for (y = y[g]; y;) {
            ...
            if (y.nodeType === 1) {
              ...
              } else if (_k2.filter(i, [y]).length > 0) {
                F = y;
                break;
              }
            }
    ...
    var _k2 = function k(g, i, n, m) {
      ...
      if (D.length > 1 && x.exec(g)) {
        if (D.length === 2 && o.relative[D[0]]) u = L(D[0] + D[1], i);else for (u = o.relative[D[0]] ? [i] : _k2(D.shift(), i); D.length;) {
          g = D.shift();
        ...
        if (!m && D.length > 1 && i.nodeType === 9 && !O && o.match.ID.test(D[0]) && !o.match.ID.test(D[D.length - 1])) {
          q = _k2.find(D.shift(), i, O);
          i = q.expr ? _k2.filter(q.expr, q.set)[0] : q.set[0];
        }
        ...
        if (i) {
          q = m ? {
            expr: D.pop(),
            set: C(m)
          } : _k2.find(D.pop(), D.length === 1 && (D[0] === "~" || D[0] === "+") && i.parentNode ? i.parentNode : i, O);
          u = q.expr ? _k2.filter(q.expr, q.set) : q.set;
      ...
      if (f.call(y) === "[object Array]") {
        if (N) {
          if (i && i.nodeType === 1) for (g = 0; y[g] != null; g++) {
            if (y[g] && (y[g] === true || y[g].nodeType === 1 && _k2.contains(i, y[g]))) n.push(u[g]);
    ...
    _k2.uniqueSort = function (g) {
      if (w) {
        h = l;
        g.sort(w);
        if (h) for (var i = 1; i < g.length; i++) {
    ...
    _k2.matches = function (g, i) {
      return _k2(g, null, null, i);
    };

    _k2.matchesSelector = function (g, i) {
      return _k2(i, null, null, [g]).length > 0;
    };

    _k2.find = function (g, i, n) {
      var m;
      if (!g) return [];
    ...
    _k2.filter = function (g, i, n, m) {
      for (var p, q, u = g, y = [], F = i, M = i && i[0] && _k2.isXML(i[0]); g && i.length;) {
        for (var N in o.filter) {
          if ((p = o.leftMatch[N].exec(g)) != null && p[2]) {
            ...
            if (D.substr(D.length - 1) !== "\\") {
              ...
              if (p) for (var j = 0; (D = F[j]) != null; j++) {
                if (D) {
                  O = R(D, p, j, F);
                  var s = m ^ !!O;
                  if (n && O != null) {
                    if (s) q = true;else F[j] = false;
                  } else if (s) {
                    y.push(D);
                    q = true;
                  }
        ...
        if (g === u) if (q == null) _k2.error(g);else break;
        u = g;
      }
    ...
    var o = _k2.selectors = {
      ...
      preFilter: {
        ...
        ATTR: function ATTR(g, i, n, m, p, q) {
          i = g[1].replace(/\\/g, "");
          if (!q && o.attrMap[i]) g[1] = o.attrMap[i];
          if (g[2] === "~=") g[4] = " " + g[4] + " ";
          return g;
        },
        PSEUDO: function PSEUDO(g, i, n, m, p) {
          if (g[1] === "not") {
            if ((d.exec(g[3]) || "").length > 1 || /^\w/.test(g[3])) g[3] = _k2(g[3], null, null, i);else {
              g = _k2.filter(g[3], i, n, true ^ p);
              n || m.push.apply(m, g);
              return false;
            }
      ...
      filters: {
        ...
        has: function has(g, i, n) {
          return !!_k2(n[3], g).length;
        },
      ...
      setFilters: {
        first: function first(g, i) {
          return i === 0;
        },
        last: function last(g, i, n, m) {
          return i === m.length - 1;
        },
        even: function even(g, i) {
          return i % 2 === 0;
        },
        odd: function odd(g, i) {
          return i % 2 === 1;
        },
        lt: function lt(g, i, n) {
          return i < n[3] - 0;
        },
        gt: function gt(g, i, n) {
          return i > n[3] - 0;
        },
        nth: function nth(g, i, n) {
          return n[3] - 0 === i;
        },
        eq: function eq(g, i, n) {
          return n[3] - 0 === i;
        }
      },
      filter: {
        PSEUDO: function PSEUDO(g, i, n, m) {
          var p = i[1],
              q = o.filters[p];
          if (q) return q(g, n, i, m);else if (p === "contains") return (g.textContent || g.innerText || _k2.getText([g]) || "").indexOf(i[3]) >= 0;else if (p === "not") {
            i = i[3];
            n = 0;
            ...
            return true;
          } else _k2.error("Syntax error, unrecognized expression: " + p);
        },
        CHILD: function CHILD(g, i) {
          var n = i[1],
              m = g;
    ...
    try {
      ...
      C = function C(g, i) {
        var n = 0,
            m = i || [];
        if (f.call(g) === "[object Array]") Array.prototype.push.apply(m, g);else if (typeof g.length === "number") for (var p = g.length; n < p; n++) {
          m.push(g[n]);
        } else for (; g[n]; n++) {
          m.push(g[n]);
        }
    ...
    var w, I;
    if (t.documentElement.compareDocumentPosition) w = function w(g, i) {
      if (g === i) {
        h = true;
        return 0;
      }
    ...
    _k2.getText = function (g) {
      for (var i = "", n, m = 0; g[m]; m++) {
        n = g[m];
        if (n.nodeType === 3 || n.nodeType === 4) i += n.nodeValue;else if (n.nodeType !== 8) i += _k2.getText(n.childNodes);
      }
    ...
    t.querySelectorAll && function () {
      ...
      if (!(i.querySelectorAll && i.querySelectorAll(".TEST").length === 0)) {
        _k2 = function _k(m, p, q, u) {
          p = p || t;
          m = m.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']");
          if (!u && !_k2.isXML(p)) if (p.nodeType === 9) try {
    ...
    (function () {
      ...
      if (i) _k2.matchesSelector = function (p, q) {
        q = q.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']");
        if (!_k2.isXML(p)) try {
          if (n || !o.match.PSEUDO.test(q) && !/!=/.test(q)) return i.call(p, q);
        } catch (u) {}
        return _k2(q, null, null, [p]).length > 0;
      };
    })();
    ...
    _k2.contains = t.documentElement.contains ? function (g, i) {
    ...
    _k2.isXML = function (g) {
      return (g = (g ? g.ownerDocument || g : 0).documentElement) ? g.nodeName !== "HTML" : false;
    };

    var L = function L(g, i) {
      ...
      return _k2.filter(p, m);
    };

    c.find = _k2;
    c.expr = _k2.selectors;
    c.expr[":"] = c.expr.filters;
    c.unique = _k2.uniqueSort;
    c.text = _k2.getText;
    c.isXMLDoc = _k2.isXML;
    c.contains = _k2.contains;
  })();
  ...
  c.fn.extend({
    find: function find(a) {
      for (var b = this.pushStack("", "find", a), d = 0, e = 0, f = this.length; e < f; e++) {
        d = b.length;
        c.find(a, this[e], b);
        if (e > 0) for (var h = d; h < b.length; h++) {
          for (var l = 0; l < d; l++) {
            if (b[l] === b[h]) {
              b.splice(h--, 1);
              break;
  ...
  c.fn.extend({
    text: function text(a) {
      ...
      if (_typeof(a) !== "object" && a !== B) return this.empty().append((this[0] && this[0].ownerDocument || t).createTextNode(a));
      return c.text(this);
    },
  ...
  c.extend({
    ...
    cleanData: function cleanData(a) {
      for (var b, d, e = c.cache, f = c.event.special, h = c.support.deleteExpando, l = 0, k; (k = a[l]) != null; l++) {
        if (!(k.nodeName && c.noData[k.nodeName.toLowerCase()])) if (d = k[c.expando]) {
          if ((b = e[d]) && b.events) for (var o in b.events) {
  ...
  if (t.defaultView && t.defaultView.getComputedStyle) Ga = function Ga(a, b, d) {
    var e;
  ...
  if (t.documentElement.currentStyle) aa = function aa(a, b) {
    var d,
        e,
  ...
  c.fn.extend({
    load: function load(a, b, d) {
      ...
      c.ajax({
        ...
        dataType: "html",
        data: b,
        complete: function complete(l, k) {
  ...
  c.extend({
    ...
    triggerGlobal: function triggerGlobal(a, b, d) {
  ...
  c.fn.extend({
    ...
    fadeTo: function fadeTo(a, b, d, e) {
      return this.filter(":hidden").css("opacity", 0).show().end().animate({
        opacity: b
      }, a, d, e);
    },
    animate: function animate(a, b, d, e) {
      var f = c.speed(b, d, e);
        ...
        for (l in a) {
          ...
          if (k && (l === "height" || l === "width")) {
            ...
            if (c.css(this, "display") === "inline" && c.css(this, "float") === "none") if (c.support.inlineBlockNeedsLayout) {
              if (qa(this.nodeName) === "inline") this.style.display = "inline-block";else {
  ...
  c.extend({
    speed: function speed(a, b, d) {
      var e = a && _typeof(a) === "object" ? c.extend({}, a) : {
    ...
    easing: {
      linear: function linear(a, b, d, e) {
        return d + e * a;
      },
      swing: function swing(a, b, d, e) {
    ...
    step: function step(a) {
      ...
      if (a || b >= this.options.duration + this.startTime) {
        ...
        if (d) {
          ...
          if (this.options.hide || this.options.show) for (var l in this.options.curAnim) {
