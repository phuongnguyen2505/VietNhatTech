...
(function (c, j, i) {
  ...
  c.simplyScroll = function (a, b) {
    ...
    this.isRTL = (this.isHorizontal = null !== this.o.orientation.match(/^horizontal|vertical$/) && this.o.orientation == h.orientation) && "rtl" == c("html").attr("dir");
  ...
  c.simplyScroll.fn = c.simplyScroll.prototype = {};
  ...
  c.simplyScroll.fn.extend({
    init: function init() {
      ...
      if (this.isAuto && "loop" == this.o.autoMode) this.$list.css(this.dimension, this.posMax + this.itemMax * a + "px"), this.posMax += this.clipMax - this.o.speed, this.isForwards ? (this.$items.slice(0, a).clone(!0).appendTo(this.$list), this.resetPosition = 0) : (this.$items.slice(-a).clone(!0).prependTo(this.$list), this.resetPosition = this.$items.length * this.itemMax, this.isRTL && (this.$clip[0].dir = "ltr", this.$items.css("float", "right")));else if (!this.isAuto && "loop" == this.o.manualMode) {
      ...
      if (this.isAuto || "end" != this.o.manualMode) for (; 0 !== this.itemMax % this.o.speed;) {
      ...
      if (this.isAuto) {
        ...
        if (this.isAuto && this.o.pauseOnHover && !this.supportsTouch) this.$clip.bind(this.events.start, this.funcMovePause).bind(this.events.end, this.funcMoveResume);else if (this.isAuto && this.o.pauseOnTouch && !this.o.pauseButton && this.supportsTouch) {
          ...
          this.$clip.bind(this.events.start, function (a) {
            ...
            if (a < 0) a = 0;else if (a > b.posMax) a = b.posMax;
    ...
    movePause: function movePause() {
      clearInterval(this.interval);
    },
    moveStop: function moveStop(a) {
      this.movePause();
    ...
    moveResume: function moveResume() {
