...
(function (a) {
  var b,
    ...
    return a.each(r.split(" "), function (a, c) {
      ...
      t = function t(b) {
    var c;
    return _typeof(b) != "object" ? b : (a.each(b, function (d, e) {
    ...
    youtube: {
      ...
      getThumb: function getThumb(b, c, d) {
    ...
    Galleria.theme = b, a.each(C, function (a, b) {
      ...
      E = function () {
    return {
      clearTimer: function clearTimer(b) {
        a.each(Galleria.get(), function () {
          this.clearTimer(b);
        });
      },
      addTimer: function addTimer(b) {
        a.each(Galleria.get(), function () {
          this.addTimer(b);
        });
      },
      ...
      getScriptPath: function getScriptPath(b) {
      ...
      animate: function () {
        var b = function (a) {
          ...
          for (d = 0; b[d]; d++) {
            if (typeof a[b[d]] != "undefined") return b[d];
          }
      ...
      removeAlpha: function removeAlpha(a) {
        if (p < 9 && a) {
          var b = a.style,
              c = a.currentStyle,
      ...
      forceStyles: function forceStyles(b, c) {
        ...
        return function (f) {
          a(f).bind("touchend", function (f) {
            ...
            while (b.parentNode && b != f.currentTarget && e) {
              c = a(b).data("events"), d = a(b).data("fakes"), c && "click" in c ? (e = !1, f.preventDefault(), a(b).click(g).click(), c.click.pop(), a.each(c.click, h), a(b).data("fakes", c.click), delete c.click) : d && (e = !1, f.preventDefault(), a.each(d, i)), b = b.parentNode;
            }
          });
        };
      }(),
      wait: function wait(b) {
        b = a.extend({
          until: o,
          success: n,
      ...
      toggleQuality: function toggleQuality(a, b) {
      ...
      insertStyleTag: function insertStyleTag(a) {
      ...
      loadScript: function loadScript(b, c) {
        var d = !1,
            e = a("<script>").attr({
          src: b,
          async: !0
      ...
      loadCSS: function loadCSS(c, e, f) {
        var g, h;
        ...
        if (a("#" + e).length) a("#" + e).attr("href", c), h--;else {
          g = a("<link>").attr({
            rel: "stylesheet",
            href: c,
            id: e
    ...
    var b = function b(_b, c, d, e) {
      var f = this.getOptions("easing"),
          ...
          h = {
        left: g * (_b.rewind ? -1 : 1)
      },
          i = {
        left: 0
      };
      d ? (h.opacity = 0, i.opacity = 1) : h.opacity = 1, a(_b.next).css(h), E.animate(_b.next, i, {
        duration: _b.speed,
        complete: function (a) {
          return function () {
            c(), a.css({
        ...
        }(a(_b.next).add(_b.prev)),
        queue: !1,
        easing: f
      }), e && (_b.rewind = !_b.rewind), _b.prev && (h = {
        left: 0
      }, i = {
        left: g * (_b.rewind ? 1 : -1)
      }, d && (h.opacity = 1, i.opacity = 0), a(_b.prev).css(h), E.animate(_b.prev, i, {
        duration: _b.speed,
        queue: !1,
        easing: f,
    ...
    return {
      ...
      effects: {
        ...
        slide: function slide(a, c) {
          b.apply(this, E.array(arguments));
        },
        fadeslide: function fadeslide(a, c) {
          b.apply(this, E.array(arguments).concat([!0]));
        },
        doorslide: function doorslide(a, c) {
  ...
  x.listen(), Galleria = function (_Galleria) {
    function Galleria() {
      return _Galleria.apply(this, arguments);
    }

    Galleria.toString = function () {
      return _Galleria.toString();
    };
    ...
    var i = this._keyboard = {
      ...
      attach: function attach(a) {
        ...
        for (b in a) {
          a.hasOwnProperty(b) && (c = b.toUpperCase(), c in i.keys ? i.map[i.keys[c]] = a[b] : i.map[c] = a[b]);
        }
      ...
      set: function set(a) {
        ...
        while (k.hooks[a - 1] + k.width >= k.max && a >= 0) {
          a--;
        }
      ...
      follow: function follow(a) {
        ...
        while (k.hooks[b] - k.hooks[k.current] < k.width && b <= k.hooks.length) {
          b++;
        }
      ...
      parseCallback: function parseCallback(b, c) {
      ...
      add: function add(b, c, d, e) {
        ...
        for (g in c) {
          c.hasOwnProperty(g) && (f[g] = b.css(g));
        }
      ...
      show: function show(b) {
        ...
        try {
          for (k = d._options.preload; k > 0; k--) {
            j = new Galleria.Picture(), i = d.getData(h), j.preload("big" in i ? i.big : i.image), h = d.getNext(h);
          }
        } catch (l) {}
      ...
      add: function add(a, _b2, d, e) {
        ...
        this.trunk[a] = c.setTimeout(_b2, d);
      },
      clear: function clear(a) {
        ...
        if (!!a && a in this.trunk) b.call(this, a);else if (typeof a == "undefined") for (d in this.trunk) {
          this.trunk.hasOwnProperty(d) && b.call(this, d);
        }
      }
    };
    return this;
    ...
    init: function init(c, d) {
      ...
      return this._options = {
        ...
        dataConfig: function dataConfig(a) {
          return {};
        },
        dataSelector: "img",
        dataSort: !1,
      ...
      }, this._options.initialTransition = this._options.initialTransition || this._options.transitionInitial, d && d.debug === !1 && (i = !1), d && typeof d.imageTimeout == "number" && (j = d.imageTimeout), d && typeof d.dummy == "string" && (k = d.dummy), a(this._target).children().hide(), _typeof(Galleria.theme) == "object" ? this._init() : C.push(this), this;
    },
    ...
    _createThumbnails: function _createThumbnails(b) {
      ...
      var e,
          ...
          n = [],
          o = 0,
          q = p < 8 ? "http://upload.wikimedia.org/wikipedia/commons/c/c0/Blank.gif" : "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D",
          r = function () {
      ...
      for (; this._data[l]; l++) {
        g = this._data[l], e = g.thumb || g.image, k.thumbnails !== !0 && s != "lazy" || !g.thumb && !g.image ? g.iframe || s === "empty" || s === "numbers" ? (f = {
    ...
    lazyLoad: function lazyLoad(b, c) {
    ...
    lazyLoadChunks: function lazyLoadChunks(a, b) {
        ...
        if ("video" in e) {
          ...
          if (f) {
            c.iframe = v[f.provider].embed(f.id) + function () {
              if (_typeof(b._options[f.provider]) == "object") {
                var c = "?",
                    d = [];
    ...
    unbind: function unbind(a) {
      return a = u(a), this.$("container").unbind(a), this;
    },
    trigger: function trigger(b) {
      return b = _typeof(b) == "object" ? a.extend(b, {
        scope: this
      }) : {
        type: u(b),
        scope: this
    ...
    addIdleState: function addIdleState(a, b, c, d) {
      return this._idle.add.apply(this._idle, E.array(arguments)), this;
    },
    removeIdleState: function removeIdleState(a) {
    ...
    addPan: function addPan(b) {
      ...
      var c = this,
        ...
        if (a > 0) {
          ...
          if (n !== o) {
            n = o;
            if (p === 8) b.parent()["scroll" + d](o * -1);else {
              var e = {};
    ...
    addElement: function addElement(b) {
      var c = this._dom;
      return a.each(E.array(arguments), function (a, b) {
        c[b] = E.create("galleria-" + b);
      }), this;
    },
    attachKeyboard: function attachKeyboard(a) {
    ...
    prependChild: function prependChild(a, b) {
    ...
    append: function append(a) {
      ...
      for (b in a) {
        if (a.hasOwnProperty(b)) if (a[b].constructor === Array) for (c = 0; a[b][c]; c++) {
    ...
    _scaleImage: function _scaleImage(b, c) {
    ...
    rescale: function rescale(a, c, d) {
      var e = this;
      ...
      if (this._options.preload) {
        ...
        try {
          for (p = this._options.preload; p > 0; p--) {
            o = new Galleria.Picture(), r = d.getData(q), o.preload(this.isFullscreen() && "big" in r ? r.big : r.image), q = d.getNext(q);
          }
        } catch (s) {}
      }
    ...
    setOptions: function setOptions(b, c) {
      return _typeof(b) == "object" ? a.extend(this._options, b) : this._options[b] = c, this;
    },
    ...
    playToggle: function playToggle(a) {
    ...
    hasInfo: function hasInfo(a) {
      var b = "title description".split(" "),
          c;

      for (c = 0; b[c]; c++) {
        if (!!this.getData(a)[b[c]]) return !0;
      }

      return !1;
    },
    jQuery: function jQuery(b) {
      var c = this,
          d = [];
    ...
    b.name || Galleria.raise("No theme name specified"), _typeof(b.defaults) != "object" ? b.defaults = {} : b.defaults = t(b.defaults);
    var d = !1,
        e;
    ...
    isCached: function isCached(a) {
      return !!this.cache[a];
    },
    preload: function preload(b) {
    ...
    galleria: function galleria(a, b, c, d, e) {
      return (b /= e / 2) < 1 ? d / 2 * b * b * b + c : d / 2 * ((b -= 2) * b * b + 2) + c;
    },
    galleriaIn: function galleriaIn(a, b, c, d, e) {
      return d * (b /= e) * b + c;
    },
    galleriaOut: function galleriaOut(a, b, c, d, e) {
      return -d * (b /= e) * (b - 2) + c;
    }
