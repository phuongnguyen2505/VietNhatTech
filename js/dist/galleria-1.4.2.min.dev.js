...
!function (t, e, _i2, n) {
  var a = e.document,
    ...
    youtube: {
      ...
      get_thumb: function get_thumb(t) {
        return t.entry.media$group.media$thumbnail[2].url;
      },
      get_image: function get_image(t) {
        if (t.entry.yt$hd) {
    ...
    t.each(P, function (t, i) {
      ...
      H = function () {
    return {
      clearTimer: function clearTimer(e) {
        t.each(_i2.get(), function () {
          this.clearTimer(e);
        });
      },
      addTimer: function addTimer(e) {
        t.each(_i2.get(), function () {
          this.addTimer(e);
        });
      },
      ...
      removeFromArray: function removeFromArray(e, i) {
      ...
      getScriptPath: function getScriptPath(e) {
      ...
      removeAlpha: function removeAlpha(t) {
      ...
      forceStyles: function forceStyles(e, i) {
        e = t(e);
      ...
      wait: function wait(n) {
        _i2._waiters = _i2._waiters || [];
        n = t.extend({
          until: v,
          success: m,
          error: function error() {
            _i2.raise("Could not complete wait function.");
          },
          timeout: 3e3
        }, n);
        ...
        var a = H.timestamp(),
          ...
          r = H.timestamp();
          o = r - a;
          H.removeFromArray(_i2._waiters, s);
          ...
          _i2._waiters.push(s = e.setTimeout(l, 10));
        };

        _i2._waiters.push(s = e.setTimeout(l, 10));
      },
      toggleQuality: function toggleQuality(t, e) {
      ...
      insertStyleTag: function insertStyleTag(e, i) {
        if (i && t("#" + i).length) {
          return;
        }
      ...
      loadScript: function loadScript(e, i) {
        var n = false,
            a = t("<scr" + "ipt>").attr({
          src: e,
          async: true
      ...
      loadCSS: function loadCSS(e, o, r) {
        var s, l;
        ...
        if (t("#" + o).length) {
          ...
          if (y && l >= 31) {
            _i2.raise("You have reached the browser stylesheet limit (31)", true);
        ...
        if (typeof r === "function") {
          ...
          H.wait({
            ...
            error: function error() {
              ...
              _i2.raise("Theme CSS could not load after 20 sec. " + (_i2.QUIRK ? "Your browser is in Quirks Mode, please add a correct doctype." : "Please download the latest theme at http://galleria.io/customer/."), true);
            },
            timeout: 5e3
          });
        }
    ...
    return {
      ...
      effects: {
        ...
        slide: function slide(t, i) {
          e.apply(this, H.array(arguments));
        },
        fadeslide: function fadeslide(t, i) {
          e.apply(this, H.array(arguments).concat([true]));
        },
        doorslide: function doorslide(t, i) {
  ...
  _i2 = function i() {
    ...
    var d = this._carousel = {
      ...
      getLast: function getLast(t) {
        return (t || d.current) - 1;
      },
      follow: function follow(t) {
    ...
    var m = this._fullscreen = {
      ...
      beforeExit: function beforeExit(t) {
        t();
      },
      keymap: s._keyboard.map,
      parseCallback: function parseCallback(e, i) {
      ...
      enter: function enter(t) {
        m.beforeEnter(function () {
          ...
          if (s._options.trueFullscreen && A.support) {
            ...
            if (_i2.MAC) {
              if (!(_i2.SAFARI && /version\/[1-5]/.test(f))) {
      ...
      _enter: function _enter(o) {
        ...
        if (b) {
          m.iframe = function () {
            ...
            if (r.protocol != s.protocol || r.hostname != s.hostname || r.port != s.port) {
              _i2.raise("Parent fullscreen not available. Iframe protocol, domains and ports must match.");
        ...
        if (u) {
          ...
          H.forceStyles(s.get("container"), {
            position: _i2.TOUCH ? "absolute" : "fixed",
            top: 0,
            left: 0,
            width: "100%",
            height: "100%",
        ...
        s.rescale(function () {
          ...
          s.trigger(_i2.FULLSCREEN_ENTER);
        });
    ...
    var x = this._timer = {
      ...
      add: function add(t, _i, n, a) {
        ...
        this.trunk[t] = e.setTimeout(_i, n);
      },
  ...
  _i2.prototype = {
    ...
    init: function init(e, a) {
      ...
      if (!this._target) {
        _i2.raise("Target not found", true);
      ...
      this._options = {
        ...
        dataConfig: function dataConfig(t) {
          return {};
        },
        dataSelector: "img",
        dataSort: false,
      ...
      if (_i2.QUIRK) {
        _i2.raise("Your page is in Quirks mode, Galleria may not render correctly. Please validate your HTML and add a correct doctype.");
      }
    ...
    _init: function _init() {
      ...
      if (this._initialized) {
        _i2.raise("Init failed: Gallery instance already initialized.");
      ...
      if (!this.theme) {
        _i2.raise("Init failed: No theme found.", true);

        return this;
      }

      t.extend(true, s, this.theme.defaults, this._original.options, _i2.configure.options);
      ...
      this.bind(_i2.DATA, function () {
        ...
        H.wait({
          ...
          error: function error() {
            if (a()) {
              _i2.raise("Could not extract sufficient width/height of the gallery container. Traced measures: width:" + n.width + "px, height: " + n.height + "px.", true);
            } else {
              _i2.raise("Could not extract a stage height from the CSS. Traced height: " + a() + "px.", true);
            }
          },
      ...
      this.$("container").addClass([_i2.TOUCH ? "touch" : "notouch", this._options.variation, "galleria-theme-" + this.theme.name].join(" "));

      if (!this._options.swipe) {
        t.each(new Array(2), function (e) {
          var n = new _i2.Picture();
          t(n.container).css({
            position: "absolute",
            top: 0,
            left: 0
      ...
      if (s.swipe) {
        ...
        this.finger = new _i2.Finger(this.get("stage"), {
        ...
        this.bind(_i2.RESCALE, function () {
          this.finger.setup();
        });
        ...
        this.bind(_i2.IMAGE, function (e) {
      ...
      if (s.carousel) {
        var l = 0,
            c = s.show;
        this.bind(_i2.THUMBNAIL, function () {
          this.updateCarousel();
      ...
      t.each(_i2.on.binds, function (e, i) {
    ...
    _createThumbnails: function _createThumbnails(n) {
      this.get("total").innerHTML = this.getDataLength();
    ...
    lazyLoadChunks: function lazyLoadChunks(t, i) {
    ...
    _run: function _run() {
      ...
      H.wait({
        ...
        success: function success() {
          ...
          t.each(_i2.ready.callbacks, function (t, e) {
            if (typeof e == "function") {
              e.call(a, a._options);
            }
          });
        ...
        error: function error() {
          _i2.raise("Stage width or height is too small to show the gallery. Traced measures: width:" + a._stageWidth + "px, height: " + a._stageHeight + "px.", true);
        }
      });
    },
    load: function load(e, n, a) {
      var o = this,
          r = this._options;
      this._data = [];
      this._thumbnails = [];
      ...
      if (t.isArray(e)) {
        if (this.validate(e)) {
          ...
          _i2.raise("Load failed: JSON Array not valid.");
        }
      } else {
        n += ",.video,.iframe";
      ...
      if (this.getDataLength()) {
        this._parseData(function () {
          this.trigger(_i2.DATA);
        });
      }

      return this;
    },
    _parseData: function _parseData(e) {
      var i = this,
          a,
          o = false,
          r = function r() {
        ...
        if ("video" in o) {
          ...
          if (s) {
            a.iframe = new I(s.provider, s.id).embed() + function () {
              if (_typeof(i._options[s.provider]) == "object") {
                var e = "?",
                    n = [];
    ...
    destroy: function destroy() {
      ...
      if (_i2._waiters.length) {
        t.each(_i2._waiters, function (t, i) {
    ...
    addIdleState: function addIdleState(t, e, i, n) {
      this._idle.add.apply(this._idle, H.array(arguments));

      return this;
    },
    removeIdleState: function removeIdleState(t) {
    ...
    enterFullscreen: function enterFullscreen(t) {
      this._fullscreen.enter.apply(this, H.array(arguments));

      return this;
    },
    exitFullscreen: function exitFullscreen(t) {
    ...
    defineTooltip: function defineTooltip(t, e) {
      this._tooltip.define.apply(this._tooltip, H.array(arguments));

      return this;
    },
    refreshTooltip: function refreshTooltip(t) {
    ...
    hasVariation: function hasVariation(e) {
    ...
    attachKeyboard: function attachKeyboard(t) {
    ...
    prependChild: function prependChild(t, e) {
    ...
    _scaleImage: function _scaleImage(e, i) {
    ...
    rescale: function rescale(e, a, o) {
      var r = this;
        ...
        return function () {
          ...
          if (o.iframe && o.image || o.link || a._options.lightbox || a._options.clicknext) {
            t(r.image).css({
              ...
              if (a._options.clicknext && !_i2.TOUCH) {
    ...
    setOptions: function setOptions(e, i) {
      if (_typeof(e) === "object") {
    ...
    play: function play(t) {
      ...
      this.trigger(_i2.PLAY);
      return this;
    },
    pause: function pause() {
      this._playing = false;
      this.trigger(_i2.PAUSE);
      return this;
    },
    ...
    setPlaytime: function setPlaytime(t) {
      this._playtime = t;
      return this;
    },
    ...
    setCounter: function setCounter(t) {
      if (typeof t === "number") {
        t++;
      } else if (typeof t === "undefined") {
        t = this.getIndex() + 1;
  ...
  _i2.addTheme = function (n) {
    if (!n.name) {
      _i2.raise("No theme name specified");
    }

    if (_typeof(n.defaults) !== "object") {
      n.defaults = {};
    } else {
    ...
    t(e).load(function () {
      if (!o) {
        r = e.setTimeout(function () {
          if (!o) {
            _i2.raise("Galleria had problems loading theme at " + n + ". Please check theme path or load manually.", true);
          }
        }, 2e4);
      }
    });
  ...
  _i2.get = function (t) {
    if (!!D[t]) {
      ...
      _i2.raise("Gallery index " + t + " not found");
    }
  };

  _i2.configure = function (e, n) {
    var a = {};
    ...
    _i2.configure.options = a;
    t.each(_i2.get(), function (t, e) {
      e.setOptions(a);
    });
    return _i2;
  };

  _i2.configure.options = {};
  ...
  _i2.addTransition = function (t, e) {
    M.effects[t] = e;
    return _i2;
  };
  ...
  _i2.getLoadedThemes = function () {
    return t.map(z, function (t) {
      return t.name;
    });
  };

  _i2.requires = function (t, e) {
  ...
  _i2.Picture.prototype = {
    ...
    load: function load(n, a, o) {
      ...
      if (!_i2.IE && !_i2.CHROME && !_i2.SAFARI) {
              ...
              H.wait({
                ...
                error: function error() {
                  if (!c) {
                    ...
                    _i2.raise("Could not extract width/height from image: " + e.src + ". Traced measures: width:" + e.width + "px, height: " + e.height + "px.");
                  }
                },
                timeout: 100
              });
    ...
    scale: function scale(e) {
      ...
      H.wait({
        ...
        error: function error() {
          _i2.raise("Could not scale image: " + a.image.src);
        },
        timeout: 1e3
      });
      return this;
  ...
  t.extend(t.easing, {
    galleria: function galleria(t, e, i, n, a) {
      if ((e /= a / 2) < 1) {
        return n / 2 * e * e * e + i;
      }
    ...
    galleriaIn: function galleriaIn(t, e, i, n, a) {
      return n * (e /= a) * e + i;
    },
    galleriaOut: function galleriaOut(t, e, i, n, a) {
      return -n * (e /= a) * (e - 2) + i;
    }
  });
  ...
  _i2.Finger = function () {
    ...
    var l = function l(i, n) {
      this.config = {
        start: 0,
        duration: 500,
        onchange: function onchange() {},
        oncomplete: function oncomplete() {},
        easing: function easing(t, e, i, n, a) {
  ...
  t.fn.galleria = function (e) {
    ...
    return this.each(function () {
      ...
      t.data(this, "galleria", new _i2().init(this, e));
    });
  };
