    ...
    init: function init(b) {
      ...
      var c = this,
        ...
        c = a.extend({
          speed: 400,
          width: 190,
          onbrick: function onbrick() {},
          onheight: function onheight() {},
          delay: 0,
          debug: !1
        }, c), b = a(b);
        var d = b.children(),
      ...
      this.bind("fullscreen_enter", function (a) {
        ...
        this.getData().iframe && (a(this._controls.getActive().container).find("iframe").remove(), this.$("container").removeClass("iframe")), g.hide(), a(c._controls.getActive().container).hide(), e.show(), d.css("left", -1e4);
      }), this.bind("loadstart", function (a) {
        Galleria.TOUCH && this.$("image-nav").toggle(!!a.galleriaData.iframe);
      }), this.bind("thumbnail", function (f) {
        this.addElement("plus"), Galleria.History && f.index === parseInt(n, 10) && this.enterFullscreen(function () {
          this.show(n);
        });
        var g = f.thumbTarget,
            h = this.$("plus").css({
        ...
        b.showInfo && this.hasInfo(f.index) && h.append("<span>" + this.getData(f.index).title + "</span>"), l = l || a(g).parent().outerWidth(!0), a(g).css("opacity", 0), k.unbind(b.thumbEventType), Galleria.IE ? h.hide() : h.css("opacity", 0), Galleria.TOUCH ? k.bind("touchstart", function () {
          h.css("opacity", 1);
